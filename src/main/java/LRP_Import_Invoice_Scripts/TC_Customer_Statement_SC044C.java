...
public class TC_Customer_Statement_SC044C extends Keywords {

	public void Customer_Statement_SC044C(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws EncryptedDocumentException, InvalidFormatException {

		String testcase_Name = "TC_Customer_Statement_SC044C";
		...
		String BL_Input = Excel_data.get("BL_Input");
		...
		waitForElement(driver, By_BL_Radio_Button);
		click(driver, By_BL_Radio_Button);
		waitForElement(driver, BL_Plus_Button);
		click(driver, BL_Plus_Button);

		globalValueSearchWindow(driver, BL_Condition, BL_Search_Filter, BL_Input, "", "", "", "");
		...
		if(!From_date.trim().equals("")&&IsElementEnabled(driver, customer_Statement_From_Date)) {
		...
		if(!To_date.trim().equals("")&&IsElementEnabled(driver, customer_Statement_To_Date)) {
