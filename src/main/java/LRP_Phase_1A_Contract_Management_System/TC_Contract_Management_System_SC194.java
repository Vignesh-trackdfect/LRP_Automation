...
public class TC_Contract_Management_System_SC194 extends Keywords {

	public void Contract_Management_System_SC194(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC194";
		...
		Step_Start(12, "click the file and download", test, test1);
		
		waitForElement(driver, CMS_View_FileName);
		String filePath = downloadFile(driver, CMS_View_FileName);
		...
		Step_End(12, "click the file and download", test, test1);
