...
public class TC_Ecommerce_Notification_SC004 extends Keywords {

	public void Ecommerce_Notification_SC004(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Ecommerce_Notification_SC004";
		...
		String Customer_Value_Select = Excel_data.get("Customer_Value_Select");
		...
		waitForElement(driver, Customer_Add_button_EN);
		click(driver, Customer_Add_button_EN);

		twoColumnMultipleSearchWindow(driver, Customer_Select_Header, Customer_Select_Condition, Customer_Value_Select);
		Step_End(2, "Select the customer in customer input box", test, test1);

		Step_Start(3, "Type the required message in the content box.", test, test1);
		waitForElement(driver, Message_Input_Area_EN);
		sendKeys(driver, Message_Input_Area_EN, Type_Message);
		Step_End(3, "Type the required message in the content box.", test, test1);
		...
		Step_End(5, "Notification will be sent to the customer based on the eCommerce system ", test, test1);
