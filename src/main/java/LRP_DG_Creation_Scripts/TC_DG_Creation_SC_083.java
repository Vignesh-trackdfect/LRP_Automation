...
public class TC_DG_Creation_SC_083 extends Keywords {


	public void DG_Creation_SC_083(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_083";
...
//		Plugin Configuration
		...
		Step_End(2, "make sure   netweight  button disable", test, test1);
		...
		if(Actual_Popup.equals(Net_Weight_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + Net_Weight_Popup + " || Actual Popup is : " + Actual_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Net_Weight_Popup + " || Actual Popup is : " + Actual_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + Net_Weight_Popup + " || Actual Popup is : " + Actual_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + Net_Weight_Popup + " || Actual Popup is : " + Actual_Popup, test,test1); 
		} 
