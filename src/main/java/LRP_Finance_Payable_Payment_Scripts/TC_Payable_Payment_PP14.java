...
public class TC_Payable_Payment_PP14 extends Keywords{


public void Payable_Payment_PP14(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
		
		String testcase_Name="TC_Payable_Payment_PP14";
		...
		Step_Start(8, "Once we select cash, the Bank should disable", test, test1);
		
		waitForElement(driver, cheque_Drpdwn_Label_PPT);
		click(driver, cheque_Drpdwn_Label_PPT);
		
		String cheque_Drpdwn_Option_Rr=String.format(Payable_Payment_Locators.cheque_Drpdwn_Option_PPT, cheque_Drpdwn_Data);
		...
		waitForElement(driver, bank_Txtfld1_PPT);
		
		if(!isElementEnabled(driver, bank_Txtfld1_PPT) && !isElementEnabled(driver, bank_Txtfld2_PPT)) {
			
			System.out.println("The expected Result is : Once user select the cash, The Bank No should be disabled and Acutal result is : Once user select the cash, The Bank No should be disabled field is disabled");
			Extent_pass_New(driver, "The expected Result is : Once user select the cash, The Bank No should be disabled and Acutal result is : Once user select the cash, The Bank No should be disabled field is disabled", test, test1);
		}else {
			
			System.out.println("The expected Result is : Once user select the cash, The cheque/TT No should be disabled and Acutal result is : Once user select the cash, TheBank No field is still enabled");
			Extent_fail(driver, "The expected Result is : Once user select the cash, The cheque/TT No should be disabled and Acutal result is : Once user select the cash, TheBank No field is still enabled", test, test1);
			
		}
		
		Step_End(8, "Once we select cash, the Bank should disable", test, test1);
