...
public class TC_Import_Invoice_SC007B extends Keywords {

	public void Import_Invoice_SC007B(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Import_Invoice_SC007B";
		...
		String Issue_Saved = Excel_data.get("Issue_Saved");
		...
		Step_End(2, "open the import invoice module.", test, test1);
			...
			if (Issue_Saved.equals(import_saved_act2)) {
			...
			Step_Start(12, "above rows showing Green Color", test, test1);
			...
			if (Issued_colour.equals(Issue_color)) {
			...
			Step_End(12, "above rows showing Green Color", test, test1);
			
			Extent_pass_New(driver, "Expected -Import invoice saved be Issue status  ||   Actual : Import Invoice Saved in Issue Status", test, test1);
			...
			List<String> Import_Invoice_Number = getValuesByHeader(invoice_Tabledata, "Inv Number");
            System.out.println("Import_Invoice_Number :"+ Import_Invoice_Number);
			...
			Step_End(22, "system has validate the invoice reversed", test, test1);
