...
public class TC_Detention_Waiver_TS_046_A extends Keywords {

	public void Detention_Waiver_TS_046_A(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url)
			throws EncryptedDocumentException, InvalidFormatException, IOException {

		String testcase_Name = "TC_Detention_Waiver_TS_046_A";
		...
		Step_End(5, "Select the container details, and input the Free time /Lumpsum/Percentage", test, test1);
		...
		List<Map<String, String>> TabledataFull = getTableDatawithscroll(driver, detentionCharges_Table_Columns_IN, detentionCharges_Table_Rows_IN, Detention_Charges_HorizontalScrollBar, scrollLength, returnScrollLength);
		...
		for (Map<String, String> row : TabledataFull) {
			...
			int scrollLength=60;
			int returnScrollLength=0;
			List<Map<String, String>> TabledataFull = getTableDatawithscroll(driver, portStorageCharges_Table_Columns_IN, portStorageCharges_Table_Rows_IN, PortStorage_Charges_HorizontalScrollBar, scrollLength, returnScrollLength);
		...
		String waiverNumbers = WaiverNumbers.get(0);
		String Waiver_Numbers_Split[] = waiverNumbers.split(" ");
		...
		globalValueSearchWindow(driver, BL_Condition, WaiverNumber_Option, Waiver_Numbers, "", "", "", "");
