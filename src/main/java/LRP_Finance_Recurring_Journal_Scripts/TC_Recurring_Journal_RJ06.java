...
public class TC_Recurring_Journal_RJ06  extends Keywords{
	public void  Recurring_Journal_RJ06(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		String testcase_Name="TC_Recurring_Journal_RJ06";
		...
		if(Year_Perform.equalsIgnoreCase("YES")) {
			waitForElement(driver, year_radio_button);
		...
		Step_Start(10, " Batch generated by Year .", test, test1);
		...
		Step_End(10, " Batch generated by Year .", test, test1);
