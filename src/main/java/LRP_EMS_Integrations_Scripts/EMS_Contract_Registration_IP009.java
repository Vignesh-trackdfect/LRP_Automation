...
public void emscontractregistrationip009 (WebDriver driver,ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {
	...
	String tc_Name="EMS_Contract_Registration_IP009";
		...
		String ContractType9 = Excel_data.get("ContractType9");	
		String Contractno9 = Excel_data.get("Contractno9");	
		...
		String remove_data_msg = Excel_data.get("remove_data_msg");	
