...
public class TC_Contract_Management_System_SC007 extends Keywords {

	public void Contract_Management_System_SC007(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC007";
		...
		String OOG_Condition = Excel_data.get("OOG_Condition");
		String Rate_Header = Excel_data.get("Rate_Header");
		...
		twoColumnSearchWindow(driver, Rate_Header, Search_Condition, Eqp_Type);
		...
		twoColumnSearchWindow(driver, Package_Header, Search_Condition, Package_Description);
