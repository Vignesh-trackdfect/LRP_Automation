...
public class TC_Rate_Request_SC70   extends Keywords {
	public void Rate_Request_SC70(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Exp_Det_Days_Input1 = Excel_data.get("Exp_Det_Days_Input1");
		String Imp_Det_Days_Input1 = Excel_data.get("Imp_Det_Days_Input1");
		String Exp_Demmurage_Input1 = Excel_data.get("Exp_Demmurage_Input1");
		String Imp_Demmurage_Input1 = Excel_data.get("Imp_Demmurage_Input1");
		String Exp_Det_Days_Input2 = Excel_data.get("Exp_Det_Days_Input2");
		String Imp_Det_Days_Input2 = Excel_data.get("Imp_Det_Days_Input2");
		String Exp_Demmurage_Input2 = Excel_data.get("Exp_Demmurage_Input2");
		String Imp_Demmurage_Input2 = Excel_data.get("Imp_Demmurage_Input2");
		String agencyUser = Excel_data.get("Agency_user");
		String SOC_checkbox1 = Excel_data.get("SOC_checkbox1");
		String NOR_checkbox1 = Excel_data.get("NOR_checkbox1");
		String OOG_checkbox1 = Excel_data.get("OOG_checkbox1");
		String DG_checkboxs1 = Excel_data.get("DG_checkboxs1");
		String SOC_checkbox2 = Excel_data.get("SOC_checkbox2");
		String MTY_checkbox1 = Excel_data.get("MTY_checkbox1");
		String MTY_checkbox2 = Excel_data.get("MTY_checkbox2");
		String NOR_checkbox2 = Excel_data.get("NOR_checkbox2");
		String OOG_checkbox2 = Excel_data.get("OOG_checkbox2");
		String DG_checkboxs2 = Excel_data.get("DG_checkboxs2");
		...
		String Pre_Carriage_Radiobtn1 = Excel_data.get("pre_Carriage_Radiobtn1");
		String On_Carriage_Radiobtn1 = Excel_data.get("On_Carriage_Radiobtn1");
		String Pre_Carriage_Radiobtn2 = Excel_data.get("pre_Carriage_Radiobtn2");
		String On_Carriage_Radiobtn2 = Excel_data.get("On_Carriage_Radiobtn2");
				String Container_Type = Excel_data.get("Container_Type");
		...
		String Select_type_location = Excel_data.get("Location_code_search");
		String condition=Excel_data.get("Condition");
		String payLocation=Excel_data.get("PayLocation");
		String date_Perform = Excel_data.get("date_Perform");
		String Flexi_CheckBox1 = Excel_data.get("Flexi_CheckBox1");
		String MTY_CheckBox1 = Excel_data.get("MTY_CheckBox1");
		String Flexi_CheckBox2 = Excel_data.get("Flexi_CheckBox2");
		String MTY_CheckBox2 = Excel_data.get("MTY_CheckBox2");
...
formatLocatorClick(driver, RequestType, Request_Input);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			if(isdisplayed(driver, flexi_Checkbox_RR)) {
				checkBox(driver, flexi_Checkbox_RR, Flexi_CheckBox1);
			}
			waitForDisplay(driver, empty_Checkbox_RR);
			if(isdisplayed(driver, empty_Checkbox_RR)) {
				checkBox(driver, empty_Checkbox_RR, MTY_CheckBox1);
			}
			...
			if(!Pre_Carriage_Radiobtn1.equals("")) {
				formatLocatorClick(driver, pre_Carriage_Radiobtn, Pre_Carriage_Radiobtn1);
			}
		if(!On_Carriage_Radiobtn1.equals("")) {
			formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn1);
		}

		rateRequestRoutingDays(driver, Exp_Det_Days_Input1, Imp_Det_Days_Input1, Exp_Demmurage_Input1, Imp_Demmurage_Input1);
			...
			waitForDisplay(driver, flexi_Checkbox_RR);
			if(isdisplayed(driver, flexi_Checkbox_RR)) {
				checkBox(driver, flexi_Checkbox_RR, Flexi_CheckBox2);
			}
			waitForDisplay(driver, empty_Checkbox_RR);
			if(isdisplayed(driver, empty_Checkbox_RR)) {
				checkBox(driver, empty_Checkbox_RR, MTY_CheckBox2);
			}
			...
			//Pre Carriage radio btn
			if(!Pre_Carriage_Radiobtn2.equals("")) {
				formatLocatorClick(driver, pre_Carriage_Radiobtn, Pre_Carriage_Radiobtn2);
			}
		if(!On_Carriage_Radiobtn2.equals("")) {
			formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn2);
		}

		rateRequestRoutingDays(driver, Exp_Det_Days_Input2, Imp_Det_Days_Input2, Exp_Demmurage_Input2, Imp_Demmurage_Input2);
		...
		click(driver, Mail_Cancel_button);
			...
			for(int i = 1;i<=total_Rows.size();i++) {
				...
				scrollBottom(driver);
				List<String> ContainerTypes = splitAndExpand(Container_Type, ",");
				...
				if(isElementEnabled(driver, SRR_Approve_Button)) {
					...
					cost.EquipmentData(driver, missingCost, test, test1, selected_dataset,ContainerTypes.get(i-1));
