...
public class TC_Discharge_Reconciliation_MD50 extends Keywords {
	public void Discharge_Reconciliation_MD50(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Discharge_Reconciliation_MD50";
		...
		String eq_type_DV = String.format(Equipment_section_DR, EQUIPMENT_TYPE_1);
		String eq_type_RE = String.format(Equipment_section_DR, EQUIPMENT_TYPE_2);
		...
		Step_Start(13, "Verify that Label DV&&RE has shown in Exquipments section.", test, test1);
		waitForDisplay(driver, eq_type_DV);
		if (isdisplayed(driver, eq_type_DV)) {

			System.out.println(
					"Expected Result is :DV has shown in Exquipments section should be Displayed||  Actual Result is : DV has shown in Exquipments section is  Displayed ");
			Extent_pass(driver,
					"Expected Result is :DV has shown in Exquipments section should be Displayed||  Actual Result is : DV has shown in Exquipments section is  Displayed ",
					test, test1);
		} else {
			System.out.println(
					"Expected Result is :DV has shown in Exquipments section should be Displayed||  Actual Result is : DV has shown in Exquipments section is not Displayed ");
			Extent_fail(driver,
					"Expected Result is :DV has shown in Exquipments section should be Displayed||  Actual Result is : DV has shown in Exquipments section is not Displayed ",
					test, test1);

		}
		waitForDisplay(driver, eq_type_RE);
		if (isdisplayed(driver, eq_type_RE)) {

			System.out.println(
					"Expected Result is :RE has shown in Exquipments section should be Displayed||  Actual Result is : RE has shown in Exquipments section is  Displayed ");
			Extent_pass(driver,
					"Expected Result is :RE has shown in Exquipments section should be Displayed||  Actual Result is : RE has shown in Exquipments section is  Displayed ",
					test, test1);
		} else {
			System.out.println(
					"Expected Result is :RE has shown in Exquipments section should be Displayed||  Actual Result is : RE has shown in Exquipments section is not Displayed ");
			Extent_fail(driver,
					"Expected Result is :RE has shown in Exquipments section should be Displayed||  Actual Result is : RE has shown in Exquipments section is not Displayed ",
					test, test1);

		}
		Step_End(13, "Verify that Label DV&&RE has shown in Exquipments section.", test, test1);
