...
public class TC_DG_Creation_SC_067 extends Keywords {


	public void DG_Creation_SC_067(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_067";
...
moduleNavigate(driver, DG_Creation_Module);
		...
		Step_Start(7,"click multichecklist", test, test1);
		...
		Step_End(7,"click multichecklist", test, test1);
		Step_Start(8,"Click partial Reject button.", test, test1);

		waitForElement(driver, partial_Reject_Button);
		safeclick(driver, partial_Reject_Button);
		
		Step_End(8,"Click partial Reject button.", test, test1);
