...
public class TC_Merge_Booking_SC05  extends Keywords {
		public void Merge_Booking_SC05(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
				Map<String, String> Excel_data, String url) {
			
			String testCaseName="TC_Merge_Booking_SC05";   
		...
		if (isdisplayed(driver, MB_New_Booking_No)) {
			System.out.println(
					"Expected result : New Booking Number should be displayed || Actual result : New Booking Number is  displayed ");
			Extent_pass_New(driver,
					"Expected result : New Booking Number should be displayed || Actual result : New Booking Number is  displayed ",test, test1);
		} else {
