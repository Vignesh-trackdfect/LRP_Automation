...
public class TC_Rate_Request_SC67 extends Keywords{
	...
	public void Rate_Request_SC67(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	checkBox(driver, empty_Checkbox_RR, MTY_CheckBox);
		...
		if(isElementAccessible(driver, SRR_Approve_Button)) {
