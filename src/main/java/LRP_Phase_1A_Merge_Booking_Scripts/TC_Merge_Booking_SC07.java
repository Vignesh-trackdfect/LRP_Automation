...
public class TC_Merge_Booking_SC07  extends Keywords {
		public void Merge_Booking_SC07(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
				Map<String, String> Excel_data, String url) {
			
			String testCaseName="TC_Merge_Booking_SC07";   
			...
			Step_Start(1, "Create 2 containerised booking in draft status", test, test1);
			...
			Step_End(1, "Create 2 containerised booking in draft status", test, test1);
		...
		Step_Start(5, "Then below the PLA field draft and confirm button is there in that select draft option ", test, test1);
		
		waitForElement(driver, MB_Draft_Button);
		click(driver, MB_Draft_Button);

		Step_End(5, "Then below the PLA field draft and confirm button is there in that select draft option ", test, test1);
		...
		Step_Start(7, " then select nominated book no option then new field and new button is enabled above the booking to merge tab called merge to and nominate button", test, test1);

		 waitForElement(driver, MB_Nominated_Book_No);
		 click(driver, MB_Nominated_Book_No);
		 waitForDisplay(driver, MB_Nominated_Book_No);

			waitForDisplay(driver, MB_Merge_To);
			if (isdisplayed(driver, MB_Merge_To)) {
				System.out.println(
						"Expected result : After selecting the Nominated Book No radio button Merge To Text field should be displayed || Actual result : After selecting the Nominated Book No radio button Merge To Text field is be displayed ");
				Extent_pass_New(driver,
						"Expected result : After selecting the Nominated Book No radio button Merge To Text field should be displayed || Actual result : After selecting the Nominated Book No radio button Merge To Text field is be displayed ",test, test1);
			} else {

				System.out.println(
						"Expected result : After selecting the Nominated Book No radio button Merge To Text field should be displayed || Actual result : After selecting the Nominated Book No radio button Merge To Text field is not displayed ");
				Extent_fail(driver,
						"Expected result : After selecting the Nominated Book No radio button Merge To Text field should be displayed || Actual result : After selecting the Nominated Book No radio button Merge To Text field is not displayed ",
						test, test1);

			}	
			waitForDisplay(driver, MB_Nominate_Button);
			if (isdisplayed(driver, MB_Nominate_Button)) {
				System.out.println(
						"Expected result : After selecting the Nominated Book No radio button Nomiate Button should be displayed || Actual result : After selecting the Nominated Book No radio button Nomiate Button is be displayed ");
				Extent_pass_New(driver,
						"Expected result : After selecting the Nominated Book No radio button Nomiate Button should be displayed || Actual result : After selecting the Nominated Book No radio button Nomiate Button is be displayed ",test, test1);
			} else {

				System.out.println(
						"Expected result : After selecting the Nominated Book No radio button Nomiate Button should be displayed || Actual result : After selecting the Nominated Book No radio button Nomiate Button is not displayed ");
				Extent_fail(driver,
						"Expected result : After selecting the Nominated Book No radio button Nomiate Button should be displayed || Actual result : After selecting the Nominated Book No radio button Nomiate Button is not displayed ",
						test, test1);
		...
		Step_End(7, " then select nominated book no option then new field and new button is enabled above the booking to merge tab called merge to and nominate button", test, test1);
		...
		Step_Start(10, " After moving two bookings then in booking to merge tab then select one booking and clik on nominate button ", test, test1);


		formatLocatorClick(driver, MB_BookNum_To_Merge_Select, booknum);
		waitForElement(driver, MB_Nominate_Button);
		click(driver, MB_Nominate_Button);
		Step_End(10, " After moving two bookings then in booking to merge tab then select one booking and clik on nominate button ", test, test1);

		Step_Start(11, "Then on the screen click on merge button", test, test1);

		waitForElement(driver, MD_Merge_btn);
		click(driver, MD_Merge_btn);
		Step_End(11, "Then on the screen click on merge button", test, test1);


		 
		Step_Start(12, "Then system ask for confirmation for merge booking", test, test1);
		waitForElement(driver, popup_Message);
		click(driver, popup_Message_Yes_Button);
		Step_End(12, "Then system ask for confirmation for merge booking", test, test1);
		
		Step_Start(13, "Then merged booking message will be shown ", test, test1);
		...
		Step_End(13, "Then merged booking message will be shown ", test, test1);
		...
		Step_Start(14, "Then unselected draft booking get cancelled and cancelled booking details will be carry forwarded to nominated booking", test, test1);
		moduleNavigate(driver, Booking_Module_Name);
		...
		Step_End(14, "Then unselected draft booking get cancelled and cancelled booking details will be carry forwarded to nominated booking", test, test1);
