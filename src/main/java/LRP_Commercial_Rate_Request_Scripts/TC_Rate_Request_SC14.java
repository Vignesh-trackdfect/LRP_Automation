...
public class TC_Rate_Request_SC14 extends Keywords {
	...
	public void Rate_RequestSC14(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			if(Surcharge_Code.equals(lastRowName)) {
				...
				Extent_pass_New(driver, "Matched || Surcharge code Expected : "+Surcharge_Code+" || Surcharge code Actual : "+lastRowName, test, test1);
			}
			else {
			...
			if(submit_msg.equals(SaveRate_PopUp2)) {
				System.out.println("Matched || EExpected : popup message should be shown as : "+submit_msg+" || Actual : popup message is shown as : "+SaveRate_PopUp2);
				Extent_pass_New(driver, "Matched || EExpected : popup message should be shown as : "+submit_msg+" || Actual : popup message is shown as : "+SaveRate_PopUp2, test, test1);
