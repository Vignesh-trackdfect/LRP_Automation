...
public class TC_Contract_Management_System_SC170 extends Keywords {

	public void Contract_Management_System_SC170(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC170";
		...
		Step_Start(1, " Create a AC contract in N-FMC/LRR in agency ,", test, test1);
		...
		waitForElement(driver, RR_N_Fmc);
		click(driver, RR_N_Fmc);
		...
		Step_End(1, " Create a AC contract in N-FMC/LRR in agency ,", test, test1);
