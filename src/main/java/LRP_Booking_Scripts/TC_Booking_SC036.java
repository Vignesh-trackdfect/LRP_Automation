...
//Check whether while select the Rates in Rates window system will insert the Agreement party and Booking party and named customer in cusomer tab
public class TC_Booking_SC036 extends Keywords {

	public void Booking_SC036(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC036";
		...
		Step_Start(7, "System set the Customer in customer tab", test, test1);
		...
		String value3 = getAttribute(driver, CustomerName_TF, "value");
		if (value1.contains(value3)) {
			System.out.println("Matched || Expected value was : " + value1 + " || Actual value was : " + value3);
			Extent_pass_New(driver, "Matched || Expected value was : " + value1 + " || Actual value was : " + value3, test,test1);

		} else {
			System.out.println("NotMatched || Expected value was : " + value1 + " || Actual value was : " + value3);
			Extent_fail(driver, "NotMatched || Expected value was : " + value1 + " || Actual value was : " + value3,
					test, test1);
		}
		Step_End(7, "System set the Customer in customer tab", test, test1);
