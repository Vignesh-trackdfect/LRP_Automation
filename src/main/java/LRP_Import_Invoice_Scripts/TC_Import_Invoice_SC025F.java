...
public class TC_Import_Invoice_SC025F extends Keywords {
	public void Import_Invoice_SC025F(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Import_Invoice_SC025F";
		...
		if (waiverType.stream().allMatch(value -> "Inclusive".equalsIgnoreCase(value))) {
			...
			System.out.println("The detention waiver is created Not under the inclussive waiver type");
			Extent_fail(driver, "The detention waiver is created Not under the inclussive waiver type", test, test1);
		}
		// Import Invoice
		...
		if (DetentionStorage_Option.equals(Detention_Tab_Name_In_Iport_Invoice)) {
		...
		if (DetentionStorage_Option.equals(Storage_Tab_Name_In_Iport_Invoice)) {
