...
public class TC_Contract_Management_System_SC016 extends Keywords {
	public void Contract_Management_System_SC16(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC016";
		...
		if (Verified.equals(verifiednumber)) {
			Extent_pass(driver,
					...
					test, test1);
			System.out.println("Matched || Expected value is After click on verify button, The status should be : "
					+ Verified + " || Actual value is : After click on verify button, The status is :" + verifiednumber);
		} else {
			System.out.println("Not Matched || Expected value is : After click on verify button, The status should be : "
					+ Verified + " || Actual value is : After click on verify button, The status is : " + verifiednumber);
			Extent_fail(driver,
					"Not Matched || Expected value is : After click on verify button, The status should be : " + Verified
							+ " || Actual value is : After click on verify button, The status is : " + verifiednumber,
					test, test1);
		...
		Step_Start(19, "click on inactive button", test, test1);	
		...
		if (Draft.equals(InActive_field)) {
			System.out
			.println("Matched || Expected value is : After click on inactive button, The status should be : " + Draft + "||  Actual value is : After click on inactive button, The status is : " + InActive_field);
			Extent_pass(driver,"Matched || Expected value is : After click on inactive button, The status should be : " + Draft + "|| Actual value is : After click on inactive button, The status is  : " + InActive_field, test,test1);

		} else {
			System.out.println("Not Matched || Expected value is : After click on inactive button, The status should be : " + Draft + "|| Actual value is : After click on inactive button, The status is : " + InActive_field);
			Extent_fail(driver,"Not Matched || Expected value is : After click on inactive button, The status should be : " + Draft + " || Actual value is : After click on inactive button, The status is: " + InActive_field, test,test1);
		...
		if (Inactive_BackRoundColor.equalsIgnoreCase(INActivecolor)) {
			System.out.println("Matched || Expected : Backround color should be : " + Inactive_BackRoundColor + " || actual value : Backround color is : " + INActivecolor);
			Extent_pass(driver, "Matched || Expected : Backround color should be : "  + Inactive_BackRoundColor+ " || actual value : Backround color is :  " + INActivecolor, test, test1);
		} else {
			System.out.println("Not Matched || Expected : Backround color should be : " + Inactive_BackRoundColor + " || actual value : Backround color is Not matched : " + INActivecolor);
			Extent_fail(driver, "Not Matched || Expected : Backround color should be : " + Inactive_BackRoundColor + " || actual value : Backround color is not matched : " + INActivecolor, test, test1);
		}
	 	
		Step_End(19, "click on inactive button", test, test1);
