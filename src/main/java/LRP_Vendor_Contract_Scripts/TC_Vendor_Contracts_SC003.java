...
public class TC_Vendor_Contracts_SC003 extends Keywords {

	public void Vendor_Contracts_SC003(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Vendor_Contracts_SC003";
		...
		Step_End(16, "Click on the required activities and click 'select' option.", test, test1);

		Step_Start(17, "Double click on the amount column an give the required amount for the activities.", test,
				test1);
		...
		Step_End(25, "Click ok Option.  ", test, test1);
