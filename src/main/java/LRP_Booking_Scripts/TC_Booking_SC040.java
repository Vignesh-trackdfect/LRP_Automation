...
//Check whether in container tab carrier and shipper seal same then system should validate in Edit action
public class TC_Booking_SC040 extends Keywords {

	public void Booking_SC040(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC040";
		...
		String ShipperSeal1 = Excel_data.get("ShipperSeal1");
		String CarrieaSeal1 = Excel_data.get("CarrieaSeal1");
		String DummyContainer = Excel_data.get("DummyContainer");
		String random_no = Excel_data.get("random_no");
		String SameValue_Popup = Excel_data.get("SameValue_Popup");
		...
		Step_Start(7, "Enter the carrier and shipper  seal be same system validate", test, test1);
		...
		click(driver, Carrier_SealTF);
		sendKeys(driver, Carrier_SealTF, CarrieaSeal1);
		waitForElement(driver, Shipper_SealTF);
		click(driver, Shipper_SealTF);
		sendKeys(driver, Shipper_SealTF, ShipperSeal1);
		waitForElement(driver, Container_Edit_Btn);
		click(driver, Container_Edit_Btn);

		String Value3 = getText(driver, Dummy_container_Popup);
		if (DummyContainer.contains(Value3)) {
			System.out
			.println("Matched || The Expected Pop-up Value is: " + DummyContainer + " || The Actual Pop-up Value is : " + Value3);
			Extent_pass_New(driver,
					"Matched || The Expected Pop-up Value is:  " + DummyContainer + " || The Actual Pop-up Value is : " + Value3, test,
					test1);
		} else {
			System.out.println(
					"NotMatched || The Expected Pop-up Value is " + DummyContainer + " || The Actual Pop-up Value is :" + Value3);
			Extent_fail(driver,
					"NotMatched || The Expected Pop-up Value is " + DummyContainer + " || The Actual Pop-up Value is : " + Value3, test,
					test1);
		}

		waitForElement(driver, dummy_container_yes);
		click(driver, dummy_container_yes);
		waitForElement(driver, Carrier_shipper_SamePopup);
		String value4 = getText(driver, Carrier_shipper_SamePopup);
		if (SameValue_Popup.equals(value4)) {
			System.out
			.println("Matched || Expected  Pop-up value is : " + SameValue_Popup + " || The Actual Pop-up Value is : " + value4);
			Extent_pass_New(driver,
					"Matched || Expected  Pop-up value is  : " + SameValue_Popup + " || The Actual Pop-up Value is : " + value4, test,
					test1);
		} else {
			System.out.println(
					"NotMatched || Expected  Pop-up value is  : " + SameValue_Popup + " || Actual value was : " + value4);
			Extent_fail(driver,
					"NotMatched || Expected  Pop-up value is  : " + SameValue_Popup + " || Actual value was : " + value4, test,
					test1);
		}

		waitForElement(driver, popup_Message_Ok_Button);
		click(driver, popup_Message_Ok_Button);
		Step_End(7, "Enter the carrier and shipper  seal be same system validate", test, test1);
