...
public class TC_Contract_Management_System_SC219 extends Keywords {
	public void Contract_Management_System_SC219(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC219";
		...
		Step_Start(6, "Import the port pair lanes with DG YES and OOG YES and without  the DG and OOG details.", test,
				test1);
