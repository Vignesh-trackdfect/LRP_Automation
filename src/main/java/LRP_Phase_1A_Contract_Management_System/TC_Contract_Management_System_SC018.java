...
public class TC_Contract_Management_System_SC018 extends Keywords {
public void Contract_Management_System_SC18(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC018";
...
//		
		...
		if (Activated_avl1.equals(Activated)) {
			System.out.println("Matched || Expected value is : After click on Activate button, The status should be  : " + Activated + " || Actual value is : After click on Activate button, The status is :" + Activated_avl1);
			Extent_pass(driver,"Matched || Expected value is : After click on Activate button, The status should be  : " + Activated + " || Actual value is : After click on Activate button, The status is :" + Activated_avl1, test,test1);
			
		} else {

			System.out.println("UnMatched || Expected value is : After click on Activate button, The status should be  : " + Activated + " || Actual value is : After click on Activate button, The status is :" + Activated_avl1);

			Extent_fail(driver,"UnMatched || Expected value is : After click on Activate button, The status should be  : " + Activated + " || Actual value is : After click on Activate button, The status is :" + Activated_avl1, test,test1);
		
		}
		

		Step_End(20, " change the cust code and re-do the process till activate status.", test, test1);
