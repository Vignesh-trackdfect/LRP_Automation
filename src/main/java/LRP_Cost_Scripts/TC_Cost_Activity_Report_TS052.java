...
public class TC_Cost_Activity_Report_TS052 extends Keywords {
	...
	public void Cost_Activity_Report_TS052(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		for (WebElement approveddata : approved_rows) {
			...
			if (!Fieldcolor.equals(ColorCode) || !Fieldcolor.equals(disbursement_ColorCode)) {
				...
				waitForElement(driver, approveddata);
