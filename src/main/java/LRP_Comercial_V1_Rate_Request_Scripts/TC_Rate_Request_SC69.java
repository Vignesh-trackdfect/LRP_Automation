...
public class TC_Rate_Request_SC69 extends Keywords{
	...
	public void Rate_Request_SC69(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
		...
		Step_End(14, "Click Add", test, test1);
			...
			if(Req_Submit_Popup_Txt.equals(PopUp_Msg)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Report Activity is :popup message should be shown " + Req_Submit_Popup_Txt + " || Actual Report Activity is :popup message should be shown " + PopUp_Msg);            
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity is :popup message should be shown " + Req_Submit_Popup_Txt + " || Actual Report Activity is :popup message should be shown " + PopUp_Msg, test, test1);     
				...
				System.out.println("Not Matched || " + " Expected Report Activity is :popup message is not shown " + Req_Submit_Popup_Txt + " || Actual Report Activity is :popup message is not shown " + PopUp_Msg);        
				Extent_fail(driver, "Not Matched || " + " Expected Report Activity is :popup message is not shown " + Req_Submit_Popup_Txt + " || Actual Report Activity is :popup message is not shown " + PopUp_Msg, test, test1); 
			} 
