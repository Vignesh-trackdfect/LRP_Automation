...
public class TC_Feeder_Contract_SC44 extends Keywords {

	public void Feeder_Contract_SC44(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC44";
		...
		Step_Start(22, "Double click the amount and enter the value", test, test1);
		...
		for (String charge_Type : given_ChargeTypes) {
			...
			formatLocatorjsClick(driver, FC_ChargeType_Dropdown, String.valueOf(i));

			formatLocatorClick(driver, DropDown_Select, charge_Type);

			if (charge_Type.equals("LumpSum") || charge_Type.equals("Percentage")) {

				String AmountInput = String.format(FC_Amount_Input, i);
				...
				formatLocatorClick(driver, FC_SurchargeRowSelect, String.valueOf(i));
		...
		Step_End(22, "Double click the amount and enter the value", test, test1);
