...
public class TC_Booking_SC057 extends Keywords {

	public void Booking_SC057(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC057";
		...
		Extent_call(test, test1,"********** Fetching the Values Berfore Reset the POL - Start **********");
		waitForElement(driver, OrginInput);
		String origin_Field_value=getAttribute(driver, OrginInput,"value");
		waitForDisplay(driver, OrginInput);
		if(isDisplayed(driver,OrginInput)) {
			Extent_pass_New(driver,"Matched || Before Reseting the Origin the Agr party Text field value is :" +origin_Field_value, test,test1);
			System.out.println("Matched || Before Reseting the Origin the Agr party Text field value is : " +origin_Field_value);
		}else {
			System.out.println("Not Matched || Before Reseting the Origin the Commodity Gruop value is not displayed");
			Extent_fail(driver,"Not Matched || Before Reseting the Origin the Commodity Gruop value is not displayed", test,test1);
		}
		waitForElement(driver, Edit_Button_toolBar);
		...
		if(isDisplayed(driver,Charges_Grid_edit)) {
			Extent_pass_New(driver,"Matched || Before Reseting the Origin the Charges Grid is displayed ", test,test1);
			System.out.println("Matched || Before Reseting the Origin the Charges Grid is displayed");
			Extent_pass_New(driver, "Charges Grid is displayed", test,test1);
		}else {
			System.out.println("Not Matched || Before Reseting the Origin the Charges Grid value is not displayed || Charges Grid is not displayed");
			Extent_fail(driver,"Not Matched || Before Reseting the Origin the Charges Grid value is not displayed || Charges Grid is not displayed ", test,test1);
		}
		scrollTop(driver);
		...
		if(isDisplayed(driver,Commodity_Gruop)) {
			Extent_pass_New(driver,"Matched || Before Reseting the Origin the Commodity Gruop value is :" +Commodity_Gruop_value, test,test1);
			System.out.println("Matched || Before Reseting the Origin the Commodity Gruop value is : " +Commodity_Gruop_value);
		}else {
			System.out.println("Not Matched || Before Reseting the Origin the Commodity Gruop value is not displayed");
			Extent_fail(driver,"Not Matched || Before Reseting the Origin the Commodity Gruop value is not displayed", test,test1);
		}
		...
		if(Container_grid_Color.equals(act_ContainerGrid_colour)) {
			Extent_pass_New(driver,"Matched || Before Reseting the Origin container tab colour is Yellow Color : " +act_ContainerGrid_colour, test,test1);
			System.out.println("Matched || Before Reseting the Origin container tab colour is Yellow Color : " +act_ContainerGrid_colour);
		}else {
			System.out.println("Not Matched || Before Reseting the Origin container tab colour is Not Yellow Color : "+act_ContainerGrid_colour);
			Extent_fail(driver,"Not Matched || Before Reseting the Origin container tab colour is Not Yellow Color : "+act_ContainerGrid_colour, test,test1);
		}
		...
		if(isDisplayed(driver, Rate_No_Value)) {
			Extent_pass_New(driver,"Matched || Before Reseting the Origin container tab Rate No is :" +Act_Rate_No, test,test1);
			System.out.println("Matched || Before Reseting the Origin container tab Rate No is : " +Act_Rate_No);
		}else {
			System.out.println("Not Matched || Before Reseting Origin the container tab Rate No is : " +Act_Rate_No);		
			Extent_fail(driver, "Not Matched || Before Reseting Origin the container tab Rate No is : " +Act_Rate_No, test,test1);
		}
		Extent_call(test, test1,"********** Fetching the Values Berfore Reset the POL - End **********");
		Step_End(7, "select confirm button and click Save button", test, test1);

		Step_Start(8, "Reset the POL", test, test1);
		scrollTop(driver);
		waitForElement(driver, Reset_Btn);
		safeclick(driver, Reset_Btn);
		waitForElement(driver, Reset_POL);
		safeclick(driver, Reset_POL);
		waitForElement(driver, Popup_Msg);
		String Actual_Popup=getText(driver, Popup_Msg);
		if(Reset_Agr_Popopup.equals(Actual_Popup)) {
			Extent_pass_New(driver, "Matched || Expected popup: "+Reset_Agr_Popopup+"|| Actual Popup:"+Actual_Popup , test,test1);
			System.out.println("Matched || Expected popup: "+Reset_Agr_Popopup+"|| Actual Popup:"+Actual_Popup);
			safeclick(driver, Popup_Ok);
		}else {
			System.out.println("Not Matched || Expected popup: "+Reset_Agr_Popopup+"|| Actual Popup:"+Actual_Popup);
			Extent_fail(driver, "Not Matched || Expected popup: "+Reset_Agr_Popopup+"|| Actual Popup:"+Actual_Popup , test,test1);
		}

		waitForElement(driver, Popup_Msg);
		String Act_Popup=getText(driver, Popup_Msg);
		if(Agr_Reseted_Popup_Msg.equals(Act_Popup)) {
			Extent_pass_New(driver, "Matched || Actual Pop-up Value is: "+Agr_Reseted_Popup_Msg+"|| Actual Popup Value is:"+Act_Popup , test,test1);
			System.out.println("Matched || Expected popup Value is: "+Agr_Reseted_Popup_Msg+"|| Actual Popup Value is:"+Act_Popup);
		}else {
			System.out.println("Not Matched || Expected popup Value is: "+Agr_Reseted_Popup_Msg+"|| Actual Popup:"+Act_Popup);
			Extent_fail(driver, "Not Matched || Expected popup Value is: "+Agr_Reseted_Popup_Msg+"|| Actual Popup:"+Act_Popup , test,test1);
		}
		safeclick(driver, popup_Message_Ok_Button);
		waitForElement(driver, SaveButton_ToolBar);
		...
		waitForElement(driver, popup_Message_Ok_Button);
		safeclick(driver, popup_Message_Ok_Button);
		Step_End(8, "Reset the POL", test, test1);		

		Extent_call(test, test1,"********** Fetching the Values After Reset the POL - Start **********");
		waitForElement(driver, OrginInput);
		String origin_Field_value1=getAttribute(driver, OrginInput,"value");
		if(!origin_Field_value.equals(origin_Field_value1)) {
			Extent_pass_New(driver,"Matched || After Reseting the Origin the Commodity Gruop value is not displayed", test,test1);
			System.out.println("Matched || After Reseting the Origin the Commodity Gruop value is not displayed");
		}else {
			System.out.println("Not Matched || After Reseting the Origin the Agr party Text field value is :" +origin_Field_value1);
			Extent_fail(driver,"Not Matched || After Reseting the Origin the Agr party Text field value is :" +origin_Field_value1, test,test1);
		}
		scrollTop(driver);
		waitForElement(driver, commodity_tab);
		safeclick(driver, commodity_tab);
		...
		if(!Commodity_Gruop_value.equals(Commodity_Gruop_value1)) {
			Extent_pass_New(driver,"Matched || After Reseting the Origin the Commodity Gruop value is not displayed"+Commodity_Gruop_value1, test,test1);
			System.out.println("Matched || After Reseting the Origin the Commodity Gruop value is not displayed"+Commodity_Gruop_value1);
		}else {
			System.out.println("Not Matched || After Reseting the Origin the Commodity Gruop value is : "+Commodity_Gruop_value1);
			Extent_fail(driver,"Not Matched || After Reseting the Origin the Commodity Gruop value is : "+Commodity_Gruop_value1, test,test1);
		}
		scrollTop(driver);
		waitForElement(driver, Container_Tab);
		safeclick(driver, Container_Tab);
		...
		if(!act_ContainerGrid_colour.equals(act_ContainerGrid_colour1)) {
			Extent_pass_New(driver,"Matched || After Reseting the Origin container tab colour is Pink Color : " +act_ContainerGrid_colour1, test,test1);
			System.out.println("Matched || After Reseting the Origin container tab colour is Pink Color : " +act_ContainerGrid_colour1);		
		}else {
			System.out.println("Not Matched || After Reseting Origin the container tab colour is Not  Pink Color : "+act_ContainerGrid_colour1);
			Extent_fail(driver,"Not Matched || After Reseting Origin the container tab colour is Not Pink Color : "+act_ContainerGrid_colour1, test,test1);
		}
		scrollUsingElement(driver, Rate_No_Value);
		waitForElement(driver, Rate_No_Value);
		String Act_Rate_No1 = getText(driver, Rate_No_Value);
		if(!Act_Rate_No.equals(Act_Rate_No1)) {
			Extent_pass_New(driver,"Matched || After Reseting the Origin container tab Rate No is Not displayed"+Act_Rate_No1, test,test1);
			System.out.println("Matched || After Reseting the Origin container tab Rate No is Not displayed" +Act_Rate_No1);
		}else {
			System.out.println("Not Matched || After Reseting the Origin container tab Rate No is : " +Act_Rate_No1);		
			Extent_fail(driver, "Not Matched || After Reseting the Origin container tab Rate No is : " +Act_Rate_No1, test,test1);
		}
		scrollTop(driver);
		waitForElement(driver, Charges_tab);
		safeclick(driver, Charges_tab);
		waitForDisplay(driver, Charges_Grid_edit);
		if(!isDisplayed(driver, Charges_Grid_edit)) {
			Extent_pass_New(driver,"Matched || After Reseting the Origin the Charges Grid value is not displayed", test,test1);
			System.out.println("Matched || After Reseting the Origin the Charges Grid value is not displayed");
			Extent_pass_New(driver, "Charges Grid is not displayed ", test,test1);	
		}else {
			waitForElement(driver, chargesGrid);
			String chargesGrid_value1=getText(driver, chargesGrid);
			System.out.println("Not Matched || After Reseting the Origin the Charges Grid value is : "+chargesGrid_value1+" || Charges Grid is displayed");
			Extent_fail(driver,"Not Matched || After Reseting the Origin the Charges Grid value is :" +chargesGrid_value1+" || Charges Grid is displayed", test,test1);
		}
		Extent_call(test, test1,"********** Fetching the Values After Reset the POL - End **********");
