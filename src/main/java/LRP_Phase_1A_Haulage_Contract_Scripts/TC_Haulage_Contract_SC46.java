...
public class TC_Haulage_Contract_SC46 extends Keywords{
	public void Haulage_Contract_SC46(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC46";
		...
		String DG_Applied_Popup = Excel_data.get("DG_Applied_Popup");
		...
		waitForPopup(driver, popup_Message,DG_Applied_Popup);
		String Applied_Popup = getText(driver, popup_Message);
		System.out.println(Applied_Popup);
		if(Applied_Popup.equals(DG_Applied_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + DG_Applied_Popup + " || Actual Popup is : " + Applied_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + DG_Applied_Popup + " || Actual Popup is : " + Applied_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + DG_Applied_Popup + " || Actual Popup is : " + Applied_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + DG_Applied_Popup + " || Actual Popup is : " + Applied_Popup, test,test1); 
		}
		
		waitForDisplay(driver, HC_DG_Empty_Row);
		if(!isdisplayed(driver, HC_DG_Empty_Row)) {                                                                                                                  
			System.out.println("Matched || " + " Expected : DG details row should be displayed || Actual : DG details row is displayed");            
			Extent_pass_New(driver, "Matched || " + " Expected : DG details row should be displayed || Actual : DG details row is displayed", test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected : DG details row should be displayed || Actual : DG details row is not displayed");        
			Extent_fail(driver, "Not Matched || " + " Expected : DG details row should be displayed || Actual : DG details row is not displayed", test,test1); 
		}
