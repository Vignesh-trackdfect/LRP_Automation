...
public class TC_Contract_Management_System_SC248 extends Keywords{

	public void Contract_Management_System_SC248(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC248";
		...
		Step_Start(7, "Import the port pair lanes with the validity.", test, test1);
		...
		scrollTop(driver);
		Step_End(7, "Import the port pair lanes with the validity.", test, test1);
		...
		if(!effective_date.equals(Valid_from_date)) {
			Extent_pass(driver,"Expected value || The Effective Date in the General tab must not be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+effective_date+" || Actual value || The Valid From date in the Portpair tab must not be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_from_date, test,test1);
			System.out.println("Expected value || The Effective Date in the General tab must not be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+effective_date+" || Actual value || The Valid From date in the Portpair tab must not be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_from_date);
		}else {
			Extent_fail(driver,"Expected value || The Effective Date in the General tab must  be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+effective_date+" || Actual value || The Valid From date in the Portpair tab must  be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_from_date, test,test1);
			System.out.println("Expected value || The Effective Date in the General tab must  be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+effective_date+" || Actual value || The Valid From date in the Portpair tab must  be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_from_date);
		...
		if(!expiry_date.equals(Valid_to_date)) {
			Extent_pass(driver,"Expected value || The Expiry Date in the General tab must not be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+expiry_date+" || Actual value || The Valid To date in the Portpair tab must not be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_to_date, test,test1);
			System.out.println("Expected value || The Expiry Date in the General tab must not be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+expiry_date+" || Actual value || The Valid To date in the Portpair tab must not be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_to_date);
		}else {
			Extent_fail(driver,"Expected value || The Expiry Date in the General tab must  be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+expiry_date+" || Actual value || The Valid To date in the Portpair tab must  be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_to_date, test,test1);
			System.out.println("Expected value || The Expiry Date in the General tab must  be equal to the Actual value in the Portpair tab ,|| Expected Effective Date: "+expiry_date+" || Actual value || The Valid To date in the Portpair tab must  be equal to the expected value in the General tab Expected Valid From Date:"+ Valid_to_date);
