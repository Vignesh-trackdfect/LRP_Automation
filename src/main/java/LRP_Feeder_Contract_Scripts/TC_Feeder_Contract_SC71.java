...
public class TC_Feeder_Contract_SC71 extends Keywords {

	public void Feeder_Contract_SC71(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC71";
		...
		Step_Start(27, "System show the validation pop,Cannot able to save.", test, test1);
		...
		waitForPopup(driver, FC_Duplicate_Msg, Duplicate_popup);

		String ActualSaved_popup2 = getText(driver, FC_Duplicate_Msg);

		if (Duplicate_popup.equals(ActualSaved_popup2)) {
		...
		Step_End(27, "System show the validation pop,Cannot able to save.", test, test1);
