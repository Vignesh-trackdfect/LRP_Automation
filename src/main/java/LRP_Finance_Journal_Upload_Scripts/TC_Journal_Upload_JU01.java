...
public class TC_Journal_Upload_JU01 extends Keywords{
	public void Journal_Upload_JU01(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws EncryptedDocumentException, InvalidFormatException, IOException{
		String testcase_Name="TC_Journal_Upload_JU01";
		...
		Step_Start(2, "Click template button , Excel Template will automatically download", test, test1);
		waitForElement(driver, JU_Template_Button);
		String downloaded_Path = downloadFile(driver, JU_Template_Button);
		if (!downloaded_Path.equals("")) {
			Extent_pass_New(driver, "Matched || The Expected Result : After Clicking the Template Button the Excel Sheet Should be Download ||The Actual Result is : After Clicking the Template Button the Excel Sheet was Downloaded . The Downloaded File Path is : "+downloaded_Path, test,test1);
			System.out.println("Matched || The Expected Result : After Clicking the Template Button the Excel Sheet Should be Download ||The Actual Result is : After Clicking the Template Button the Excel Sheet was Downloaded . The Downloaded File Path is : "+downloaded_Path);
		} else {
			System.out.println("Not Matched || The Expected Result : After Clicking the Template Button the Excel Sheet Should be Download ||The Actual Result is : After Clicking the Template Button the Excel Sheet was Not Downloaded");
			Extent_fail(driver,"Not Matched || The Expected Result : After Clicking the Template Button the Excel Sheet Should be Download ||The Actual Result is : After Clicking the Template Button the Excel Sheet was Not Downloaded", test,test1);
		}
		Step_End(2, "Click template button , Excel Template will automatically download", test, test1);
		Step_Start(3, "Click Import excel option popup window will appear", test, test1);
		waitForElement(driver, JU_Import_Excel_Button);
		click(driver, JU_Import_Excel_Button);
		Step_End(3, "Click Import excel option popup window will appear", test, test1);
		Step_Start(4, "Click select Excel file optiom and popup window will appear and now select the excel file which is having different batch number and multiple entries", test, test1);
		...
		Step_End(4, "Click select Excel file optiom and popup window will appear and now select the excel file which is having different batch number and multiple entries", test, test1);
		Step_Start(5, "Excel file loaded in that screen ", test, test1);
		waitForElement(driver, JU_Excel_AutoMap_Yes_Button);
		click(driver, JU_Excel_AutoMap_Yes_Button);
		Step_End(5, "Excel file loaded in that screen ", test, test1);
		Step_Start(6, "Click Upload button", test, test1);
		waitForElement(driver, JU_Excel_Upload_Button);
		click(driver, JU_Excel_Upload_Button);
		Step_End(6, "Click Upload button", test, test1);
		Step_Start(7, "Journal Uploaded successfully in that journal upload screen", test, test1);
		waitForElement(driver, JU_Select_All_Check_Box);
		Step_End(7, "Journal Uploaded successfully in that journal upload screen", test, test1);
		click(driver, JU_Select_All_Check_Box);
		Step_Start(8, "Click verify button", test, test1);
		waitForElement(driver, JU_Verify_Button);
		click(driver, JU_Verify_Button);
		Step_End(8, "Click verify button", test, test1);
		Step_Start(9, "Journal verified successfully .", test, test1);
		...
		Step_End(9, "Journal verified successfully .", test, test1);
		Step_Start(10, "Click Post button , Journal posted successfully", test, test1);
		...
		Step_End(10, "Click Post button , Journal posted successfully", test, test1);
		Step_Start(11, "Saved Journal entry can able to view in journal module screen", test, test1);
		...
		Step_End(11, "Saved Journal entry can able to view in journal module screen", test, test1);
