...
public class TC_Feeder_Contract_SC07 extends Keywords {
	public void Feeder_Contract_SC07(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testcase_Name = "TC_Feeder_Contract_SC07";
		...
		Step_Start(5, "Click the POL field and Select the value", test, test1);
		...
		Step_End(5, "Click the POL field and Select the value", test, test1);
		Step_Start(6, "Based on POL ,We can select the Load location\"", test, test1);
		waitForElement(driver, FC_POL_Input);
		String Pickup_Location_Value_Act = getAttribute(driver, FC_POL_Input, "value");
		...
		Step_End(6, "Based on POL ,We can select the Load location\"", test, test1);
