...
public class TC_DG_Creation_SC_085 extends Keywords {


	public void DG_Creation_SC_085(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_085";
...
//		Module Search
		...
		if(Saved_Popup.equals(Details_Saved_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup : " + Details_Saved_Popup + " || Actual Popup : " + Saved_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup: " + Details_Saved_Popup + " || Actual Popup : " + Saved_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup : " + Details_Saved_Popup + " || Actual Popup : " + Saved_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup : " + Details_Saved_Popup + " || Actual Popup : " + Saved_Popup, test,test1); 
		}
		...
		if(act_Popup.equals(Request_Sent_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup : " + Request_Sent_Popup + " || Actual Popup : " + act_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup: " + Request_Sent_Popup + " || Actual Popup : " + act_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup : " + Request_Sent_Popup + " || Actual Popup : " + act_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup : " + Request_Sent_Popup + " || Actual Popup : " + act_Popup, test,test1); 
		}
