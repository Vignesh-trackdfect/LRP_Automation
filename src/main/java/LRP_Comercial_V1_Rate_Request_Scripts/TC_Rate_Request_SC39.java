...
public class TC_Rate_Request_SC39 extends Keywords {
	...
	public void Rate_Request_SC39(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Dg_class = Excel_data.get("Dg_class");
		String UN_Number_header =Excel_data.get("UN_Number_header");
...
newButton(driver);
		...
		if(DG_checkboxs.equalsIgnoreCase("Yes")) {
			...
			if(actDGDetailsFrame.equals(dGDetailsFrame)) {
				Extent_pass_New(driver,"Matched || Expected Result is : "+dGDetailsFrame+" Actual Result is : "+ actDGDetailsFrame, test,test1);
				System.out.println("Matched || Expected Result is : "+dGDetailsFrame+" Actual Result is : "+ actDGDetailsFrame);
				...
				twoColumnSearchWindow(driver,UN_Number_header,Condition_Value,unno);
				...
				System.out.println("Not Matched || Expected Result is : "+dGDetailsFrame+" Actual Result is : "+ actDGDetailsFrame);

				Extent_fail(driver,"Not Matched || Expected Result is : "+dGDetailsFrame+" Actual Result is : "+ actDGDetailsFrame, test,test1);
			}
		...
		waitForElement(driver, SaveButton_ToolBar);
		click(driver, SaveButton_ToolBar);
		waitForElement(driver, Filed_val);
