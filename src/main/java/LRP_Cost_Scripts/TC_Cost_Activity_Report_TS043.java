...
public class TC_Cost_Activity_Report_TS043 extends Keywords {
	...
	public void Cost_Activity_Report_TS043(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Operational_Warning = Excel_data.get("Operational_Warning");
		...
		waitForPopup(driver, popup_Message, Operational_Warning);
		...
		if (WarningMessage.equals(Operational_Warning)) {
			...
			Extent_pass_New(driver, "User can't able to remove the Operational main activity || Expected : "
