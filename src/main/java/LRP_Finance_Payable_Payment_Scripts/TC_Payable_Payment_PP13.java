...
public class TC_Payable_Payment_PP13 extends Keywords {

	public void Payable_Payment_PP13(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Payable_Payment_PP13";
		...
		if (payment_Date.equals("")) {
         ...
         if (payment_Date.equals(actual_Payment_Date)) {
			...
			Step_End(2, "Payment date will be automatically selected based on month", test, test1);
			Step_Start(3, "Select the search icon near customer tab, without entering values in customer field", test,
					test1);
		...
		String cheque_Drpdwn_Option_Rr = String.format(Payable_Payment_Locators.cheque_Drpdwn_Option_PPT,
				cheque_Drpdwn_Data);
		...
		if (!isElementEnabled(driver, chequeTT_No_Txtfld_PPT)) {

			System.out.println(
					"The expected Result is : Once user select the cash, The cheque/TT No should be disabled and Acutal result is : Once user select the cash, The cheque/TT No field is disabled");
			...
			System.out.println(
					"The expected Result is : Once user select the cash, The cheque/TT No should be disabled and Acutal result is : Once user select the cash, The cheque/TT No field is still enabled");
			Extent_fail(driver,
					"The expected Result is : Once user select the cash, The cheque/TT No should be disabled and Acutal result is : Once user select the cash, The cheque/TT No field is still enabled",
					test, test1);
