...
public class EMS_Contract_Registration_IP008 extends Keywords{
	...
	public void emscontractregistrationip008 (WebDriver driver,ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {
		...
		String Contractno8 = Excel_data.get("Contractno8");	
		String ContractType8 = Excel_data.get("ContractType8");	
		...
		String exist_sizetype = Excel_data.get("exist_sizetype");	
