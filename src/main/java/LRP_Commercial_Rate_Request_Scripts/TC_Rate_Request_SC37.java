...
public class TC_Rate_Request_SC37 extends Keywords {
	...
	public void rate_Request_Sc37(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String Routingpopexp =Excel_data.get("Routingpopexp");
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			waitForPopup(driver, Popup_Message, Routingpopexp);			

			String PopUp_Msg11=getText(driver, Popup_Message);    
			System.out.println(PopUp_Msg11);
			if(Routingpopexp.equals(PopUp_Msg11)) {                                                                                                                  
				System.out.println("Matched || " + "Expected : popup message should be shown as : " + Routingpopexp + " || Actual : popup message is shown as : " + PopUp_Msg11);            
				Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + Routingpopexp + " || Actual : popup message is shown as : " + PopUp_Msg11, test,test1);     
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + Routingpopexp + " || Actual : popup message is shown as : " + PopUp_Msg11);        
				Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + Routingpopexp + " || Actual : popup message is shown as : " + PopUp_Msg11, test,test1); 
