...
public class TC_Import_Documentation_SC058 extends Keywords {

	public void Import_Documentation_SC058(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Import_Documentation_SC058";
		...
		Step_Start(7, ".click the Import invoice button in IMport documenation.(Capture the Name)", test, test1);
		waitForElement(driver, Invoice_Button);
		String Import_Invoice_Button_Text=getText(driver, Invoice_Button);
		System.out.println("Text of the Import invoice Button:"+Import_Invoice_Button_Text);
		...
		Step_End(7, ".click the Import invoice button in IMport documenation.(Capture the Name)", test, test1);

		Step_Start(8, "once clicked tht Import invoice ,system has open the Import invoice module.(Verify the Same name", test, test1);
		String Import_Notice_Frame=getText(driver, Import_Invoice_Module_Title);
		System.out.println("Import invoice Module Text:"+Import_Notice_Frame);

		if (Import_Notice_Frame.equalsIgnoreCase(Import_Invoice_Button_Text)) {
			System.out.println("Matched || Text of the Import invoice Button : " + Import_Invoice_Button_Text + " || Import invoice Module Text: " + Import_Notice_Frame);
			Extent_pass_New(driver, "Matched ||Text of the Import invoice Button: " + Import_Invoice_Button_Text + " || Import invoice Module Text: " + Import_Notice_Frame, test,
					test1);
		} else {
			System.out.println("Not Matched || Text of the Import invoice Button: " + Import_Invoice_Button_Text + " || Import invoice Module Text : " + Import_Notice_Frame);
			Extent_fail(driver, "Not Matched ||Text of the Import invoice Button: " + Import_Invoice_Button_Text + " || Import invoice Module Text : " + Import_Notice_Frame,
					test, test1);
		}

		Step_Start(8, "once clicked that Import invoice ,system has open the Import invoice module.(Verify the Same name", test, test1);
