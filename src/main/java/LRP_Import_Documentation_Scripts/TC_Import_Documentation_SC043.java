...
public class TC_Import_Documentation_SC043 extends Keywords {

	public void Import_Documentation_SC043(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name="TC_Import_Documentation_SC043";
	...
	String ChargeCodevalues=Excel_data.get("ChargeCodeEdit");
	...
	String saved_popup_expected = Excel_data.get("SavedPopup");
	...
	//
	Step_Start(11, "Added charges are shown in Below grid", test, test1);
	waitForElement(driver, charges_table_headers);
	...
	Step_End(11, "Added charges are shown in Below grid", test, test1);

	Step_Start(12, "Save the Import Documentation", test, test1);
	scrollTop(driver);
	waitForElement(driver, SaveButton_ToolBar);
	jsClick(driver, SaveButton_ToolBar);
	
	Step_End(12, "Save the Import Documentation", test, test1);

	Step_Start(13, "Once saved, the Import Documentation system has validated that Import Documentation is saved", test, test1);
	
	waitForPopup(driver, popup_Message, saved_popup_expected);
	String saved_popup_actual = getText(driver, popup_Message);
	
	if(saved_popup_expected.equals(saved_popup_actual)) {
		
		System.out.println("Matched || Expected saved popup : "+saved_popup_expected+"|| Actual saved popup : "+saved_popup_actual);
		Extent_pass_New(driver, "Matched || Expected saved popup : "+saved_popup_expected+"|| Actual saved popup : "+saved_popup_actual, test, test1);
	}else {
		
		System.out.println("Not Matched || Expected saved popup : "+saved_popup_expected+"|| Actual saved popup : "+saved_popup_actual);
		Extent_fail(driver, "Not Matched || Expected saved popup : "+saved_popup_expected+"|| Actual saved popup : "+saved_popup_actual, test, test1);
	}
	
	waitForElement(driver, popup_Message_Ok_Button);
	click(driver, popup_Message_Ok_Button);
	
	Step_End(13, "Once saved, the Import Documentation system has validated that Import Documentation is saved", test, test1);
	...
	Step_Start(15, "Once saved, the Import Documentation new, search, edit, and delete icons are shown in the toolbar", test, test1);
	...
	Step_End(15, "Once saved, the Import Documentation new, search, edit, and delete icons are shown in the toolbar", test, test1);

	Step_Start(16, "Click the delete icon, and the system validates 'Do you want to delete import documentation? YES or NO'", test, test1);
	Step_Start(17, "Click YES, and the system validates Import Documentation is deleted", test, test1);
	...
	Step_End(16, "Click the delete icon, and the system validates 'Do you want to delete import documentation? YES or NO'", test, test1);
	Step_End(17, "Click YES, and the system validates Import Documentation is deleted", test, test1);
