...
public class TC_DG_Creation_SC_045 extends Keywords {


	public void DG_Creation_SC_045(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_045";
...
//		Module Search
		...
		Step_Start(6, "Click file upload", test, test1);
		...
		System.out.println(Saved_Popup);
		if(File_Size_Popup.equals(FileSizepop)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + File_Size_Popup + " || Actual Popup is : " + FileSizepop);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + File_Size_Popup + " || Actual Popup is : " + FileSizepop, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + File_Size_Popup + " || Actual Popup is : " + FileSizepop);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + File_Size_Popup + " || Actual Popup is : " + FileSizepop, test,test1);
		}
		...
		Step_End(6, "Click file upload", test, test1);
