...
public class TC_Haulage_Contract_SC21 extends Keywords{
	public void Haulage_Contract_SC21(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC21";
		...
		click(driver, HC_LDN_MTY_Select);
		 ...
		 Step_Start(5, "Click the Currency search and select the Currency.", test, test1);
		...
		waitForElement(driver, currency_Textfield_HC);
         String actualCurrency = getAttribute(driver, currency_Textfield_HC, "value");	
         
         if(CurrencyCode.equals(actualCurrency)) {
        	 System.out.println("Matched|| Expected Currency Code :"+CurrencyCode + " ||  Actual Currency Code : "+actualCurrency);
        	 Extent_pass_New(driver, "Matched|| Expected Currency Code :"+CurrencyCode + " ||  Actual Currency Code : "+actualCurrency, test, test1);
         }else {
        	 System.out.println("Not Matched || Expected Currency Code :"+CurrencyCode + "||  Actual Currency Code : "+actualCurrency);
             Extent_fail(driver, "Not Matched ||Expected Currency Code :"+CurrencyCode + " ||  Actual Currency Code : "+actualCurrency, test, test1);
         }
		
         Step_End(5, "Click the Currency search and select the Currency.", test, test1);
