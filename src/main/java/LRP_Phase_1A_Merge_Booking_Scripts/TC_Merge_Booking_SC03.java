...
public class TC_Merge_Booking_SC03 extends Keywords {

	public void Merge_Booking_SC03(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_Merge_Booking_SC03";
		...
		Step_Start(1, "Create two non-containerised bookings in Draft status", test, test1);
		...
		Step_End(1, "Create two non-containerised bookings in Draft status", test, test1);
