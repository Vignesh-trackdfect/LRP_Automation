...
public class TC_Vendor_Contracts_SC002 extends Keywords {

	public void Vendor_Contracts_SC002(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Vendor_Contracts_SC002";
		...
		for (String activitycode : activitycodes) {
			...
			waitForPopup(driver, popup_Message, Activity_Remove_Popup);
		...
		for (String activitycode : Mainactivities) {
			
			waitForElement(driver, Vendor_Filter);
			click(driver, Vendor_Filter);
			
			waitForElement(driver, VC_Activityfilter);
			clear(driver, VC_Activityfilter);
			sendKeys(driver, VC_Activityfilter, activitycode);
