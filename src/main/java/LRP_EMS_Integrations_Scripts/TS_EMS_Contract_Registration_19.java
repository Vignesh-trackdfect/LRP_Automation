...
public class TS_EMS_Contract_Registration_19 extends Keywords {
	...
	public void EMS_Contract_Registration_19(WebDriver driver, ExtentTest test, ExtentTest test1,
		...
		String sizetype_pickup_value = Excel_data.get("sizetype_pickup_value");
		...
		String pickup_quantity_popup_msg = Excel_data.get("pickup_quantity_popup_msg");
		String termcharge_pickup_value = Excel_data.get("termcharge_pickup_value");
