...
public class TC_Contract_Management_System_SC245 extends Keywords{

	public void Contract_Management_System_SC245(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC245";
		...
		Step_Start(7, "Import the port pair lanes without the validity.", test, test1);
		...
		scrollTop(driver);
		Step_End(7, "Import the port pair lanes without the validity.", test, test1);
