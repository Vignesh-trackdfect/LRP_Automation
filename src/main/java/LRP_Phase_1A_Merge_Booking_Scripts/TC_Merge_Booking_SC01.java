...
public class TC_Merge_Booking_SC01 extends Keywords {

	public void Merge_Booking_SC01(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_Merge_Booking_SC01";
		...
		Step_Start(1, "Create two containerised bookings in Draft status", test, test1);
		...
		Step_End(1, "Create two containerised bookings in Draft status", test, test1);
       ...
       moduleNavigate(driver, Merge_Booking_Module_Name);
		...
		Step_Start(3, "Enter input values: Service, Vessel, Voyage, Bound, PLA, POL, POD, PLD, Agreement Party", test, test1);
