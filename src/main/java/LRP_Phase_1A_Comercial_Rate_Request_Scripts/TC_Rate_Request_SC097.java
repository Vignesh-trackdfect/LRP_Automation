...
public class TC_Rate_Request_SC097 extends Keywords{
	
	public void Rate_Request_SC097(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "Rate_Request_SC097";
		...
		waitForPopup(driver, status_Field,Submit_Popup);
		String Status =getAttribute(driver, status_Field,"value");
		
		if(Status.equals(Submit_Popup)) {
			Extent_pass_New(driver, "Matched || Expected: Status message should be: " + submittedPopup + " || Actual: Status message is: " + Status, test, test1);			
			System.out.println("Matched || Expected: Status message should be: " + submittedPopup + " || Actual: Status message is: " + Status);
		}else {
			
			Extent_fail(driver, "Not Matched || Expected: Status message should be: " + submittedPopup + " || Actual: Status message is: " + Status, test, test1);			
			System.out.println("Not Matched || Expected: Status message should be: " + submittedPopup + " || Actual: Status message is: " + Status);
		}
