...
public class TC_Feeder_Contract_SC58 extends Keywords {

	public void Feeder_Contract_SC58(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC58";
		...
		String Approve_popup1 = getText(driver, popup_Message);

		if (Saved_popup.equals(ActualSaved_popup)) {

			System.out.println("Matched || Expected popup message was : " + approve_popup
					+ " || Actual popup message was : " + approve_popup);
			Extent_pass_New(driver, "Matched || Expected popup message was : " + approve_popup
					+ " || Actual popup message was : " + Approve_popup1, test, test1);
		} else {

			System.out.println("Not Matched || Expected popup message was : " + approve_popup
					+ " || Actual popup message was : " + approve_popup);
			Extent_fail(driver, "Not Matched || Expected popup message was : " + approve_popup
					+ " || Actual popup message was : " + Approve_popup1, test, test1);
