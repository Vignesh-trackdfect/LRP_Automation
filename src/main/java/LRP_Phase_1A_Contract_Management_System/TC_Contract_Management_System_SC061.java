...
public class TC_Contract_Management_System_SC061 extends Keywords {

	public void Contract_Management_System_SC61(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC061";
		...
		String Load_fmc_locdetailspopup = Excel_data.get("Load_fmc_locdetailspopup");
		...
		Step_Start(6, "enter the non FMC load and discharge ports", test, test1);
		...
		Step_End(6, "enter the non FMC load and discharge ports", test, test1);
		...
		waitForPopup(driver, Popup_Message, Load_fmc_locdetailspopup);
		String Popup_Text_Act = getText(driver, Popup_Message);

		if (Popup_Text_Act.equals(Load_fmc_locdetailspopup)) {
			System.out.println(
					"Matched  || When enter the non FMC origin or delivery details for FMC, the Expected popup is "
							+ Load_fmc_locdetailspopup
							+ "   ||  When enter the non FMC origin or delivery details for FMC, the Actual popup is :  "
							+ Popup_Text_Act);
			Extent_pass(driver,
					" Matched  || When enter the non FMC origin or delivery details for FMC , the Expected popup is : "
							+ Load_fmc_locdetailspopup
			...
			System.out.println(
					"Not Matched  ||  When enter the non FMC origin or delivery details for FMC, the Expected popup is :  "
							+ Load_fmc_locdetailspopup
							+ "   ||  When enter the non FMC origin or delivery details for FMC , the Actual popup is : "
							+ Popup_Text_Act);
			Extent_fail(driver,
