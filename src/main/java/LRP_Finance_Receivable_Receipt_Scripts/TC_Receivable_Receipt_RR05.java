...
public class TC_Receivable_Receipt_RR05 extends Keywords {
	public void Receivable_Receipt_RR05(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws EncryptedDocumentException, InvalidFormatException, IOException {

		String testcase_Name="TC_Receivable_Receipt_RR05";
		...
		twoColumnMultipleSearchWindow(driver, CurrencyCode_header, Search_Condition, currencyCode);
		...
		Step_Start(9, "Click save, system should show pop up validation as \"Enter the Cheque No", test, test1);
