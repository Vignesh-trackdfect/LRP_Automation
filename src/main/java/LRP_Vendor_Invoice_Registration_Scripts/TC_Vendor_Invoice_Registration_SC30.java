...
public class TC_Vendor_Invoice_Registration_SC30 extends Keywords{
	public void Vendor_Invoice_Registration_SC30(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName = "TC_Vendor_Invoice_Registration_SC30";
		...
		if(popup_message.size()>1) {
		  ...
		  waitForPopup(driver, popup_Message, InvoiceSaved_Popup);
			...
			if(InvoiceSaved_Popup.trim().equals(act_popup)) {
		...
		if(Approved.trim().equals(approved_act)) {
