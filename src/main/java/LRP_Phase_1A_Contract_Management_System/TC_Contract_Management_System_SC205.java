...
public class TC_Contract_Management_System_SC205  extends Keywords {
	public void Contract_Management_System_SC205(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC205";
		...
		String surcharge_ratecalc_type = String.format(Surcharge_eqp_type, Eqp_Type);
		...
		for (int i = 0; i < size; i++) {
			...
			if(isdisplayed(driver, cms_Surcharge_Body)) {
