...
public class TC_CRO_SC025 extends Keywords {

	public void CRO_SC025(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_CRO_SC025";
		...
		String GlobalSearch_Container_Release_Header = Excel_data.get("GlobalSearch_Container_Release_Header");
		...
		Step_Start(2, "Search DDL plugin and double click the record", test, test1);
		Step_Start(3, "Set the plugin as true", test, test1);
		Step_Start(4, "Clcik save button", test, test1);
		Step_Start(5, "Updated successfully message shown", test, test1);
		...
		Step_End(2, "Search DDL plugin and double click the record", test, test1);
		Step_End(3, "Set the plugin as true", test, test1);
		Step_End(4, "Clcik save button", test, test1);
		Step_End(5, "Updated successfully message shown", test, test1);
		...
		globalValueSearchWindow(driver, condition_Filter,GlobalSearch_Container_Release_Header , CRO_Release_Number, "", "", "", "");
