...
public class TC_DG_Creation_SC_074 extends Keywords{
	public void DG_Creation_SC_074(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data, String url) throws Exception {

		String testCaseName = "TC_DG_Creation_SC_074";
		...
		Step_Start(2, "make sure response button disable ",test, test1);
		...
		if(!isdisplayed(driver, DGC_Dg_Validation)) {
			System.out.println("Matched || Expected popup : When DVQ plugin is disabled, the system should not display the DG Validation Response button || Actual: When DVQ plugin is disabled, the system does not display the DG Validation Response button.");
			Extent_pass_New(driver,"Matched || Expected popup : When DVQ plugin is disabled, the system should not display the DG Validation Response button || Actual: When DVQ plugin is disabled, the system does not display the DG Validation Response button.", test,test1);
			
		}else {
			System.out.println("Not Matched || Expected popup : When DVQ plugin is disabled, the system should not display the DG Validation Response button || Actual: When DVQ plugin is disabled, the system is display the DG Validation Response button.");
			Extent_fail(driver,"Not Matched || Expected popup : When DVQ plugin is disabled, the system should not display the DG Validation Response button || Actual: When DVQ plugin is disabled, the system is display the DG Validation Response button.", test,test1);
			
		}
		
		Step_End(2, "make sure  response button disable ",test, test1);
