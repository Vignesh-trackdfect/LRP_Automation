...
public class TC_Booking_SC029 extends Keywords{
	public void Booking_SC029(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC029";
		...
		System.out.println("********** Select the Check Box in Rates Window **********");
		...
		waitForElement(driver, Routing_Origin_Value);
		String route_Origin = getText(driver, Routing_Origin_Value);
		if(orgin.equals(route_Origin)) {
			System.out.println("Matched ||  Expected Route window Origin Given Test data value is : " + orgin + " || Actual Route window Origin value is : " + route_Origin);            
			Extent_pass_New(driver, "Matched || Expected Route window Origin Given Test data value is : " + orgin + " || Actual Route window Origin value is : " + route_Origin, test,test1);     
		}else {                                                                                                                                                                   
			System.out.println("Not Matched ||  Expected Route window Origin Given Test data value is : " + orgin + " || Actual Route window Origin value is : " + route_Origin);        
			Extent_fail(driver, "Not Matched || Expected Route window Origin Given Test data value is : " + orgin + " || Actual Route window Origin value is : " + route_Origin, test,test1); 
		} 
		waitForElement(driver, Routing_Delivery_Value);
		String route_Delivery = getText(driver, Routing_Delivery_Value);
		if(delivery.equals(route_Delivery)) {
			System.out.println("Matched || Expected Route window delivery Given Test data value is : " + delivery + " || Actual Route window delivery value is : " + route_Delivery);            
			Extent_pass_New(driver, "Matched ||  Expected Route window delivery Given Test data value is : " + delivery + " || Actual Route window delivery value is : " + route_Delivery, test,test1);     
		}else {                                                                                                                                                                   
			System.out.println("Not Matched ||  Expected Route window delivery Given Test data value is : " + delivery + " || Actual Route window delivery value is : " + route_Delivery);        
			Extent_fail(driver, "Not Matched ||  Expected Route window delivery Given Test data value is : " + delivery + " || Actual Route window delivery value is : " + route_Delivery, test,test1); 
		} 
