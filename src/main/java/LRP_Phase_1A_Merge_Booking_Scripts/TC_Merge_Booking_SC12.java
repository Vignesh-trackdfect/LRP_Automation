...
public class TC_Merge_Booking_SC12 extends Keywords{

	
public void Merge_Booking_SC12(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {
		
		
	    String testCaseName="TC_Merge_Booking_SC12";
		...
		Step_Start(1, "Create 2 containerised booking in confirmed status and In plugin configuration enable SBO plugin as false", test, test1);	
...
//	Master tab		
		...
		Step_End(1, "Create 2 containerised booking in confirmed status and In plugin configuration enable SBO plugin as false", test, test1);
