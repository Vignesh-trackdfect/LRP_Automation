...
public class TC_Contract_Management_System_SC186 extends Keywords {
	public void Contract_Management_System_SC186(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC186";
		...
		String Expected_Upload_popup = Excel_data.get("Expected_Upload_popup");
		...
		waitForPopup(driver, Popup_Message, Expected_Upload_popup);
		String Upload_popup = getText(driver, Popup_Message);
		System.out.println("saved_popup :" + Upload_popup);

		if (Expected_Upload_popup.equals(Upload_popup)) {
			Extent_pass(driver, "Matched || Expected popup value was : " + Expected_Upload_popup
					+ " || Actual popup value was is display : " + Upload_popup, test, test1);
			System.out.println("Matched || Expected popup value was : " + Expected_Upload_popup
					+ " || Actual popup value was is display: " + Upload_popup);
		} else {
			System.out.println("Not Matched || Expected popup value was : " + Expected_Upload_popup
					+ " || Actual popup value was not display: " + Upload_popup);
			Extent_fail(driver, "Not Matched || Expected popup value was : " + Expected_Upload_popup
