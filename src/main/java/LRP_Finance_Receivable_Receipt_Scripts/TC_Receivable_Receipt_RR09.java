...
public class TC_Receivable_Receipt_RR09 extends Keywords {

	public void Receivable_Receipt_RR09(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Receivable_Receipt_RR09";
		...
		if (!accountHead_BankCharges.equals("") || !accountName_BankCharges.equals("")) {
		...
		Step_Start(8, "Click on Add button without entering the value in the \"Bank \"", test, test1);

		waitForElement(driver, add_Button_Cash_Bank_Details_RR);
		click(driver, add_Button_Cash_Bank_Details_RR);

		Step_End(8, "Click on Add button without entering the value in the \"Bank\"", test, test1);
		Step_Start(9, "system should show pop up validation as \"Please select Bank Nominal\"", test, test1);
		...
		Step_End(9, "system should show pop up validation as \"Please select Bank Nominal\"", test, test1);
