...
public class TC_Receivable_Receipt_RR07 extends Keywords {

	public void Receivable_Receipt_RR07(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Receivable_Receipt_RR07";
		...
		String bankCode = Excel_data.get("BankCode");
		...
		if (!bankCode.equals("") || !bankName.equals("")) {
		...
		Step_Start(9, "system should show pop up validation as \"Select the Bank Name\"", test, test1);
		...
		Step_End(9, "system should show pop up validation as \"Select the Bank Name\"", test, test1);
