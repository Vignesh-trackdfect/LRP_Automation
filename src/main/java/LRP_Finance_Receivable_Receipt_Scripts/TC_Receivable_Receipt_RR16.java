...
public class TC_Receivable_Receipt_RR16 extends Keywords {

	public void Receivable_Receipt_RR16(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Receivable_Receipt_RR16";
		...
		if (!isElementEnabled(driver, bank_Search_Btn_Rr)) {
