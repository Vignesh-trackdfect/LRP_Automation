...
public class TC_Payable_Payment_PP06 extends Keywords{
	
	public void Payable_Payment_PP06(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Payable_Payment_PP06";
		...
		Step_Start(8, "Click on Add button without entering the value in the \"Document Amount\".", test, test1);

		waitForElement(driver, add_Button_Cash_Bank_Details_PPT);
		click(driver, add_Button_Cash_Bank_Details_PPT);
		
		Step_End(8, "Click on Add button without entering the value in the \"Document Amount\".", test, test1);
		Step_Start(9, "system should show pop up validation as \"Check the payment amount\"", test, test1);
		...
		Step_End(9, "system should show pop up validation as \"Check the payment amount\"", test, test1);
