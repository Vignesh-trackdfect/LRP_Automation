...
public class TC_Rate_Request_SC46 extends Keywords {
	...
	public void Rate_Request_SC46(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		String OFR_Input_SRR = Excel_data.get("OFR_Input_SRR");
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
		...
		click(driver, Mail_Cancel_button);
			...
			if(OFR_Input_SRR.equals(Expected_Amount)) {
				System.out.println("Matched || Expected value is : OFR Amount value  : "+OFR_Input_SRR+" || Actual Amount value in SRR : "+Expected_Amount);
				Extent_pass_New(driver, "Matched || Expected value is : OFR Amount value  : "+OFR_Input_SRR+" || Actual Amount value in SRR : "+Expected_Amount, test, test1);
			}else {
				System.out.println("Not Matched || " + "Expected value is : OFR Amount value  : " + OFR_Input_SRR+ " || Actual Amount value in SRR : " + Expected_Amount);
				Extent_fail(driver, "Not Matched || " + "Expected value is : OFR Amount value  : " + OFR_Input_SRR+ " || Actual Amount value in SRR : " + Expected_Amount, test,test1);
			}
