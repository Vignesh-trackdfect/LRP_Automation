...
public class TC_Contract_Management_System_SC005 extends Keywords {

	public void Contract_Management_System_SC005(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC005";
		...
		formatLocatorClick(driver, Contract_Management_System_Commodity_val, Eqp_Type);
		...
		waitForDisplay(driver, Contract_Management_System_Valied_from);
		...
		if (Contract_Activated.equals(Currentstatus)) {
			System.out.println("Matched || Expected value is : After click on save button, The status should be  : "
					+ Contract_Activated + " || Actual value is : After click on save button, The status is :"
					+ Currentstatus);
			Extent_pass(driver,
					"Matched || Expected value is : After click on save button, The status should be  : "
							+ Contract_Activated + " || Actual value is : After click on save button, The status is :"
							+ Currentstatus,
					test, test1);
		...
		if (Contract_Updated.equals(Update_popup)) {
			...
			System.out.println("Matched || Expected popup value was : " + Contract_Updated
					+ " ||  Actual popup value was :  " + Update_popup);
			Extent_pass(driver, "Matched ||  Expected popup value was : " + Contract_Updated
					+ " ||  Actual popup value was : " + Update_popup, test, test1);
		} else {

			System.out.println("Not Matched || Expected popup value was : " + Contract_Updated
					+ " Actual popup value was : " + Update_popup);
			Extent_fail(driver, "Not Matched || Expected popup value was : " + Contract_Updated
					+ " Actual popup value was : " + Update_popup, test, test1);
		...
		if (Verified.equals(verifiednumber2)) {
			Extent_pass(driver,
					"Matched || Expected value is : After click on save button, The status should be : " + Verified
							+ " || Actual value is : After click on save button, The status is :" + verifiednumber2,
					test, test1);
			System.out.println("Matched || Expected value is After click on save button, The status should be : "
					+ Verified + " || Actual value is : After click on save button, The status is :" + verifiednumber2);
		} else {
			System.out.println(
					"Not Matched || Expected value is : After click on save button, The status should be : " + Verified
							+ " || Actual value is : After click on save button, The status is : " + verifiednumber2);
