...
public class TC_Manifest_Correction_Notes_SC09 extends Keywords {
	public void Manifest_Correction_Notes_SC09(WebDriver driver,ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Manifest_Correction_Notes_SC09";
		...
		String Actual_Pdf_Text = getText(driver, Pdf_Draft);
