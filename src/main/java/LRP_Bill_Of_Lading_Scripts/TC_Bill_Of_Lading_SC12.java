...
public class TC_Bill_Of_Lading_SC12 extends Keywords {

	public void Bill_Of_Lading_SC12(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Bill_Of_Lading_SC12";
		...
		String Bl_Original_Radio_Button = Excel_data.get("Bl_Original_Radio_Button");
		String print_Popup = Excel_data.get("print_Popup").trim();
		...
		if(saved_pop_act.trim().contains(Saved_pop_draft.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Saved_pop_draft + " || Actual Report Activity is : " + saved_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + Saved_pop_draft + " || Actual Report Activity is : " + saved_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Saved_pop_draft + " || Actual Report Activity is : " + saved_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Saved_pop_draft + " || Actual Report Activity is : " + saved_pop_act, test,test1); 
		...
		Step_Start(5, "Confirm the BL", test, test1);
		...
		if(bl_mismatch_pop_act.trim().contains(bl_mismatch_pop_exp.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + bl_mismatch_pop_exp + " || Actual Report Activity is : " + bl_mismatch_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + bl_mismatch_pop_exp + " || Actual Report Activity is : " + bl_mismatch_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + bl_mismatch_pop_exp + " || Actual Report Activity is : " + bl_mismatch_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + bl_mismatch_pop_exp + " || Actual Report Activity is : " + bl_mismatch_pop_act, test,test1); 
...
if(isdisplayed(driver, popup_Message)) {
		...
		if(carrier_pop_exp.trim().equals(Reset_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + carrier_pop_exp + " || Actual Report Activity is : " + Reset_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + carrier_pop_exp + " || Actual Report Activity is : " + Reset_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + carrier_pop_exp + " || Actual Report Activity is : " + Reset_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + carrier_pop_exp + " || Actual Report Activity is : " + Reset_pop_act, test,test1); 
		...
		if(package_act.equals(package_exp)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + package_act + " || Actual Report Activity is : " + package_exp);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + package_act + " || Actual Report Activity is : " + package_exp, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + package_act + " || Actual Report Activity is : " + package_exp);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + package_act + " || Actual Report Activity is : " + package_exp, test,test1); 
		...
		if(valid_comm_pop_exp.trim().equals(valid_comm_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + valid_comm_pop_exp + " || Actual Report Activity is : " + valid_comm_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + valid_comm_pop_exp + " || Actual Report Activity is : " + valid_comm_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + valid_comm_pop_exp + " || Actual Report Activity is : " + valid_comm_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + valid_comm_pop_exp + " || Actual Report Activity is : " + valid_comm_pop_act, test,test1); 
		...
		if(comm_dis_pop_exp.trim().contains(comm_dis_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + comm_dis_pop_exp + " || Actual Report Activity is : " + comm_dis_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + comm_dis_pop_exp + " || Actual Report Activity is : " + comm_dis_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + comm_dis_pop_exp + " || Actual Report Activity is : " + comm_dis_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + comm_dis_pop_exp + " || Actual Report Activity is : " + comm_dis_pop_act, test,test1); 
		...
		if(marks_number_pop_exp.trim().contains(marks_number_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + marks_number_pop_exp + " || Actual Report Activity is : " + marks_number_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + marks_number_pop_exp + " || Actual Report Activity is : " + marks_number_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + marks_number_pop_exp + " || Actual Report Activity is : " + marks_number_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + marks_number_pop_exp + " || Actual Report Activity is : " + marks_number_pop_act, test,test1); 
		...
		if(enter_commodity_pop_exp.trim().contains(enter_commodity_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + enter_commodity_pop_exp + " || Actual Report Activity is : " + enter_commodity_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + enter_commodity_pop_exp + " || Actual Report Activity is : " + enter_commodity_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + enter_commodity_pop_exp + " || Actual Report Activity is : " + enter_commodity_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + enter_commodity_pop_exp + " || Actual Report Activity is : " + enter_commodity_pop_act, test,test1); 
		...
		if(enter_package_pop_exp.trim().contains(enter_package_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + enter_package_pop_exp + " || Actual Report Activity is : " + enter_package_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + enter_package_pop_exp + " || Actual Report Activity is : " + enter_package_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + enter_package_pop_exp + " || Actual Report Activity is : " + enter_package_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + enter_package_pop_exp + " || Actual Report Activity is : " + enter_package_pop_act, test,test1); 
		...
		if(Commodity_group.trim().contains(enter_package_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Commodity_group + " || Actual Report Activity is : " + enter_package_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + Commodity_group + " || Actual Report Activity is : " + enter_package_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Commodity_group + " || Actual Report Activity is : " + enter_package_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Commodity_group + " || Actual Report Activity is : " + enter_package_pop_act, test,test1); 
		...
		if(Package_Quantity.trim().contains(enter_package_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Package_Quantity + " || Actual Report Activity is : " + enter_package_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + Package_Quantity + " || Actual Report Activity is : " + enter_package_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Package_Quantity + " || Actual Report Activity is : " + enter_package_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Package_Quantity + " || Actual Report Activity is : " + enter_package_pop_act, test,test1); 
		...
		if(consignee_pop_exp.trim().equals(consignee_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + consignee_pop_exp + " || Actual Report Activity is : " + consignee_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + consignee_pop_exp + " || Actual Report Activity is : " + consignee_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + consignee_pop_exp + " || Actual Report Activity is : " + consignee_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + consignee_pop_exp + " || Actual Report Activity is : " + consignee_pop_act, test,test1); 
		...
		if(notify_pop_exp.trim().equals(notify_pop_act.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + notify_pop_exp + " || Actual Report Activity is : " + notify_pop_act);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + notify_pop_exp + " || Actual Report Activity is : " + notify_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + notify_pop_exp + " || Actual Report Activity is : " + notify_pop_act);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + notify_pop_exp + " || Actual Report Activity is : " + notify_pop_act, test,test1); 
		...
		if(saved_pop_act1.contains(updated_pop_exp)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + saved_pop_exp + " || Actual Report Activity is : " + updated_pop_exp);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + saved_pop_exp + " || Actual Report Activity is : " + updated_pop_exp, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + saved_pop_exp + " || Actual Report Activity is : " + updated_pop_exp);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + saved_pop_exp + " || Actual Report Activity is : " + updated_pop_exp, test,test1); 
		...
		if(booking_confirmed_Color.equals(bill_number_colour)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + booking_confirmed_Color + " || Actual Report Activity is : " + bill_number_colour);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + booking_confirmed_Color + " || Actual Report Activity is : " + bill_number_colour, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + booking_confirmed_Color + " || Actual Report Activity is : " + bill_number_colour);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + booking_confirmed_Color + " || Actual Report Activity is : " + bill_number_colour, test,test1); 

		} 

		Step_End(5, "Confirm the BL", test, test1);

		Step_Start(6, "Click the print button in master tab", test, test1);
		waitForElement(driver, print_Button_BL);
		click(driver, print_Button_BL);

		Step_End(6, "Click the print button in master tab", test, test1);

		Step_Start(7, "Select the BL Original radio button", test, test1);


		String BL_Original_button = String.format(Bill_Of_Lading_Locators.bL_Print_Radio_Button, Bl_Original_Radio_Button);
		waitForElement(driver, BL_Original_button);
		click(driver, BL_Original_button);

		Step_End(7, "Select the BL Original radio button", test, test1);

		Step_Start(8, "Click the print button", test, test1);

		waitForElement(driver, bl_Print_Popup_Print_Button);
		click(driver, bl_Print_Popup_Print_Button);

		Step_End(8, "Click the print button", test, test1);

		Step_Start(9, "System will validate with \"Load confirmation not done\"", test, test1);
		waitForElement(driver, popup_Message);
		String popup= getText(driver, popup_Message);

		if(print_Popup.equals(popup)) {
			System.out.println("Matched || Expected value was : " + print_Popup + " || Actual value was : " + popup);
			Extent_pass_New(driver, "Matched || Expected value was : " + print_Popup + " || Actual value was : " + popup, test,
					test1);

		} 
		else {
			System.out.println("NotMatched || Expected value was : " + print_Popup + " || Actual value was : " + popup);
			Extent_fail(driver, "NotMatched || Expected value was : " + print_Popup + " || Actual value was : " + popup,
					test, test1);
		...
		waitForElement(driver, popup_Message_Ok_Button);
		click(driver, popup_Message_Ok_Button);
		Step_End(9, "System will validate with \"Load confirmation not done\"", test, test1);
