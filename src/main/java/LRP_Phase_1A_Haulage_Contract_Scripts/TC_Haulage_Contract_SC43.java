...
public class TC_Haulage_Contract_SC43 extends Keywords{
	public void Haulage_Contract_SC43(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC43";
		...
		if (isdisplayed(driver, HC_Add_Gird_Table)) {
			...
			Extent_pass(driver, "All mandatory fields are filled and added in the gird", test, test1);
		...
		click(driver, HC_DG_Amount_Gridcell);
