...
public class TC_Contract_Management_System_SC015 extends Keywords {

	public void Contract_Management_System_SC15(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC015";
		...
		if (Draft.equals(InActive_field)) {
			System.out.println("Matched || Expected value is : After click on inactive button, The status should be : "
					+ Draft + "||  Actual value is : After click on inactive button, The status is : " + InActive_field);
			Extent_pass(driver,
			...
			System.out.println("Not Matched || Expected value is : After click on inactive button, The status should be : "
					+ Draft + "|| Actual value is : After click on inactive button, The status is : " + InActive_field);
			Extent_fail(driver,
