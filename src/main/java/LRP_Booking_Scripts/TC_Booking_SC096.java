...
public class TC_Booking_SC096 extends Keywords {

	public void Booking_SC096 (WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String test_Case_Name="TC_Booking_SC096";
		...
		String Container_Number_header_Value = Excel_data.get("Container_Number");
		String Container_Number_Filter= Excel_data.get("Container_Number_header_Filter");
		...
		if(draft_bookingColor.equals(booking_draft_Color)) {                                                                                                                  
			System.out.println("Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + draft_bookingColor + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is changed to yellow colour] ");            
			Extent_pass_New(driver,"Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + draft_bookingColor + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is changed to yellow colour] ", test, test1);     
		}else {                                                                                                                                                                   
			System.out.println("Not Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + draft_bookingColor + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is Not changed to yellow colour] ");        
			Extent_fail(driver,"Not Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + draft_bookingColor + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is Not changed to yellow colour] ", test, test1); 
		} 
		...
		if(!isdisplayed(driver, two_col_first_row)) {
			twoColumnSearchWindow(driver, Container_Number_header, Container_Number_Filter, Container_Number_header_Value);
		}else {
		click(driver, two_col_first_row);
		...
		if(Draft_BL_Color.equals(booking_draft_Color)) {      
			System.out.println("Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + Draft_BL_Color + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is changed to yellow colour] ");            
			Extent_pass_New(driver,"Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + Draft_BL_Color + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is changed to yellow colour] ", test, test1);     
		}else {                                                                                                                                                                   
			System.out.println("Not Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + Draft_BL_Color + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is Not changed to yellow colour] ");        
			Extent_fail(driver,"Not Matched || [ Booking number input field Should be change to yellow colour ] Expected Report Activity is : " + Draft_BL_Color + " || The Actual Report Activity is : " + booking_draft_Color+" [Booking number input field is Not changed to yellow colour] ", test, test1); 
		} 
	   ...
	   globalValueSearchWindow(driver, dd1_condition, select_by_book_number, booknum, "", "", "", "");			
		...
		bookingRatesSelect(driver, rate_no, No_Schedule_Popup, service_data_edit, Voyagenumber_Edit, Boundinput_Edit);
		...
		waitForElement(driver, BL_voyage);
		String BL_voyage_data=getText(driver, BL_voyage);

		if(BL_voyage_data.equals(updated_voyage_data)) {
			Extent_pass_New(driver,"Matched ||Excepted data should be shown :"+ updated_voyage_data+" Actual data  shown:"+BL_voyage_data, test, test1);
			System.out.println("Matched ||Excepted data should be shown:"+ updated_voyage_data+" Actual  data  shown:"+BL_voyage_data);
			...
			System.out.println("Not matched ||Excepted data should be shown :"+ updated_voyage_data+" Actual data was not shown"+BL_voyage_data);
			Extent_fail(driver,"Not matched ||Excepted data should be shown :"+ updated_voyage_data+" Actual data was not shown:"+BL_voyage_data, test, test1);
