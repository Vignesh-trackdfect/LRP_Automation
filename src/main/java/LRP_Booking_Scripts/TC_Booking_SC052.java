...
public class TC_Booking_SC052 extends Keywords {

	public void Booking_SC052 (WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC052";
		...
		String ETD_grid=String.format(ETD_Grid,origin);
		String ETA_grid=String.format(ETA_Grid,delivery);
		...
		waitForPopup(driver, popup_Message,feeder_update_msg);
		...
		Step_Start(10, "system update the latest details", test, test1);
		waitForElement(driver, ETD_date);
		String updated_ETD_date=getText(driver, ETD_date);
		if(updated_ETD_date.contains(ETDdepdate)) {
			Extent_pass_New(driver,"Matched || The Excepted Date Value : "+ ETDdepdate+" || The Actual Date Value : "+updated_ETD_date, test, test1);
			System.out.println("Matched || The Excepted Date Value : "+ ETDdepdate+" || The Actual Date Value : "+updated_ETD_date);
		}else {
			Extent_fail(driver,"Not Matched || The Excepted Date Value : "+ ETDdepdate+" || The Actual Date Value : "+updated_ETD_date, test, test1);
			System.out.println("Not Matched || The Excepted Date Value : "+ ETDdepdate+" || The Actual Date Value : "+updated_ETD_date);
		}
		Step_End(10, "system update the latest details", test, test1);
