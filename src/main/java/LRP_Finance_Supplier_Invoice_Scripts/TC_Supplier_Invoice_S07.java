...
public class TC_Supplier_Invoice_S07 extends Keywords{
	public void  Supplier_Invoice_S07(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Supplier_Invoice_S07";
		...
		if(draft_bookingColor.equals(trans_num_colour_exp)) {                                                                                                                  
			System.out.println("Matched || " + " Expected : Once Confirm transaction should be displayed as  green color in trans number field : " + trans_num_colour_exp + " || Actual : Confirm transaction is displayed as  green color in trans number field : " + draft_bookingColor);            
			Extent_pass_New(driver, "Matched || " + " Expected :Once Confirm transaction should be displayed as  green color in trans number field : " + trans_num_colour_exp + " || Actual : Confirm transaction is displayed as  green color in trans number field  : " + draft_bookingColor, test, test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Confirm transaction should be displayed as  green color in trans number field : " + trans_num_colour_exp + " || Actual Confirm transaction is displayed as  green color in trans number field :" + draft_bookingColor);        
			Extent_fail(driver, "Not Matched || " + " Confirm transaction should be displayed as  green color in trans number field : " + trans_num_colour_exp + " || Actual Confirm transaction is displayed as  green color in trans number field : " + draft_bookingColor, test, test1); 
		} 
