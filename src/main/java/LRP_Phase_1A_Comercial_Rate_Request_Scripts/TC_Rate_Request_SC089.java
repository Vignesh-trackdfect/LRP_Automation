...
public class TC_Rate_Request_SC089  extends Keywords{

	
	public void Rate_Request_SC089(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		
		String testCaseName = "TC_Rate_Request_SC089";
		...
		Step_End(27, "Click Add", test, test1);
		Step_Start(28, "Click Save button in the tool bar", test, test1);
		waitForElement(driver, SaveButton_ToolBar);
		click(driver, SaveButton_ToolBar);
		...
		Step_End(28, "Click Save button in the tool bar", test, test1);
		Step_Start(29, "Click pending", test, test1);
		...
		Step_End(29, "Click pending", test, test1);
		
		Step_Start(30, "Click Ok", test, test1);
		
		waitForElement(driver, Yes_Btn);
		click(driver, Yes_Btn);
		
		Step_End(30, "Click Ok", test, test1);
