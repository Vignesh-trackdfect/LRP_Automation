...
public class TC_Schedule_Security_SS06 extends Keywords{

	public void Schedule_Security_SS06(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name="TC_Schedule_Security_SS06";
		...
		String Select_Group_Popup = Excel_data.get("Select_Group_Popup");
		...
		Step_Start(2, "Click on the Group  Button", test, test1);
		waitForElement(driver, schedule_Security_Btn_select);
		click(driver, schedule_Security_Btn_select);
		Step_End(2, "Click on the Group  Button", test, test1);
		Step_Start(3, "Click on Save button without selecting  the value in the Group Code.", test, test1);
		waitForElement(driver, SaveButton_ToolBar);
		click(driver, SaveButton_ToolBar);
		
		Step_End(3, "Click on Save button without selecting  the value in the Group Code.", test, test1);
		Step_Start(4, "System Should show the pop message says 'Select the Group Code'", test, test1);
		waitForPopup(driver, popup_Message,Select_Group_Popup);

		String schedule_Pop_Act=getText(driver, popup_Message);
		if(Select_Group_Popup.equals(schedule_Pop_Act)) {
			Extent_pass_New(driver, "Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Select_Group_Popup+" || Actual : After click on save button Popup value is display in the Schedule Security Screen : "+schedule_Pop_Act, test, test1);
			System.out.println("Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Select_Group_Popup+" || Actual : After click on save button Popup value is display in the Schedule Security Screen : "+schedule_Pop_Act);
			waitForElement(driver, popup_Message_Ok_Button);	
			click(driver, popup_Message_Ok_Button);
		}else {
			System.out.println("Not Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Select_Group_Popup+" || Actual : After click on save button Popup value is Not display in the Schedule Security Screen : "+schedule_Pop_Act);
			Extent_fail(driver, "Not Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Select_Group_Popup+" ||Actual : After click on save button Popup value is Not display in the Schedule Security Screen : "+schedule_Pop_Act, test, test1);
		}
		Step_Start(4, "System Should show the pop message says 'Select the Group Code'", test, test1);
		...
		if(Select_Service_Popup.equals(schedule_Pop_Act)) {
			...
			Extent_fail(driver, "Not Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Select_Service_Popup+" || Actual : After click on save button Popup value not  is display in the Schedule Security Screen :"+schedule_Pop_Act, test, test1);
