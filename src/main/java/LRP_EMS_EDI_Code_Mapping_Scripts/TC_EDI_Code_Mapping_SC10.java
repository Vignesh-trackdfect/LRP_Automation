...
public class TC_EDI_Code_Mapping_SC10 extends Keywords {
	public void EDI_Code_Mapping_SC10(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_EDI_Code_Mapping_SC10";
		...
		String EDI_Package_Input_ECM = Excel_data.get("EDI_Package_Input");
		...
		sendKeys(driver, EDI_Package_Filter_Input_ECM, EDI_Package_Input_ECM);
		...
		waitForElement(driver, Status_btn_Click_Package_Tab_ECM);
		click(driver, Status_btn_Click_Package_Tab_ECM);
