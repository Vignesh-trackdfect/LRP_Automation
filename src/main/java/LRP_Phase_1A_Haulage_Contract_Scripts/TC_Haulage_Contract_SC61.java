...
public class TC_Haulage_Contract_SC61 extends Keywords{

	public void Haulage_Contract_SC61(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC61";
		...
		waitForDisplay(driver, HC_Approve_Button);
		if(isdisplayed(driver, HC_Approve_Button)) {
		...
		Step_Start(5, ".Remove the approve button privilege on the user level security for haulage contract. ", test, test1);
		...
		Step_Start(8, "Check Approve button not present in the Haulage contract.", test, test1);
		...
		Step_End(8, "Check Approve button not present in the Haulage contract.", test, test1);
