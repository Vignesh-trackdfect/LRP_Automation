...
public class TC_Rate_Request_SC77 extends Keywords {
	...
	public void Rate_Request_SC77(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String srr_Status_exp_after=Excel_data.get("srr_Status_exp_after");
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if(status_actual.equals(srr_Status_exp_after)) {
				...
				Extent_pass_New(driver, "Matched || Expected status -> "+srr_Status_exp_after+"|| Actual status -> "+status_actual, test, test1);
