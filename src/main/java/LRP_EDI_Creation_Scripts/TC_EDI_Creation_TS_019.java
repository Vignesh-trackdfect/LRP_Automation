...
public class TC_EDI_Creation_TS_019  extends Keywords{

	public void EDI_Creation_TS_019(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Creation_TS_019";
		...
		String File_Name = Excel_data.get("File_Name");
		 ...
		 Extent_Start(testcase_Name, test, test1);
			...
			Step_Start(3, "double click the data based on the filter by File name",test, test1);
			...
			List<String> File_Name_Input_Value = splitAndExpand(File_Name, ",");
			List<String> Agency_Input_Value = splitAndExpand(Agency_Code_input, ",");
			
			for (int i = 0; i < Agency_Input_Value.size(); i++) {
				...
				clear(driver, EDI_File_Grid_Input_Filed);
				sendKeys(driver, EDI_File_Grid_Input_Filed, File_Name_Input_Value.get(i));
				
			
				
				formatLocatorClick(driver, EDI_File_Name_Check_Box, File_Name_Input_Value.get(i));
				if (i == File_Name_Input_Value.size() - 1) {

					formatRightClick(driver, EDI_File_Name_Check_Box, File_Name_Input_Value.get(i));
			...
			for (int i = 0; i < Agency_Input_Value.size(); i++) {
				...
				if(IsEmpty(driver, EDI_FileName_Value)) {
					System.out.println("Matched ||  Expected result : Given Agency Code : " +Agency_Input_Value.get(i)+ " , File Name : "+File_Name_Input_Value.get(i)+" should be removed  in the grid || Actual result : Given  Agency Code : " +Agency_Input_Value.get(i)+", File Name : "+File_Name_Input_Value.get(i)+"   removed in the grid  ");
					Extent_pass_New(driver, "Matched ||  Expected result : Given Agency Code : " +Agency_Input_Value.get(i)+" ,File Name : "+File_Name_Input_Value.get(i)+"  should be removed  in the grid || Actual result : Given  Agency Code :  " +Agency_Input_Value.get(i)+", File Name : "+File_Name_Input_Value.get(i)+" removed in the grid  ", test, test1);
				}else {
					System.out.println("Not Matched ||  Expected result : Given Agency Code : " +Agency_Input_Value.get(i)+" ,File Name : "+File_Name_Input_Value.get(i)+" should be removed  in the grid || Actual result : Given  Agency Code : " +Agency_Input_Value.get(i)+", File Name : "+File_Name_Input_Value.get(i)+" Not removed in the grid  ");
					Extent_fail(driver, "Not Matched ||  Expected result : Given Agency Code : " +Agency_Input_Value.get(i)+"  , File Name :  "+File_Name_Input_Value.get(i)+" should be removed  in the grid || Actual result : Given  Agency Code : " +Agency_Input_Value.get(i)+", File Name : "+File_Name_Input_Value.get(i)+" Not  removed in the grid  ", test, test1);
				}
			...
			Step_End(3, "double click the data based on the filter by File name",test, test1);
			
			
			Step_Start(4, "Click on skip to last check box  and click next button ",test, test1);
			...
			Step_End(4, "Click on skip to last check box and click next button  ",test, test1);		
			
			Step_Start(5, "Click confirm button\r\n"+ "",test, test1);	
			...
			Step_End(5, "Click confirm button\r\n"+ "",test, test1);	
