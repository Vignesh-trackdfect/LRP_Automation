...
public class TC_Contract_Management_System_SC081 extends Keywords{
	public void Contract_Management_System_SC81(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC081";
		...
		if (Before_Surge_Add_Colour.equals(Act_color1)) {
			Extent_pass(driver,"Matched || Expected colour Before adding the Surcharge Rule is  : "+Before_Surge_Add_Colour+" ||  Actual colour After adding the Surcharge Rule is : "+ Act_color1, test,test1);
			System.out.println("Matched || Expected colour Before adding the Surcharge Rule is : "+Before_Surge_Add_Colour+" || Actual colour After adding the Surcharge Rule is: "+ Act_color1);
		
 
		}
 
		else {
			Extent_fail(driver," NOT Matched || Expected colour Before adding the Surcharge Rule is  : "+Before_Surge_Add_Colour+" ||  Actual colour After adding the Surcharge Rule is : "+ Act_color1, test,test1);
			System.out.println(" NOT Matched || Expected colour Before adding the Surcharge Rule is : "+Before_Surge_Add_Colour+" || Actual colour After adding the Surcharge Rule is: "+ Act_color1);
		...
		if (after_Surge_Add_Colour.equals(Act_color)) {
			Extent_pass(driver,"Matched || Expected colour After adding the Surcharge Rule is  : "+after_Surge_Add_Colour+" ||  Actual colour After adding the Surcharge Rule is : "+ Act_color, test,test1);
			System.out.println("Matched || Expected colour After adding the Surcharge Rule is : "+after_Surge_Add_Colour+" || Actual colour After adding the Surcharge Rule is: "+ Act_color);
		
 
		}
 
		else {
			Extent_fail(driver," NOT Matched || Expected colour After adding the Surcharge Rule is  : "+after_Surge_Add_Colour+" ||  Actual colour After adding the Surcharge Rule is : "+ Act_color, test,test1);
			System.out.println(" NOT Matched || Expected colour After adding the Surcharge Rule is : "+after_Surge_Add_Colour+" || Actual colour After adding the Surcharge Rule is: "+ Act_color);
