...
public class TC_Transportation_Dispatch_Notice_SC_TDN_12 extends Keywords{
	...
	public void Transportation_Dispatch_Notice_SC_TDN_12(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		String expected_Status =Excel_data.get("expected_Status").trim();
...
//	Switch the Profile
	...
	newButton(driver);
		...
		if(actual_Draft_Status.contains(expected_Status)) {
			...
			Extent_pass_New(driver, "MATCHED || EXPECTED DRAFT STATUS -> "+expected_Status+"|| ACTUAL DRAFT STATUS -> "+actual_Draft_Status, test, test1);
		}else {
