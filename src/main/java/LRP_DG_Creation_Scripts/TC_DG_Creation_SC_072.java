...
public class TC_DG_Creation_SC_072 extends Keywords {


	public void DG_Creation_SC_072(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_072";
		...
		String Cargo_Status_2 = Excel_data.get("Cargo_Status_2");	
		String ReRequest_Sent_Popup = Excel_data.get("ReRequest_Sent_Popup");	
...
//		Module Search
		...
		Step_Start(14, "Click sent button", test, test1);

		waitForElement(driver, Send_Btn);
		safeclick(driver, Send_Btn);
		
		waitForPopup(driver, popup_Message,ReRequest_Sent_Popup);
		 act_Popup = getText(driver, popup_Message);
		System.out.println(act_Popup);
		if(act_Popup.equals(ReRequest_Sent_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + ReRequest_Sent_Popup + " || Actual Popup is : " + act_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + ReRequest_Sent_Popup + " || Actual Popup is : " + act_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + ReRequest_Sent_Popup + " || Actual Popup is : " + act_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + ReRequest_Sent_Popup + " || Actual Popup is : " + act_Popup, test,test1); 
		}
		waitForElement(driver, Mail_Cancel_Btn);
		safeclick(driver, Mail_Cancel_Btn);
		...
		if(actualCargoStatus.equals(Cargo_Status_2)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Cargo status is : " + Cargo_Status_2 + " || Actual Cargo status is : " + actualCargoStatus);            
			Extent_pass_New(driver, "Matched || " + " Expected Cargo status is: " + Cargo_Status_2 + " || Actual Cargo status is : " + actualCargoStatus, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Cargo status is : " + Cargo_Status_2 + " || Actual Cargo status is : " + actualCargoStatus);        
			Extent_fail(driver, "Not Matched || " + " Expected Cargo status is : " + Cargo_Status_2 + " || Actual Cargo status is : " + actualCargoStatus, test,test1); 
		}
		
		Step_End(14, "Click sent button", test, test1);
