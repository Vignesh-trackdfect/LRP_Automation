...
public class TC_Import_Documentation_SC110 extends Keywords {

	public void Import_Documentation_SC110(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		// Get data from test data
		String testcase_Name="TC_Import_Documentation_SC110";
		...
		String checkBox_Select=Excel_data.get("CheckBox_Select");
		...
		if(isDisplayed(driver, hbl_Manifest)&& isElementAccessible(driver, hbl_Manifest_CheckBox)) {
			Extent_pass_New(driver, "Expected : HBL manifest check box should be Enable || Actual : HBL manifest check box is enabled", test, test1);
			System.out.println("Expected : HBL manifest check box should be Enable || Actual : HBL manifest check box is enabled");
			checkBox(driver, hbl_Manifest_CheckBox, checkBox_Select);
		}else {
			System.out.println("Expected : HBL manifest check box should be Enable || Actual : HBL manifest check box is not enabled");
			Extent_fail(driver, "Expected : HBL manifest check box should be Enable || Actual : HBL manifest check box is not enabled", test, test1);
		}
