...
public class TC_Receivable_Receipt_RR25 extends Keywords{
	public void Receivable_Receipt_RR25(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws EncryptedDocumentException, InvalidFormatException, IOException{

		String testcase_Name="TC_Receivable_Receipt_RR25";
		...
		String receipt_Amount = Excel_data.get("receipt_Amount");
		...
		String Part_amount_Popup = Excel_data.get("Part_amount_Popup");
		...
		sendKeys(driver, RR_TransNumber_Input, Transaction_Number);
		...
		String Receipt_amount=String.format(Invoice_Amount_Edit1, Transaction_Number);
		waitForElement(driver, Receipt_amount);
		String Receipt_Amount = getText(driver, Receipt_amount);
		 double Receipt_Amnt=getNumberValue(Receipt_Amount);
		...
		System.out.println(Receipt_amnt);
		 double Amnt_Value=getNumberValue(Receipt_amnt);
		 double balance_amnt=Receipt_Amnt-Amnt_Value;
		 balance_amnt=Double.parseDouble(String.format("%.2f", balance_amnt));
		System.out.println(balance_amnt);
	   waitForElement(driver, Receipt_amount);
		doubleClick(driver, Receipt_amount);
		
		
		String Receipt_amount_Edit=String.format(Invoice_Amount_Edit2, Transaction_Number);
		waitForElement(driver, Receipt_amount_Edit);
		clearAndType(driver, Receipt_amount_Edit,receipt_Amount);
		enter(driver);
	...
	Step_Start(7, "Enter the positive value in receipt amount column, balance amount column should show difference amount.", test, test1);

				String balance_Value=String.format(Balance_Amount, Transaction_Number);
				waitForElement(driver, balance_Value);//
				click(driver, balance_Value);//
				waitForElement(driver, balance_Value);
				 String Balance_Value = getText(driver, balance_Value);
                System.out.println(Balance_Value);
				
		double Balance_value= getNumberValue(Balance_Value);
		if(balance_amnt==Balance_value) {
			System.out.println("Matched || Expected Enter the positive value in receipt amount column, balance amount column should be show difference amount : " + balance_amnt + " || Actual : Enter the positive value in receipt amount column, balance amount column is show difference amount : " + Balance_value);
    		Extent_pass_New(driver,"Matched ||Expected Enter the positive value in receipt amount column, balance amount column should be show difference amount : " + balance_amnt + " || Actual  : Enter the positive value in receipt amount column, balance amount column is show difference amount : " + Balance_value, test,test1);
       
		} else {
			System.out.println("Not Matched || Expected Enter the positive value in receipt amount column, balance amount column should be show difference amount : " + balance_amnt + " || Actual  : Enter the positive value in receipt amount column, balance amount column is show same amount :" + Balance_value);
			Extent_fail(driver,"Not Matched || Expected Enter the positive value in receipt amount column, balance amount column should be show difference amount : " + balance_amnt + " || Actual : Enter the positive value in receipt amount column, balance amount column is show same amount: " + Balance_value,test, test1);
		}	
		waitForElement(driver, description_Txtfld_Rr);
		click(driver, description_Txtfld_Rr);
		Step_End(7, "Enter the positive value in receipt amount column, balance amount column should show difference amount.", test, test1);
		Step_Start(8, "Click on Cash/Bank Detail tab", test, test1);
		waitForElement(driver, cash_Bank_Details_Tab_RR);
		click(driver, cash_Bank_Details_Tab_RR);
		Step_End(8, "Click on Cash/Bank Detail tab", test, test1);
		Step_Start(9, "Enter the Cheque/TT No with Numeric values upto 30 characters", test, test1);
		...
		if(exp_Cheque_Size>=total_Cheque_Size) {
			System.out.println("Matched || The Expected Number of Characters Accept In  Cheque/TT No Field : "+exp_Cheque_Size+" || Actual Number of Characters Accept In  Cheque/TT No Field : "+total_Cheque_Size);
			Extent_pass_New(driver, "Matched || The Expected Number of Characters Accept In  Cheque/TT No Field : "+exp_Cheque_Size+" || Actual Number of Characters Accept In  Cheque/TT No Field : "+total_Cheque_Size, test, test1);
		}else {
			System.out.println("Not Matched || The Expected Number of Characters Accept In  Cheque/TT No Field : "+exp_Cheque_Size+" || Actual Number of Characters Accept In  Cheque/TT No Field : "+total_Cheque_Size);
			Extent_fail(driver, "Not Matched || The Expected Number of Characters Accept In  Cheque/TT No Field : "+exp_Cheque_Size+" || Actual Number of Characters Accept In  Cheque/TT No Field : "+total_Cheque_Size, test, test1);
		}
		Step_End(9, "Enter the Cheque/TT No with Numeric values upto 30 characters", test, test1);
		
		
		Step_Start(10, "Select the Deposit A/c", test, test1);
		...
		waitForElement(driver, depositAC_SearchButton_RR);
		...
		Step_End(10, "Select the Deposit A/c", test, test1);
		
		Step_Start(11, "Select the Bank", test, test1);
		...
		Step_End(11, "Select the Bank", test, test1);
		...
		clearAndType(driver, localAmount_Textfield_RR, receipt_Amount);
		waitForElement(driver, localAmount_Textfield_RR);
		click(driver, cheque_TT_No_Textfield_RR);
		...
		Step_Start(14, "Click on Post tab", test, test1);

		waitForElement(driver, post_Tab_Rr);
		click(driver, post_Tab_Rr);
		Step_End(14, "Click on Post tab", test, test1);

		Step_Start(15, "Click the post button", test, test1);

		waitForElement(driver, post_Btn_Rr);
		click(driver, post_Btn_Rr);
		Step_End(15, "Click the post button", test, test1);

		Step_Start(16, "Enter the description field with an alphanumeric upto 250 characters", test, test1);
		waitForElement(driver, description_Txtfld_Rr);
		sendKeys(driver, description_Txtfld_Rr, description_Data);
	
		
		Step_End(16, "Enter the description field with an alphanumeric upto 250 characters", test, test1);
		Step_Start(17, "Click on Save button from the toolbar", test, test1);
		waitForElement(driver, SaveButton_ToolBar);
		click(driver, SaveButton_ToolBar);
		Step_End(17, "Click on Save button from the toolbar", test, test1);
		
		waitForPopup(driver, popup_Message,Part_amount_Popup);
		String actual_PartAmount_Msg = getText(driver, popup_Message);
		if(Part_amount_Popup.equals(actual_PartAmount_Msg)) {
			System.out.println("Matched || Expected : After click on save button Popup value should be display in the Receivable Receipt Screen : "+Part_amount_Popup+" || Actual : After click on save button Popup value is display in the Receivable Receipt Screen  : "+actual_PartAmount_Msg);
			Extent_pass_New(driver, "Matched || Expected : After click on save button Popup value should be display in the Receivable Receipt Screen  : "+Part_amount_Popup+" || Actual : After click on save button Popup value is display in the Receivable Receipt Screen : "+actual_PartAmount_Msg, test, test1);
			click(driver, popup_Message_Yes_Button);
		}
		Step_Start(18, "Click save, should show the pop up message as 'Receivable Receipt Saved'", test, test1);
		...
		if(Saved_Popup.equals(actual_Msg)) {
			System.out.println("Matched || After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+Saved_Popup+" || Actual : After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+actual_Msg);
			Extent_pass_New(driver, "Matched || After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+Saved_Popup+" || Actual : After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+actual_Msg, test, test1);
			click(driver, popup_Message_Ok_Button);
		}else {
			System.out.println("Not Matched || After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+Saved_Popup+" || Actual : After accept the Part amount popup value should be display in the Receivable Receipt Screen : "+actual_Msg);
			Extent_fail(driver, "Not Matched || After accept the Part amount popup value should be display in the Receivable Receipt Screen: "+Saved_Popup+" || Actual : After accept the Part amount popup value should be display in the Receivable Receipt Screen :"+actual_Msg, test, test1);
		}
		Step_Start(18, "Click save, should show the pop up message as 'Receivable Receipt Saved'", test, test1);
