...
public class TC_Rate_Request_SC26  extends Keywords{
	...
	public void rate_Request_Sc26(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String Special_TypepopEXP = Excel_data.get("Special_TypepopEXP");
...
newButton(driver);
		...
		waitForPopup(driver, Popup_Message, Special_TypepopEXP);

		String PopUp_Msg2=getText(driver, Popup_Message);    
		System.out.println(PopUp_Msg2);
		if(Special_TypepopEXP.equals(PopUp_Msg2)) {                                                                                                                  
			System.out.println("Matched || " + "Expected : popup message should be shown as : " + Special_TypepopEXP + " || Actual : popup message is shown as : " + PopUp_Msg2);            
			Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + Special_TypepopEXP + " || Actual : popup message is shown as : " + PopUp_Msg2, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + Special_TypepopEXP + " || Actual : popup message is shown as : " + PopUp_Msg2);        
			Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + Special_TypepopEXP + " || Actual : popup message is shown as : " + PopUp_Msg2, test,test1); 
