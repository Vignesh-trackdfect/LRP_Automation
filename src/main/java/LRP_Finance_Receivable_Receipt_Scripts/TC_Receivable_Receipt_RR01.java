...
public class TC_Receivable_Receipt_RR01 extends Keywords {
	public void Receivable_Receipt_RR01(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url)
			throws EncryptedDocumentException, InvalidFormatException, IOException {

		String testcase_Name = "TC_Receivable_Receipt_RR01";
		...
		if (Receipt_Date_Input.equals("")) {
			...
			if (current_Date.equals(Receipt_Date)) {
				System.out.println(
						"Matched || Receipt Date Should be Automatically Select Based On Month || Expected Current Date : "
								+ current_Date + " || The Actual Current Date : " + Receipt_Date
								+ " Receipt Date is  Automatically Selected Based On Month");
				Extent_pass_New(driver,
						"Matched || Receipt Date Should be Automatically Select Based On Month || Expected Current Date : "
								+ current_Date + " || The Actual Payment Date : " + Receipt_Date
								+ "Receipt Date is Automatically Selected Based On Month",
						test, test1);
			} else {
				System.out.println(
						"Not Matched || Receipt Date Should be Automatically Select Based On Month || Expected Current Date || Expected Current Date : "
								+ current_Date + " || The Actual Current Date  : " + Receipt_Date
								+ "Receipt Date is Not Automatically Selected Based On Month");
				Extent_fail(driver,
						"Not Matched || Receipt Date Should be Automatically Select Based On Month || Expected Current Date || Expected Current Date : "
								+ current_Date + " || The Actual Current Date  : " + Receipt_Date
								+ "Receipt Date is Not Automatically Selected Based On Month",
			...
			if (compareMonthAndYear(actual_Receipt_Date, actual_Open_Period)) {
				System.out.println(
						"Matched || Open Period Should be Automatically Populated Based On Receipt Date || Expected  Receipt Date is : "
								+ actual_Receipt_Date + " || The Actual Receipt Date  : " + actual_Open_Period
								+ "Open Period  Automatically Populated Based On Receipt Date");
				Extent_pass_New(driver,
						"Matched || Open Period Should be Automatically Populated Based On Payment Date || Expected  Receipt Date iss : "
								+ actual_Receipt_Date + " || The Actual Receipt Date : " + actual_Open_Period
								+ "Open Period  Automatically Populated Based On Receipt Date ",
						test, test1);
			} else {
				System.out.println(
						"Not Matched || Open Period Should be Automatically Populated Based On Receipt Date || Expected  Receipt Date is : "
								+ actual_Receipt_Date + " || The Actual Receipt Date : " + actual_Open_Period
								+ "Open Period  Not Automatically Populated Based On Receipt Date");
				Extent_fail(driver,
						"Not Matched || Open Period Should be Automatically Populated Based On Receipt Date|| Expected  Receipt Date is : "
								+ actual_Receipt_Date + " || The Actual Receipt Date : " + actual_Open_Period
								+ "Open Period  Not Automatically Populated Based On Receipt Date",
			...
			if (Receipt_Date_Input.equals(actual_Receipt_Date)) {
				System.out.println(
						"Matched || Receipt Date should be Automatically Selected Based On Month || Expected Current Date : "
								+ Receipt_Date_Input + " || The Actual Receipt Date  : " + actual_Receipt_Date
								+ "Receipt Date is Automatically Selected Based On Month ");
				Extent_pass_New(driver,
						"Matched || Receipt Date should be Automatically Selected Based On Month || Expected Current Date : "
								+ Receipt_Date_Input + " || The Actual Receipt Date  : " + actual_Receipt_Date
				...
				System.out.println(
						"Not Matched || Receipt Date should be Automatically Not Selected Based On Month || Expected Current Date : "
								+ Receipt_Date_Input + " || The Actual Receipt Date : " + actual_Receipt_Date
								+ "Receipt Date is Not Automatically Selected Based On Month");
				Extent_fail(driver,
						"Not Matched || Receipt Date should be Automatically Not Selected Based On Month || Expected Current Date : "
			...
			if (compareMonthAndYear(actual_Receipt_Date, actual_Open_Period)) {
				System.out.println(
						"Matched || Open Period Should be  Automatically Populated Based On Receipt Date || Expected Receipt Date is "
								+ actual_Receipt_Date + " ||  Actual Open Receipt Date : " + actual_Open_Period
								+ " Open Period  Automatically Populated Based On Receipt Date");
				Extent_pass_New(driver,
						"Matched || Open Period Should be Automatically Populated Based On Receipt Date || Expected Receipt Date is "
								+ actual_Receipt_Date + " || Actual Open Receipt Date : " + actual_Open_Period
				...
				System.out.println(
						"Not Matched || Open Period Should be Automatically Populated Based On Receipt Date || Expected Receipt Date is "
								...
								+ "Open Period Not Automatically Populated Based On Receipt Date");
				Extent_fail(driver,
						"Not Matched || Open Period Automatically Not Populated Based On Receipt Date || Expected The Receipt Date is : "
								+ actual_Receipt_Date + " || Actual Open Receipt Date : " + actual_Open_Period
								+ "Open Period Not Automatically Populated Based On Receipt Date",
						test, test1);
			}
		...
		String amount_Value = getValueByFirstColumnAndHeader(Invoice_Table_Data, Trans_Number_Header, Trans_Number,
				Get_Amout_Value_From_Header);
		...
		if (exp_Cheque_Size >= total_Cheque_Size) {
			System.out.println(
					"Matched || The Expected : Enter the negavite Nuumber of Characters Accept should be  Cheque/TT No Field : "
							+ exp_Cheque_Size
							+ " || Actual :Enter the negavite Number of Characters Accept is  Cheque/TT No Field : "
							+ total_Cheque_Size);
			Extent_pass_New(driver,
					"Matched || The Expected : Enter the negavite Number of Characters Accept should be  Cheque/TT No Field : "
							+ exp_Cheque_Size
							+ " || Actual :Enter the negavite Number of Characters Accept is  Cheque/TT No Field : "
							+ total_Cheque_Size,
					test, test1);
			...
			System.out.println(
					"Not Matched || The Expected : Enter the negavite  Number of Characters Accept should be Cheque/TT No Field : "
							+ exp_Cheque_Size
							+ " || Actual : Enter the negavite Number of Characters Not Accept In  Cheque/TT No Field : "
							+ total_Cheque_Size);
			Extent_fail(driver,
					"Not Matched || The Expected : Enter the negavite  Number of Characters Accept should be  Cheque/TT No Field : "
							+ exp_Cheque_Size
		...
		if (!currencyCode.equals("")) {
			...
			twoColumnMultipleSearchWindow(driver, Currency_Header, Bank_Filter_Condition, currencyCode);
		...
		if (!roeDifference.equals("")) {
			...
			twoColumnMultipleSearchWindow(driver, ROE_Diff_Headers, Bank_Filter_Condition, ROE_Diff_Values);
		}
		...
		Step_Start(13, "Enter the local amount with Numeric values upto 12 characters", test, test1);
		...
		if (exp_Limit_Of_Local_Amount_Input >= total_Local_amount_size) {
			System.out
					.println("Matched || The Expected : Number Of Charecter Should be Accept In  Local Amount Field : "
							+ exp_Limit_Of_Local_Amount_Input
							+ " || Actual Number Of Charecter is Accept In Local Amount Field : "
							+ total_Local_amount_size);
			Extent_pass_New(driver,
					"Matched || The Expected Number Of Charecter Should be  Accept In  Local Amount Field : "
							+ exp_Limit_Of_Local_Amount_Input
							+ " || Actual Number Of Charecter is Accept In Local Amount Field : "
							+ total_Local_amount_size,
					test, test1);
			...
			System.out.println(
					"Not Matched || The Expected Number Of Charecter Should be  Accept In  Local Amount Field : "
							+ exp_Limit_Of_Local_Amount_Input
							+ " || Actual Number Of Charecter is Accept In Local Amount Field : "
							+ total_Local_amount_size);
			Extent_fail(driver,
		...
		if (Saved_Popup.equals(actual_Msg)) {
			System.out.println(
					"Matched || Expected : After click on save button Popup value should be display in the Receivable Receipt Screen : "
							+ Saved_Popup
							+ " ||  Actual : After click on save button Popup value is display in the Receivable Receipt Screen : "
							+ actual_Msg);
			Extent_pass_New(driver,
					"Matched ||Expected : After click on save button Popup value should be display in the Receivable Receipt Screen : "
							+ Saved_Popup
			...
			System.out.println(
					"Not Matched ||Expected : After click on save button Popup value should be display in the Receivable Receipt Screen: "
							+ Saved_Popup
							+ " || Actual :After click on save button Popup value is not display in the Receivable Receipt Screen : "
							+ actual_Msg);
			Extent_fail(driver,
					"Not Matched || Expected : After click on save button Popup value should be display in the Receivable Receipt Screen : "
							+ Saved_Popup
