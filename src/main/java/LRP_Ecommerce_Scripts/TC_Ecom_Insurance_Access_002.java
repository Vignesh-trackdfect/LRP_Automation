...
public class TC_Ecom_Insurance_Access_002 extends Keywords {

	public void Ecom_Insurance_Access_002(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Ecom_Insurance_Access_002";
		...
		Step_Start(1, "Click on the \"Customer Code Search\" option to search and select the customer.", test, test1);
		waitForElement(driver, Customer_code_search);
		click(driver, Customer_code_search);
		Step_End(1, "Click on the \"Customer Code Search\" option to search and select the customer.", test, test1);
		...
		Step_Start(5, "The system should successfully save the valid customer.", test, test1);
		...
		Step_End(5, "The system should successfully save the valid customer.", test, test1);
		...
		Step_Start(2,
				" Enter valid customer details, including:\r\n" + "   * Customer Name\r\n" + "    *Customer Code ",
				test, test1);
		...
		Step_End(2, " Enter valid customer details, including:\r\n" + "   * Customer Name\r\n" + "    *Customer Code ",
				test, test1);
