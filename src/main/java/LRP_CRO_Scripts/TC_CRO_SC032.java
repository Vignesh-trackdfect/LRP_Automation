...
public class TC_CRO_SC032 extends Keywords {

	public void CRO_SC032(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_CRO_SC032";
		...
		Step_Start(4, "Click POADBand check box.", test, test1);
		...
		Step_End(4, "Click POADBand check box.", test, test1);
...
//  CRO 
		...
		Step_Start(10, "Check the Load port and Discharge Port dispaly.", test, test1);

		
		Step_End(10, "Check the Load port and Discharge Port dispaly.", test, test1);
