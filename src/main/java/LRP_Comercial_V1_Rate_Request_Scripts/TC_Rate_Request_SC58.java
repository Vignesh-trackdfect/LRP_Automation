...
public class TC_Rate_Request_SC58  extends Keywords {
	...
	public void Rate_Request_SC58(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Back_Date_Input = Excel_data.get("Back_Date_Input");
...
newButton(driver);
		...
		click(driver, Mail_Cancel_button);
			...
			globalValueSearchWindow(driver, Condition_Value, SRR_Global_Search_Select_Type, actualReqNo1, "", "","", "");
			waitForElement(driver, Edit_Button_toolBar);
			click(driver, Edit_Button_toolBar);
			scrollBottom(driver);
			...
			if(actSubmittedPopup.equals(Exist_Popup_Msg)) {
				...
				Extent_pass_New(driver, Exist_Popup_Msg+" popup is displayed", test,test1);
