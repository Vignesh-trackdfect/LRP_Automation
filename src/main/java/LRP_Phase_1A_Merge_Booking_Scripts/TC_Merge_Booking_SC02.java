...
public class TC_Merge_Booking_SC02 extends Keywords {

	public void Merge_Booking_SC02(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_Merge_Booking_SC02";
		...
		Step_Start(1, "Create two containerised bookings in Confirmed status", test, test1);
...
//	Master tab		
		...
		Step_End(1, "Create two containerised bookings in Confirmed status", test, test1);
		...
		Step_Start(4, "Select 'Confirmed' option below the PLA field", test, test1);
		waitForElement(driver, MB_Confirm_Button);
		click(driver, MB_Confirm_Button);
		Step_End(4, "Select 'Confirmed' option below the PLA field", test, test1);
		...
		Step_End(3, "Enter input values: Service, Vessel, Voyage, Bound, PLA, POL, POD, PLD, and Agreement Party", test, test1);

	
		Step_Start(5, "Click on Show button; system lists available bookings based on the input criteria", test, test1);

		waitForElement(driver, MB_Show_btn);
		click(driver, MB_Show_btn);
		Step_End(5, "Click on Show button; system lists available bookings based on the input criteria", test, test1);
		

		Step_Start(6, "Select the first booking from Available Booking tab and move it to 'Booking to Merge' tab", test, test1);
		formatLocatorClick(driver, MB_BookNum_Select, booknum);
		waitForElement(driver, MB_Next_Button);
		click(driver, MB_Next_Button);
		Step_End(6, "Select the first booking from Available Booking tab and move it to 'Booking to Merge' tab", test, test1);

		Step_Start(7, "Select the second booking and move it to 'Booking to Merge' tab", test, test1);
		formatLocatorClick(driver, MB_BookNum_Select, booknum1);
		waitForElement(driver, MB_Next_Button);
		click(driver, MB_Next_Button);
		Step_End(7, "Select the second booking and move it to 'Booking to Merge' tab", test, test1);
		...
		Step_Start(9, "Confirm the merge in the popup dialog", test, test1);
		waitForElement(driver, popup_Message);
		click(driver, popup_Message_Yes_Button);
		Step_End(9, "Confirm the merge in the popup dialog", test, test1);

		Step_Start(10, "Merged booking confirmation message is shown", test, test1);
		waitForElement(driver, popup_Message);
		...
		Step_End(10, "Merged booking confirmation message is shown", test, test1);
		...
		Step_Start(11, "Both confirmed bookings are cancelled and a new merged booking is created with existing details", test, test1);
	moduleNavigate(driver, Booking_Module_Name);
		...
		Step_End(11, "Both confirmed bookings are cancelled and a new merged booking is created with existing details", test, test1);
