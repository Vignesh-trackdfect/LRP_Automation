...
public class TC_Arrival_Notice_TS_056 extends Keywords {

	public void Arrival_Notice_TS_056(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name="TC_Arrival_Notice_TS_056";
...
waitForDisplay(driver, by_Remainder_AN);
		if(isDisplayed(driver, by_Remainder_AN)) {
			Extent_pass(driver, "Matched || Expected Result is :System should showing  Remainder button in Arrival Notice / Freight Memo screen correctly. || Actual Result is :System  showing  Remainder button in Arrival Notice / Freight Memo screen correctly", test, test1);
			...
			Extent_fail(driver,"Not Matched || Expected Result is :System should not showing  Remainder button in Arrival Notice / Freight Memo screen correctly|| Actual Result is System is not showing  Remainder button in Arrival Notice / Freight Memo screen correctly", test, test1);
		}
