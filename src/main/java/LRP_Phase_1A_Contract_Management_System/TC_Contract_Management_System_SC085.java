...
public class TC_Contract_Management_System_SC085 extends Keywords {

	public void Contract_Management_System_SC85(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC085";
		...
		if (After_Adding_surcharge_Color.equals(color1)) {
			System.out.println("Excepted ||  After Adding Surcharge code  It should be highlighted in: " + After_Adding_surcharge_Color + "  Actual  || After Adding Surcharge code  It should be highlighted in : " + color1);
			Extent_pass(driver, "Excepted||  After Adding Surcharge code  It should be highlighted in "  + After_Adding_surcharge_Color+ " Actual ||  After Adding Surcharge code  It should be highlighted in  :" + color1, test, test1);
			temp1 = false;
		...
		if(temp1) {
			System.out.println("UnExpected || After Adding Surcharge code  It should be highlighted in: " + After_Adding_surcharge_Color + "  Actual  || After Adding Surcharge code  It Does not highlighted ");
			Extent_fail(driver,"UnExpected || After Adding Surcharge code  It should be highlighted in: " + After_Adding_surcharge_Color + " Actual  || After Adding Surcharge code  It Does not highlighted " , test, test1);
		}
