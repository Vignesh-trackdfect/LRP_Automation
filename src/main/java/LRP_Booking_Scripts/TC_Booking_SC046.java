...
public class TC_Booking_SC046 extends Keywords {

	public void Booking_SC046 (WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {


		String testcase_Name="TC_Booking_SC046";
		...
		String dd_condition = Excel_data.get("dd_condition");
		...
		Step_End(6, "Save the booking in Confirmed_Button", test, test1);
		...
		globalValueSearchWindow(driver, dd_condition, search_by_book_no, booknum, "", "", "", "");

		waitForElement(driver, contacts_tab);
		waitForElement(driver, ready_BL);
		String readyBL_status=getAttribute(driver, ready_BL, "class");
		if(readyBL_status.contains(status)) {
			Extent_pass_New(driver,"Matched || Expected Result is : ' Ready For Bl Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Selected ' and the status is : "+status, test, test1);
			System.out.println("Matched || Expected Result is : ' Ready For Bl Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Selected ' and the status is : "+status); 
		}
		else {
			System.out.println("Not Matched || Expected Result is : ' Ready For Bl Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Not Selected '");
			Extent_fail(driver,"Not Matched || Expected Result is : ' Ready For Bl Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Not Selected '", test, test1);
		}

		waitForElement(driver, ready_OP);
		String readyOP_status=getAttribute(driver, ready_OP, "class");
		if(readyOP_status.contains(status)) {
			Extent_pass_New(driver,"Matched || Expected Result is : ' Ready For Operation Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Selected ' and the status is : "+readyOP_status, test, test1);
			System.out.println("Matched || Expected Result is : ' Ready For Operation Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Selected ' and the status is : "+readyOP_status); 
		}
		else {
			System.out.println("Not Matched || Expected Result is : ' Ready For Operation Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Not Selected '");
			Extent_fail(driver,"Not Matched || Expected Result is : ' Ready For Operation Check Box Should be Selected ' || The Actual Result is : ' Ready For Bl Check Box is Not Selected '", test, test1);
		}
