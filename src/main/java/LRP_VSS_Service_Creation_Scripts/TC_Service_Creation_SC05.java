...
public void Service_Creation_SC05(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
//	Get data from excel sheet
	...
	String tc_name="TC_Service_Creation_SC05";
		...
		String alreadyExistsPopup = Excel_data.get("AlreadyExistsPopup");
