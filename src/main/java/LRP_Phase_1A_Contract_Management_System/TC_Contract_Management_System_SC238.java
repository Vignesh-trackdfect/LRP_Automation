...
public class TC_Contract_Management_System_SC238 extends Keywords {

	public void Contract_Management_System_SC238(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC238";
		...
		String Amd_Effective_Date = Excel_data.get("Amd_Effective_Date");
		...
		Step_Start(2, "select  Non_containerized check box", test, test1);
		...
		Step_End(2, "select  Non_containerized check box", test, test1);
		...
		if (Contract_Amendment.equals(AmendmentPopup)) {
			...
			System.out.println("Matched || Expected value is : After click on amendment button the value should be  : "
					+ Contract_Amendment + " || Actual value is : After click on amendment button the value  is : "
					+ AmendmentPopup);
			Extent_pass(driver,
					"Matched || Expected value is : After click on amendment button the value should be : "
							+ Contract_Amendment
							+ "||  Actual value is : After click on amendment button the value  is : " + AmendmentPopup,
					test, test1);
		} else {

			System.out
					.println("Not Matched || Expected value is : After click on amendment button the value should be :"
							+ Contract_Amendment
							+ "|| Actual value is : After click on amendment button the value  is not display :"
							+ AmendmentPopup);
			Extent_fail(driver,
					"Not Matched || Expected value is : After click on amendment button the value should be : "
							+ Contract_Amendment
							+ "|| Actual value is : After click on amendment button the value  is not display :"
							+ AmendmentPopup,
					test, test1);
		...
		Step_Start(10,
				"create 1st amendment and active with the amendment less than the port pair lane valid from date.",
				test, test1);

		waitForElement(driver, Contract_Management_System_Edit);
		click(driver, Contract_Management_System_Edit);

		waitForElement(driver, Amd_Effective_date_Input);
		click(driver, Amd_Effective_date_Input);
		sendKeys(driver, Amd_Effective_date_Input, Amd_Effective_Date);
		...
		waitForDisplay(driver, Contract_Management_System_status);
		waitForElement(driver, Contract_Management_System_status);
		String Activated_av2 = getAttribute(driver, Contract_Management_System_status, "value");
		System.out.println("Activated_avl :" + Activated_av2);

		if (Activated_av2.equals(Activated)) {
			System.out.println("Matched || Expected value is : After click on Activate button, The status should be  : "
					+ Activated + " || Actual value is : After click on Activate button, The status is :"
					+ Activated_av2);
			Extent_pass(driver,
		...
		waitForElement(driver, CMS_Log_Tab);
		click(driver, CMS_Log_Tab);
		
		waitForElement(driver, Log_tab_grid_First_Row);
		doubleClick(driver, Log_tab_grid_First_Row);
		...
		waitForElement(driver, Por_Pair_grid_First_Row);
		
		String Amendenment_Number_Colour = getTextBackgroundColor(driver, Por_Pair_grid_First_Row);
		System.out.println(Amendenment_Number_Colour);
		String Inactive_colour = getColorName(Amendenment_Number_Colour);
		...
		if (Colour_Code.equals(Inactive_colour)) {
			System.out.println(
					"Matched || Expected After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour
							+ " || Actual After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour);
			...
			System.out.println(
					"Not Matched || Expected After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour
							+ " || Actual After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour);
			Extent_fail(driver,
					"Not Matched || Expected After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour
							+ " || Actual After clicked on Amd Number should be diplay is red colur in Por pair Grid row is : " + Colour_Code + " and the colour code is : " + Inactive_colour,
		...
		Step_Start(10,"create 1st amendment and active with the amendment less than the port pair lane valid from date.",
				test, test1);
