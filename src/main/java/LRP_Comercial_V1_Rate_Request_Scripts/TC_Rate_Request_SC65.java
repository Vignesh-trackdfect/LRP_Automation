...
public class TC_Rate_Request_SC65 extends Keywords {
	...
	public void Rate_Request_SC65(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Pending_pop_up =Excel_data.get("Pending_pop_up");
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			Step_End(10, "Select the routing", test, test1);
										...
										rateRequestPaymentMode_Select(driver, PayAt_value,Select_type_location, condition, payLocation);
			...
			waitForPopup(driver, Rate_Sub_Popup_Msg, Pending_pop_up);
			...
			if(Pending_pop_up.equals(actSubmitPopup)) {
				Extent_pass_New(driver,"Matched || Expected : popup message should be shown as : "+ Pending_pop_up+" || Actual : popup message is shown as : "+ actSubmitPopup, test,test1);
				System.out.println("Matched || Expected : popup message should be shown as : " +Pending_pop_up+" || Actual : popup message is shown as : "+ actSubmitPopup);
				Extent_pass_New(driver, Pending_pop_up+" is displayed", test,test1);
				System.out.println(Pending_pop_up+" is displayed");

			}else {
				System.out.println("Not Matched || Expected : popup message should be shown as : "+Pending_pop_up+" || Actual : popup message is shown as : "+ actSubmitPopup);

				Extent_fail(driver,"Not Matched || Expected : popup message should be shown as : "+Pending_pop_up+" || Actual : popup message is shown as : "+ actSubmitPopup, test,test1);
			}
			...
			if(Rejected_popup.equals(actualPopup)) {
				Extent_pass_New(driver,"Matched || Expected : popup message should be shown as : "+Rejected_popup+" || Actual : popup message is shown as : "+ actualPopup, test,test1);
				System.out.println("Matched || Expected : popup message should be shown as : "+Rejected_popup+" || Actual : popup message is shown as : "+ actualPopup);
			}else {
				System.out.println("Not Matched || Expected : popup message should be shown as : "+Rejected_popup+" || Actual : popup message is shown as : "+ actualPopup);

				Extent_fail(driver,"Not Matched || Expected : popup message should be shown as : "+Rejected_popup+" || Actual : popup message is shown as : "+ actualPopup, test,test1);
			}
			...
			if(Submitted_popup.equals(actSubmittedPopup)) {
				Extent_pass_New(driver,"Matched || Expected : popup message should be shown as : "+Submitted_popup+" || Actual : popup message is shown as : "+ actSubmittedPopup, test,test1);
				System.out.println("Matched || Expected : popup message should be shown as : "+Submitted_popup+" || Actual : popup message is shown as : "+ actSubmittedPopup);
				Extent_pass_New(driver, Submitted_popup+" popup is displayed", test,test1);
				System.out.println(Submitted_popup+" popup is displayed");

			}else {
				System.out.println("Not Matched || Expected : popup message should be shown as : "+Submitted_popup+" || Actual : popup message is shown as : "+ actSubmittedPopup);
				Extent_fail(driver,"Not Matched || Expected : popup message should be shown as : "+Submitted_popup+" || Actual : popup message is shown as : "+ actSubmittedPopup, test,test1);
			}
