...
public class TC_CRO_SC026 extends Keywords {

	public void CRO_SC026(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_CRO_SC026";
		...
		Step_Start(16, "Click on the Commodity tab", test, test1);
		waitForElement(driver, commodity_tab);
		click(driver, commodity_tab);
		Step_End(16, "Click on the Commodity tab", test, test1);

		Step_Start(17, "Click Edit", test, test1);
		waitForElement(driver, Commodity_Grid_EditBtn);
		click(driver, Commodity_Grid_EditBtn);
		Step_End(17, "Click Edit", test, test1);
		
	
		
		Step_Start(18, "Enter the Package", test, test1);
		safeclick(driver, Commodity_Package_BKG);
		sendKeys(driver, Commodity_Package_BKG, Package_Input);
		enter(driver);
		Step_End(18, "Enter the Package", test, test1);

		Step_Start(20, "Enter the HS Code", test, test1);
		...
		Step_End(20, "Enter the HS Code", test, test1);

		Step_Start(21, "Enter Cargo Weight", test, test1);
		waitForElement(driver, com_cargo_wt);
		safeclick(driver, com_cargo_wt);
		clearAndType(driver, com_cargo_wt, cargo_Weight);
		Step_End(21, "Enter Cargo Weight", test, test1);

		Step_Start(22, "Enter the Volume", test, test1);
		waitForElement(driver, Commodity_Volume_BKG);
		safeclick(driver, Commodity_Volume_BKG);
		clearAndType(driver, Commodity_Volume_BKG, Volume);
		Step_End(22, "Enter the Volume", test, test1);

		Step_Start(23, "Enter the Commodity Description", test, test1);
		waitForElement(driver, Marks_And_No_BKG);
		safeclick(driver, Marks_And_No_BKG);
		sendKeys(driver, Marks_And_No_BKG, Marks_No);
		Step_End(23, "Enter the Commodity Description", test, test1);
		waitForElement(driver, Desc_BKG);
		safeclick(driver, Desc_BKG);
		sendKeys(driver, Desc_BKG, Marks_No);

		

		Step_Start(24, "Click Edit button", test, test1);
		waitForElement(driver, com_add_btn);
		safeclick(driver, com_add_btn);
		Step_End(24, "Click Edit button", test, test1);

		Step_Start(25, "Auto-rate the charges", test, test1);
		...
		Step_End(25, "Auto-rate the charges", test, test1);
		...
		Step_Start(27, "Switch to the Master tab and click on Confirm button", test, test1);
		waitForElement(driver, master_tab);
		click(driver, master_tab);
		
		waitForElement(driver, Confirmed_Button);
		click(driver, Confirmed_Button);
		Step_End(27, "Switch to the Master tab and click on Confirm button", test, test1);

		Step_Start(28, "Click on Save button", test, test1);
		scrollTop(driver);
		waitForElement(driver, SaveButton_ToolBar);
		safeclick(driver, SaveButton_ToolBar);
		Step_End(28, "Click on Save button", test, test1);

		Step_Start(29, "Validate the popup after clicking Save button [BOOKING SAVED]", test, test1);
		...
		Step_End(29, "Validate the popup after clicking Save button [BOOKING SAVED]", test, test1);

		Step_Start(30, "Validate the colour of Booking number field is Green", test, test1);
		waitForElement(driver, booking_no);
		...
		Step_End(30, "Validate the colour of Booking number field is Green", test, test1);

		Step_Start(31, "Navigate to CRO button", test, test1);
		waitForElement(driver, CRO_btn);
		click(driver, CRO_btn);

		Step_End(31, "Navigate to CRO button", test, test1);

		Step_Start(32, "Click Edit button", test, test1);
		waitForElement(driver, Edit_Button_toolBar);
		click(driver, Edit_Button_toolBar);
		Step_End(32, "Click Edit button", test, test1);

		Step_Start(33, "Select Release Depot/Terminal", test, test1);
		...
		Step_End(33, "Select Release Depot/Terminal", test, test1);

		Step_Start(34, "Select Acceptance Terminal", test, test1);
		...
		Step_End(34, "Select Acceptance Terminal", test, test1);
		...
		Step_Start(36, "Validate 'CRO is saved' message is shown", test, test1);
		...
		Step_End(36, "Validate 'CRO is saved' message is shown", test, test1);

		Step_Start(37, "Open Printout Configuration module", test, test1);
		moduleNavigate(driver, PrintOutConfiguration_Module_Name);

		Step_End(37, "Open Printout Configuration module", test, test1);

		Step_Start(38, "Search 'CRO module'", test, test1);
		newButton(driver);
		...
		Step_End(38, "Search 'CRO module'", test, test1);

		Step_Start(39, "Click Edit button", test, test1);
		waitForElement(driver, Edit_Button_toolBar);
		click(driver, Edit_Button_toolBar);
		Step_End(39, "Click Edit button", test, test1);

		Step_Start(40, "Click CmdtyBand checkbox", test, test1);
String selectBand=String.format(band_Select, Band_Name);
		...
		Step_End(40, "Click CmdtyBand checkbox", test, test1);

		Step_Start(41, "Click Save button", test, test1);
		waitForElement(driver, SaveButton_ToolBar);
		click(driver, SaveButton_ToolBar);
		Step_End(41, "Click Save button", test, test1);

		Step_Start(42, "Validate 'Printout Configuration updated' message is shown", test, test1);
		...
		Step_End(42, "Validate 'Printout Configuration updated' message is shown", test, test1);

		Step_Start(43, "Click OK button", test, test1);
		click(driver, popup_Message_Ok_Button);

		Step_End(43, "Click OK button", test, test1);

		Step_Start(44, "Go to Container Release Order module", test, test1);
	    moduleNavigate(driver, CRO_Module_Name);

		Step_End(44, "Go to Container Release Order module", test, test1);

		Step_Start(45, "Click Print button", test, test1);
		...
		Step_End(45, "Click Print button", test, test1);

		Step_Start(46, "Validate that Commodity details are displayed from Booking", test, test1);
		Step_End(46, "Validate that Commodity details are displayed from Booking", test, test1);
