...
public class TC_Contract_Management_System_SC012 extends Keywords {


	public void Contract_Management_System_SC012(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC012";
		...
		waitForElement(driver, Contract_Management_System_status);
		String Activatestatus = getAttribute(driver, Contract_Management_System_status, "value");



		if (Contract_Activated.equals(Activatestatus)) {
			System.out.println("Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is : " + Activatestatus);
			Extent_pass(driver,"Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is :" + Activatestatus,test, test1);
			
		} else {
			System.out.println("Not Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is not display : "+ Activatestatus);

			Extent_fail(driver,"Not Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is not display : " + Activatestatus,test, test1);
