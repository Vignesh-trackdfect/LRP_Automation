...
public class TC_Contract_Management_System_SC057 extends Keywords{
	
public void Contract_Management_System_SC57(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC057";
		...
		String origin_deliverymissing_popup = Excel_data.get("origin_deliverymissing_popup");
		...
		waitForPopup(driver, Popup_Message, origin_deliverymissing_popup);
   		String Popup_Text_Act=getText(driver, Popup_Message);
		
		if(Popup_Text_Act.equals(origin_deliverymissing_popup)) {
			System.out.println("Popup Matched  ||   Expected popup: "+ origin_deliverymissing_popup+"   ||   Actual popup :  "+ Popup_Text_Act);
			Extent_pass(driver, "Popup Matched  ||   Expected popup: "+ origin_deliverymissing_popup+"   ||   Actual popup  : "+ Popup_Text_Act, test, test1);
		}else {
			System.out.println("Popup Not Matched  ||   Expected popup:  "+ origin_deliverymissing_popup+"   ||   Actual popup  : "+ Popup_Text_Act);
			Extent_fail(driver, "Popup Not Matched  ||   Expected popup : "+ origin_deliverymissing_popup+"   ||   Actual popup  : "+ Popup_Text_Act, test, test1);
		}
