...
public class TC_Contract_Management_System_SC019 extends Keywords {
public void Contract_Management_System_SC19(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC019";
       ...
       Step_Start(14, "click edit", test, test1);
		...
		if (Activated_avl.equals(Activated)) {
			System.out.println("Matched || Expected value is : After click on Activate button, The status should be  : " + Activated_avl + " || Actual value is : After click on Activate button, The status is :" + Activated_avl);
			Extent_pass(driver,"Matched || Expected value is : After click on Activate button, The status should be  : " + Activated_avl + " || Actual value is : After click on Activate button, The status is :" + Activated_avl, test,test1);
			
		} else {

			System.out.println("Matched || Expected value is : After click on Activate button, The status should be  : " + Activated_avl + " || Actual value is : After click on Activate button, The status is :" + Activated_avl);

			Extent_fail(driver,"Matched || Expected value is : After click on Activate button, The status should be  : " + Activated_avl + " || Actual value is : After click on Activate button, The status is :" + Activated_avl, test,test1);
		...
		if (Filed.equals(Filed_avl)) {
			System.out.println("Matched || Expected value is : After click on save button, The status should be : " + Filed + "||  Actual value is : After click on save button, The status is : " + Filed_avl);
			Extent_pass(driver,"Matched || Expected value is : After click on save button, The status should be : " + Filed + "|| Actual value is : After click on save button, The status is  : " + Filed_avl, test,test1);

		} else {
			System.out.println("Not Matched || Expected value is : After click on save button, The status should be : " + Filed + "|| Actual value is : After click on save button, The status is : " + Filed_avl);
			Extent_fail(driver,"Not Matched || Expected value is : After click on save button, The status should be : " + Filed + " || Actual value is : After click on save button, The status is: " + Filed_avl, test,test1);
