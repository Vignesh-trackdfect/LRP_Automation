...
public class TC_Feeder_Contract_SC46 extends Keywords {

	public void Feeder_Contract_SC46(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC46";
		...
		Step_Start(23, ".Click the \"\"-\"\" The surcharge should deleted.", test, test1);
		...
		for (String surcharge : surcharge_Value) {
			if (surcharge != null && !surcharge.trim().isEmpty()) {
				...
				click(driver, added);
				waitForElement(driver, Surcharge_Remove);
				click(driver, Surcharge_Remove);
		...
		Step_End(23, ".Click the \"\"-\"\" The surcharge should deleted.", test, test1);
