...
public class TC_Payable_Payment_PP02 extends Keywords{
	
	public void Payable_Payment_PP02(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Payable_Payment_PP02";
		...
		if(!cash_Bank_Details_Date.equals("")) {
			...
			if(datePicker.equalsIgnoreCase("Yes")) {
				...
				click(driver, date_Cash_Bank_Details_PPT);
