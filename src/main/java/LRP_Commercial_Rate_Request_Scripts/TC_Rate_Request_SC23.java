...
public class TC_Rate_Request_SC23 extends Keywords{
	...
	public void rate_Request_Sc23(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			if(status1.equals(status_value)) {
				...
				Extent_pass_New(driver, "Matched || Expected value was : "+status_value+" || Actual value was : "+status1, test,test1);
			}
			else {
		...
		click(driver, Mail_Cancel_button);
			...
			if(Do_You_Want_Delete.equalsIgnoreCase("Yes")) {
				...
				if(submitted_ReqNum1.equals(reqno1)) {
					...
					Extent_pass_New(driver,"Matched || " + " Expected Value is : " + reqno1 + " || ActualValue is : " + submitted_ReqNum1,test,test1);
					...
					Extent_pass_New(driver, reqno1+" Moved to Pending", test,test1);
				...
				if(pending_ReqNum1.equals(reqno1)) {
					...
					Extent_pass_New(driver,"Matched || " + " Expected Value is : " + reqno1 + " || ActualValue is : " + pending_ReqNum1,test,test1);
					...
					globalValueSearchWindow(driver, Condition_Value,Rate_Request_NO,reqno1,"", "", "","");

					waitForElement(driver, Delete_button_toolBar);
					click(driver, Delete_button_toolBar);

					System.out.println(reqno1+" Opened in Rate Request tab");
					Extent_pass_New(driver, reqno1+" Opened in Rate Request tab", test,test1);
