...
public class TC_Billing_Invoice_B11  extends Keywords{
	
	public void  Billing_Invoice_B11(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Billing_Invoice_B11";
	...
	if (status.equals(search3)) {
		System.out.println("Matched || " + " Expected search coloum 3 shows  : " + status+ " || Actual search coloum 3 shows : " + search3);
		Extent_pass_New(driver, "Matched || " + " Expected search coloum 3 shows : " + status+ " || Actual search coloum 3 shows : " + search3, test, test1);
	
	} else {
		System.out.println("Not matched || " + " Expected search coloum 3 shows : " + status+ " || Actual search coloum 3 shows : " + search3);
		Extent_fail(driver, "Not matched || " + " Expected search coloum 3 shows : " + status+ " || Actual search coloum 3 shows : " + search3, test, test1);
	...
	if (trans_num_colour_exp.equalsIgnoreCase(Act_Color)) {
		System.out.println("Matched || Expected color Trans Number field should be Green colour so it was able to retrive the [CONFIRM] Records : " + trans_num_colour_exp+ " || Actual colour Trans Number field is Green colour so it was able to retrive the [CONFIRM] Records : " + Act_Color);
		Extent_pass_New(driver, "Matched || Expected color Trans Number field should be Green colour so it was able to retrive the [CONFIRM] Records :  " + trans_num_colour_exp+ " || Actual colour Trans Number field is Green colour so it was able to retrive the [CONFIRM] Records : " + Act_Color, test, test1);
		Extent_call(test, test1, "Trans Number field was Green colour so it was able to retrive the [CONFIRM] Records also");
		
	} else {
		System.out.println("Not matched || Expected color Trans Number field should be Green colour so it was able to retrive the [CONFIRM] Records : " + trans_num_colour_exp+ " || Actual Trans Number field is Not Green colour so it was able to retrive the [CONFIRM] Records : " + Act_Color);
		Extent_fail(driver, "Not matched || Expected color Trans Number field should be Green colour so it was able to retrive the [CONFIRM] Records :" + trans_num_colour_exp+ " || Actual Trans Number field is Not Green colour so it was able to retrive the [CONFIRM] Records : " + Act_Color, test, test1);
	}
