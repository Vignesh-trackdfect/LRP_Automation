...
public class TC_Haulage_Contract_SC12 extends Keywords{
	public void Haulage_Contract_SC12(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC12";
		...
		Step_Start(5, "Click the Equipment drop down and select the Equipment type", test, test1);
		...
		click(driver, HC_Equipment_select);
		  ...
		  Step_End(5, "Click the Equipment drop down and select the Equipment type", test, test1);
		
		  Step_Start(6, "Click the LDN/MTY and select the type of the Equipment", test, test1);
		...
		Step_End(6, "Click the LDN/MTY and select the type of the Equipment", test, test1);
		
		
	waitForElement(driver, HC_Equipment_select);
	String Act_Equipment=getText(driver, HC_Equipment_select);
	if(Equipment_Type.equals(Act_Equipment)) {
		System.out.println("Matched || Expected Result is : " +Equipment_Type +  " || Actual Result is  :" +Act_Equipment);
		Extent_pass_New(driver, "Matched || Expected Result is : " +Equipment_Type +  " || Actual Result is  :" +Act_Equipment, test, test1);
	}else {
		System.out.println("Not Matched || Expected Result is : " +Equipment_Type +  " || Actual Result is  :" +Act_Equipment);
        Extent_fail(driver, "Not Matched || Expected Result is : " +Equipment_Type +  " || Actual Result is  :" +Act_Equipment, test, test1);
	}
	
	waitForElement(driver, HC_LDN_MTY_Select);
	String Act_LDN_MTY_Value=getText(driver, HC_LDN_MTY_Select);
	if(HC_LDN_MTY_Value.equals(Act_LDN_MTY_Value)) {
		System.out.println("Matched || Expected Result is : " +HC_LDN_MTY_Value +  " || Actual Result is  :" +Act_LDN_MTY_Value);
		Extent_pass_New(driver, "Matched || Expected Result is : " +HC_LDN_MTY_Value +  " || Actual Result is  :" +Act_LDN_MTY_Value, test, test1);
	}else {
		System.out.println("Not Matched || Expected Result is : " +HC_LDN_MTY_Value +  " || Actual Result is  :" +Act_LDN_MTY_Value);
        Extent_fail(driver, "Not Matched || Expected Result is : " +HC_LDN_MTY_Value +  " || Actual Result is  :" +Act_LDN_MTY_Value, test, test1);
	}
