...
public class TC_DG_Creation_SC_096 extends Keywords {


	public void DG_Creation_SC_096(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_096";
...
//		Module Search
		...
		Step_Start(11,"DG Details  not attached in the booking imo tab.", test, test1);
		...
		if(verifyElementHasText(driver, IMO_Tab_Row)) {
			System.out.println("Matched || Expected : DG Details should be added in IMO Tab Grid || Actual :  DG Details are added in IMO Tab Grid ");
			Extent_pass_New(driver, "Matched || Expected : DG Details should be added in IMO Tab Grid || Actual :  DG Details are added in IMO Tab Grid ", test, test1);
		} else {
			System.out.println("Not Matched || Expected : DG Details should be added in IMO Tab Grid || Actual :  DG Details are not added in IMO Tab Grid ");
			Extent_fail(driver, "Not Matched || Expected : DG Details should be added in IMO Tab Grid || Actual :  DG Details are not added in IMO Tab Grid ", test, test1);
		}
		
		Step_End(11,"DG Details  not attached in the booking imo tab.", test, test1);
