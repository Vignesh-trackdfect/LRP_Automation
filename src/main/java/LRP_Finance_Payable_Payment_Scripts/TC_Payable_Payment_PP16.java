...
public class TC_Payable_Payment_PP16 extends Keywords {
	

public void Payable_Payment_PP16(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
		
		String testcase_Name="TC_Payable_Payment_PP16";
		...
		String currency_Code_Data = Excel_data.get("currency_Code_Data");
       ...
       LRP_Login(driver, Username, Password);
		...
		waitForElement(driver, currency_Search_Icon_PPT);
		click(driver, currency_Search_Icon_PPT);
		
		twoColumnSearchWindow(driver, Currency_Code, dropdownCondition, currency_Code_Data);
		...
		click(driver, add_Symbol_PPT);
				...
				if(actual_Popup.equals(expected_Popup)) {
					
				System.out.println("MATCHED || EXPECTED Popup :After click on Add button ROE value should be get automatically selected based on document currency : "+expected_Popup+"|| Actual Popup : After click on Add button ROE value is get automatically selected based on document currency  : "+actual_Popup);
				Extent_pass_New(driver, "MATCHED || EXPECTED Popup : After click on Add button ROE value should be get automatically selected based on document currency : "+expected_Popup+"|| Actual Popup : After click on Add button ROE value is get automatically selected based on document currency : "+actual_Popup, test, test1);
				click(driver, popup_Message_Ok_Button);
				}else {
					
					System.out.println("NOT MATCHED || EXPECTED Popup : After click on Add button ROE value should be get automatically selected based on document currency : "+expected_Popup+"|| Actual Popup : After click on Add button ROE value is get automatically Not selected based on document currency  : "+actual_Popup);
					Extent_fail(driver, "NOT MATCHED || EXPECTED Popup :After click on Add button ROE value should be get automatically selected based on document currency: "+expected_Popup+"|| Actual Popup : After click on Add button ROE value is get automatically Not selected based on document currency   : "+actual_Popup, test, test1);
