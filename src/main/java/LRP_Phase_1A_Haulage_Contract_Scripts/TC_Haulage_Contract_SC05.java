...
public class TC_Haulage_Contract_SC05 extends Keywords{
	public void Haulage_Contract_SC05(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC05";
		...
		waitForElement(driver, HC_Pickup_Location_Field);
         ...
         if(Pickup_Location_Value.equals(Pickup_Location_Value_Act)) {
        	 System.out.println("Expected Result is :"+Pickup_Location_Value + " || Actual Result is : "+Pickup_Location_Value_Act);
        	 Extent_pass_New(driver, "Expected Result is :"+Pickup_Location_Value + " || Actual Result is : "+Pickup_Location_Value_Act, test, test1);
         }else {
        	 System.out.println("Expected Result is :"+Pickup_Location_Value + " || Actual Result is : "+Pickup_Location_Value_Act);
             Extent_fail(driver, "Expected Result is :"+Pickup_Location_Value + "||  Actual Result is : "+Pickup_Location_Value_Act, test, test1);
         }
