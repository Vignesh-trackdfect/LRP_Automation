...
public class TC_Billing_Invoice_B04   extends Keywords{
	public void  Billing_Invoice_B04(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Billing_Invoice_B04";
		...
		Step_Start(13, "System should show the validation as \"Invoice Date must be in the Open Periods\".", test, test1);
		...
		if (Billing_date_popup.equals(Actualpopmsg)) {
			System.out.println("Matched ||  Expected After click on Add button System should be show the validation as Invoice Date must be in the Open Periods : " + Billing_date_popup+ " || Actual click on Add button System is show the validation as Invoice Date must be in the Open Periods : " + Actualpopmsg);
			Extent_pass_New(driver, "Matched ||Expected After click on Add button System should be show the validation as Invoice Date must be in the Open Periods : " + Billing_date_popup+ " || Actual click on Add button System is show the validation as Invoice Date must be in the Open Periods : " + Actualpopmsg, test, test1);
			Extent_call(test, test1, Actualpopmsg);
		} else {
			System.out.println("Not matched || Expected After click on Add button System should be show the validation as Invoice Date must be in the Open Periods : " + Billing_date_popup+ " || Actual click on Add button System is Not show the validation as Invoice Date must be in the Open Periods : " + Actualpopmsg);
			Extent_fail(driver, "Not matched || Expected After click on Add button System should be show the validation as Invoice Date must be in the Open Periods : " + Billing_date_popup+ " ||Actual click on Add button System is Not show the validation as Invoice Date must be in the Open Periods : " + Actualpopmsg, test, test1);

		}
		Step_End(13, "System should show the validation as \"Invoice Date must be in the Open Periods\".", test, test1);
