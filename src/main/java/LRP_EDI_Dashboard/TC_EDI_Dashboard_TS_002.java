...
public class TC_EDI_Dashboard_TS_002 extends Keywords {

	public void EDI_Dashboard_TS_002(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Dashboard_TS_002";
		...
		String EDI_Popup_Message = Excel_data.get("EDI_Popup_Message");
		String EDI_Message_Popup = Excel_data.get("EDI_Message_Popup");
		String Mess_Function_Drop_Down = Excel_data.get("Mess_Function_Drop_Down");
		String EDI_Service_Popup = Excel_data.get("EDI_Service_Popup");
		String EDI_Operation = Excel_data.get("EDI_Operation");
		...
		waitForPopup(driver, popup_Message, EDI_Popup_Message);
		String Act_Edi_popup = getText(driver, popup_Message);

		if (EDI_Popup_Message.equals(Act_Edi_popup)) {
			System.out.println("Popup Matched ||  Expected : " + EDI_Popup_Message + " || Actual : " + Act_Edi_popup);
			Extent_pass_New(driver,
					"Popup Matched ||  Expected : " + EDI_Popup_Message + " || Actual : " + Act_Edi_popup, test, test1);
		} else {
			System.out
					.println("Popup Not Matched ||  Expected : " + EDI_Popup_Message + " || Actual : " + Act_Edi_popup);
			Extent_fail(driver,
					"Popup Not Matched ||  Expected : " + EDI_Popup_Message + " || Actual : " + Act_Edi_popup, test,
					test1);
		}
		...
		Step_Start(2, "Enter the EDI details (EDI746)", test, test1);
		...
		Step_End(2, "Enter the EDI details (EDI746)", test, test1);

		waitForElement(driver, EDI_DB_Show_Button);
		click(driver, EDI_DB_Show_Button);

		waitForPopup(driver, popup_Message, EDI_Service_Popup);
		String Act_Edi_Mess = getText(driver, popup_Message);

		if (Act_Edi_Mess.equals(EDI_Message_Popup)) {
			System.out.println("Popup Matched ||  Expected : " + EDI_Message_Popup + " || Actual : " + Act_Edi_Mess);
			Extent_pass_New(driver,
					"Popup Matched ||  Expected : " + EDI_Message_Popup + " || Actual : " + Act_Edi_Mess, test, test1);
		} else {
			System.out
					.println("Popup Not Matched ||  Expected : " + EDI_Message_Popup + " || Actual : " + Act_Edi_Mess);
			Extent_fail(driver,
					"Popup Not Matched ||  Expected : " + EDI_Message_Popup + " || Actual : " + Act_Edi_Mess, test,
					test1);
		}
		...
		waitForPopup(driver, popup_Message, EDI_Operation);
		String Act_Operation = getText(driver, popup_Message);

		if (Act_Operation.equals(EDI_Operation)) {
			System.out.println("Popup Matched ||  Expected : " + EDI_Operation + " || Actual : " + Act_Operation);
			Extent_pass_New(driver, "Popup Matched ||  Expected : " + EDI_Operation + " || Actual : " + Act_Operation,
					test, test1);
		} else {
			System.out.println("Popup Not Matched ||  Expected : " + EDI_Operation + " || Actual : " + Act_Operation);
			Extent_fail(driver, "Popup Not Matched ||  Expected : " + EDI_Operation + " || Actual : " + Act_Operation,
					test, test1);
		}
		...
		waitForPopup(driver, popup_Message, EDI_Service_Popup);
		String Act_Service = getText(driver, popup_Message);

		if (Act_Service.equals(EDI_Service_Popup)) {
			System.out.println("Popup Matched ||  Expected : " + Act_Service + " || Actual : " + Act_Edi_Mess);
			Extent_pass_New(driver, "Popup Matched ||  Expected : " + Act_Service + " || Actual : " + Act_Edi_Mess,
					test, test1);
		} else {
			System.out.println("Popup Not Matched ||  Expected : " + Act_Service + " || Actual : " + Act_Edi_Mess);
			Extent_fail(driver, "Popup Not Matched ||  Expected : " + Act_Service + " || Actual : " + Act_Edi_Mess,
					test, test1);
		}
		...
		Step_Start(3, "Select Service code field (KILL) ", test, test1);
		Step_Start(4, "Select any data from the favorite search ", test, test1);
		...
		Step_End(4, "Select any data from the favorite search ", test, test1);
		Step_End(3, "Select Service code field (KILL) ", test, test1);

		Step_Start(5, "Click the show button ", test, test1);
		...
		Step_Start(6, "And select all the datas ", test, test1);
		...
		Step_End(7, "Click the Generate EDI button", test, test1);
