...
public class TC_Contract_Management_System_SC130 extends Keywords{

public void Contract_Management_System_SC130(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC130";
		...
		if(Contract_saved.equals(saved_popup)) {
			Extent_pass(driver,"Expected popup|| The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message. : "+Contract_saved+" || Actual popup || The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message. : "+ saved_popup, test,test1);
			System.out.println("Expected popup|| The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+Contract_saved+" || Actual popup || The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+ saved_popup);
		}else {
			System.out.println("Expected popup|| The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+Contract_saved+" || Actual popup || The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+ saved_popup);
			Extent_fail(driver,"Expected popup|| The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+Contract_saved+" || Actual popup  ||The system should not validate the entry if the General Tariff is not added; instead, it should display a Save popup message.: "+ saved_popup, test,test1);
