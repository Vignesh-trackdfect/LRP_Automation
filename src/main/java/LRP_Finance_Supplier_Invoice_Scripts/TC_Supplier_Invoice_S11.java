...
public class TC_Supplier_Invoice_S11  extends Keywords{

	public void  Supplier_Invoice_S11(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Supplier_Invoice_S11";
		...
		Step_Start(7, "Select the discription", test, test1);

		waitForElement(driver, Supplier_Discription_input);
		sendKeys(driver, Supplier_Discription_input, Discription_input);
		Step_End(7, "Select the discription", test, test1);
		Step_Start(8, "select the payment method", test, test1);
		...
		Step_End(8, "select the payment method", test, test1);
		...
		Step_Start(10, "Select the nominal from the search button for Dr.", test, test1);
		...
		Step_End(10, "Select the nominal from the search button for Dr", test, test1);
		Step_Start(11, "Enter the valid amount in amount text field for Dr", test, test1);
		...
		Step_End(11, "Enter the valid amount in amount text field for Dr", test, test1);
		Step_Start(12, "Select the document currency using search bar from the currency details list and Based on that selected currency roe amount and home amount will change", test, test1);
		...
		Step_End(12, "Select the document currency using search bar from the currency details list and Based on that selected currency roe amount and home amount will change", test, test1);
		Step_Start(13, "Click + button to add the nominals in the grid", test, test1);
		waitForElement(driver, Supplier_Gird_add_button);
		click(driver,Supplier_Gird_add_button);
		Step_End(13, "Click + button to add the nominals in the grid", test, test1);
		Step_Start(14, "System should show the validation as \"\"Enter the area\"\"", test, test1);
		...
		Step_End(14, "System should show the validation as \"\"Enter the area\"\"", test, test1);
