...
public class TC_Contract_Management_System_SC258 extends Keywords{


	public void Contract_Management_System_SC258(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName="TC_Contract_Management_System_SC258";
		...
		String[] values = Act_Total_record.split("of");
		String Final_Value = values[0].trim();
		System.out.println("Final total Count : "+Final_Value);
		int Total_Record= Integer.parseInt(Final_Value);
		...
		String[] values1 = Final_Act_Total_record.split("of");
		String Final_Value1 = values1[0].trim();
		System.out.println("Final total Count : "+Final_Value1);
		int Final_Value_count = Integer.parseInt(Final_Value1);
