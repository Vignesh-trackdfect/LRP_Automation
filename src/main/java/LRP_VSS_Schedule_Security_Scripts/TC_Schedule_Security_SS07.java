...
public class TC_Schedule_Security_SS07  extends Keywords{

	public void Schedule_Security_SS07(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name="TC_Schedule_Security_SS07";
		...
		String VesselCode_Input = Excel_data.get("VesselCode_Input");
		...
		String Already_Having_Popup_Value = Excel_data.get("Already_Having_Popup_Value");
		...
		Step_Start(3, "Select the Existing Username using  user name  search box.", test, test1);
		...
		Step_End(3, "Select the Existing Username using  user name  search box.", test, test1);
		...
		datas = splitAndExpand1(VesselCode_Input);
		for (String data : datas) {
		...
		Step_Start(13, "System Should show the pop message says 'This user already having access for the following service and vessel'", test, test1);
		
		waitForPopup(driver, already_Having_Popup,Already_Having_Popup_Value);
		String schedule_Pop_Act=getText(driver, already_Having_Popup);
		if(Already_Having_Popup_Value.trim().equals(schedule_Pop_Act.trim())) {
			Extent_pass_New(driver, "Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Already_Having_Popup_Value+" || Actual : After click on save button Popup value is display in the Schedule Security Screen : "+schedule_Pop_Act, test, test1);
			System.out.println("Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Already_Having_Popup_Value+" || Actual : After click on save button Popup value is display in the Schedule Security Screen : "+schedule_Pop_Act);
			Step_End(13, "System Should show the pop message says 'This user already having access for the following service and vessel'", test, test1);
			Step_Start(14, "Click on the Continue button in the Popup", test, test1);
			waitForElement(driver, continue_Button);	
			click(driver, continue_Button);
		}else {
			System.out.println("Not Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Already_Having_Popup_Value+" ||Actual : After click on save button Popup value is not display in the Schedule Security Screen : "+schedule_Pop_Act);
			Extent_fail(driver, "Not Matched || Expected : After click on save button Popup value should be display in the Schedule Security Screen : "+Already_Having_Popup_Value+" || Actual : After click on save button Popup value is not display in the Schedule Security Screen : "+schedule_Pop_Act, test, test1);
		}

		Step_Start(14, "Click on the Continue button in the Popup", test, test1);
		Step_Start(15, "Click on the Continue button in the Popup", test, test1);
		...
		Step_End(15, "Click on the Continue button in the Popup", test, test1);
