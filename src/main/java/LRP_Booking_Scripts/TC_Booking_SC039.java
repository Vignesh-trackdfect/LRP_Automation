...
//Check whether in container tab carrier and shipper seal should be different
public class TC_Booking_SC039 extends Keywords {

	public void Booking_SC039(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String test_Case_Name = "TC_Booking_SC039";
		...
		Step_Start(7, "Enter the carrier and shipper  seal should be different", test, test1);
		...
		if (DummyContainer.contains(Value3)) {
			System.out
			.println("Matched || Expected value was : " + DummyContainer + " || Actual value was : " + Value3);
			...
			Extent_fail(driver,
					"NotMatched || Expected value was : " + DummyContainer + " || Actual value was : " + Value3, test,
					test1);

		}
		waitForElement(driver, dummy_container_yes);
		safeclick(driver, dummy_container_yes);
		waitForElement(driver, Container_Tab_grid_Header);
		...
		String Carrier_Seal = getFirstRowValueByHeaderFromTableData(Container_Data, "Carrier Seal");
		System.out.println("Carrier Seal :"+Carrier_Seal);
		String Shipper_Seal = getFirstRowValueByHeaderFromTableData(Container_Data, "Shipper Seal");
		System.out.println("Shipper Seal :"+Shipper_Seal);
		if (CarrieaSeal.equals(Carrier_Seal)) {
			System.out.println("Matched || Expected value was : " + CarrieaSeal + " || Actual value was : " + Carrier_Seal);
			Extent_pass_New(driver, "Matched || Expected value was : " + CarrieaSeal + " || Actual value was : " + Carrier_Seal,
					test, test1);
		} else {
			System.out
			.println("NotMatched || Expected value was : " + CarrieaSeal + " || Actual value was : " + Carrier_Seal);
			Extent_fail(driver,
					"NotMatched || Expected value was : " + CarrieaSeal + " || Actual value was : " + Carrier_Seal, test,
					test1);
		}

		if (ShipperSeal.equals(Shipper_Seal)) {
			System.out.println("Matched || Expected value was : " + ShipperSeal + " || Actual value was : " + Shipper_Seal);
			Extent_pass_New(driver, "Matched || Expected value was : " + ShipperSeal + " || Actual value was : " + Shipper_Seal,
					test, test1);
		} else {
			System.out
			.println("NotMatched || Expected value was : " + ShipperSeal + " || Actual value was : " + Shipper_Seal);
			Extent_fail(driver,
					"NotMatched || Expected value was : " + ShipperSeal + " || Actual value was : " + Shipper_Seal, test,
					test1);
		}
		Step_End(7, "Enter the carrier and shipper  seal should be different", test, test1);
