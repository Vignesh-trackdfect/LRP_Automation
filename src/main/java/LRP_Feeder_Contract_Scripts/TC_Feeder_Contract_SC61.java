...
public class TC_Feeder_Contract_SC61 extends Keywords {

	public void Feeder_Contract_SC61(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC61";
		...
		Step_Start(9, "Click show all ,It show the all exsiting detials", test, test1);

		waitForElement(driver, FC_Show_All_RadioButton);
		click(driver, FC_Show_All_RadioButton);
		...
		if ((!today.isEqual(validFrom) || !today.isAfter(validFrom))
			...
			Extent_pass_New(driver, "Current date is not within the valid range.  ||From date : " + validFrom
			...
			System.out.println("Current date is within the valid range.     ||From date : " + validFrom
					+ "  || To date  : " + validTo + " || Current Date :" + today);
			Extent_fail(driver, "Current date is within the valid range.     ||From date : " + validFrom
					+ "  || To date  : " + validTo + " || Current Date :" + today, test, test1);
		}

		Step_End(9, "Click show all ,It show the all exsiting detials ", test, test1);
