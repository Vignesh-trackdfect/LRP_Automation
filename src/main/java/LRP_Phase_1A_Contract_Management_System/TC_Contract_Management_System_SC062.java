...
public class TC_Contract_Management_System_SC062 extends Keywords {
	public void Contract_Management_System_SC62(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC062";
		...
		String Load_nfmc_locdetailspopup = Excel_data.get("Load_nfmc_locdetailspopup");
		...
		Step_Start(6, "enter the non-N-FMC load and discharge ports", test, test1);
		...
		Step_End(6, "enter the non-N-FMC load and discharge ports", test, test1);
		...
		waitForPopup(driver, Popup_Message, Load_nfmc_locdetailspopup);
		String Popup_Text_Act = getText(driver, Popup_Message);

		if (Popup_Text_Act.equals(Load_nfmc_locdetailspopup)) {
			System.out.println(
					"Matched  || When enter the FMC origin or delivery details for NON FMC, the Expected popup is "
							+ Load_nfmc_locdetailspopup
							+ "   ||  When enter the  FMC origin or delivery details for NON FMC, the Actual popup is :  "
							+ Popup_Text_Act);
			Extent_pass(driver,
					" Matched  || When enter the  FMC origin or delivery details for NON FMC , the Expected popup is : "
							+ Load_nfmc_locdetailspopup
			...
			System.out.println(
					"Not Matched  ||  When enter the  FMC origin or delivery details for NON FMC, the Expected popup is :  "
							+ Load_nfmc_locdetailspopup
							+ "   ||  When enter the  FMC origin or delivery details for NON FMC , the Actual popup is : "
							+ Popup_Text_Act);
			Extent_fail(driver,
					" Not Matched  || When enter the  FMC origin or delivery details for NONFMC ,the Expected popup is : "
							+ Load_nfmc_locdetailspopup
							+ "   || When enter the  FMC origin or delivery details for NON FMC , the Actual popup is : "
							+ Popup_Text_Act,
					test, test1);
