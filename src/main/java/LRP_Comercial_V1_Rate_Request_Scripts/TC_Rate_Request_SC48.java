...
public class TC_Rate_Request_SC48 extends Keywords{
	...
	public void Rate_Request_SC48(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		String amount_data=Excel_data.get("amount_data");
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
		...
		click(driver, Mail_Cancel_button);
			...
			twoColumnMultipleSearchWindow(driver,Charge_Code_Header, Condition, surcharge_value);
			...
			String surcharge_Amnt_Input =  formatLocatorClick(driver, surcharge_Amount_Input, surcharge_value);
			Newclear(driver, surcharge_Amnt_Input);
            Actionsendkeys(driver, surcharge_Amnt_Input, amount_data);
