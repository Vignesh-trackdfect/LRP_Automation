...
public class TC_Bill_Of_Lading_SC14 extends Keywords {

	public void Bill_Of_Lading_SC14(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Bill_Of_Lading_SC14";
		...
		if(saved_pop_act.contains(saved_pop_exp)) {                                                                                                                  
			...
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + saved_pop_exp + " || Actual Report Activity is : " + saved_pop_act, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
		...
		scrollToElement(driver, Pdf_Draft);
		waitForElement(driver, Pdf_Draft);
		Step_End(8, "System will load the data in print", test, test1);
		Step_Start(9, "Capture whether the \"draft\" text available", test, test1);
		
		String Draft_Pdf_Value=getText(driver, Pdf_Draft) ;
		if(draft.trim().equals(Draft_Pdf_Value.trim())) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity  value shown as is : " + draft + " || Actual Report Activity value shown as is : " + Draft_Pdf_Value);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity value shown as is : " + draft + " || Actual Report Activity value shown as is : " + Draft_Pdf_Value, test,test1);     
		}else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity value shown as is : " + draft + " || Actual Report Activity value shown as is : " + Draft_Pdf_Value);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity value shown as is : " + draft + " || Actual Report Activityvalue shown as  is : " + Draft_Pdf_Value, test,test1); 
		} 
		Step_End(9, "Capture whether the \"draft\" text available", test, test1);
