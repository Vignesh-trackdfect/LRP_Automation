...
public class TC_Contract_Management_System_SC046 extends Keywords {

	public void Contract_Management_System_SC46(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC046";
		...
		if (Contract_Activated.equals(ActivatePopup)) {
			...
			System.out.println(
					"Not Matched || Expected value is : After create a duplicate record, The status should be : "
							+ Contract_Activated
							+ " Actual value is : After create a duplicate record, The status is not display : "
							+ ActivatePopup);

			Extent_fail(driver,
					"Not Matched || Expected value is : After create a duplicate record, The status should be : "
							+ Contract_Activated
							+ " Actual value is : Aftercreate a duplicate record, The status is not display : "
							+ ActivatePopup,
					test, test1);
