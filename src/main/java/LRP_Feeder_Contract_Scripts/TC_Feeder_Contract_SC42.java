...
public class TC_Feeder_Contract_SC42 extends Keywords {

	public void Feeder_Contract_SC42(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws Exception {

		String testcase_Name = "TC_Feeder_Contract_SC42";
		...
		Step_Start(27, "Select the sheet based on the Screen.", test, test1);
		...
		Step_End(27, "Select the sheet based on the Screen.", test, test1);

		Step_Start(28, "Click upload.", test, test1);
		...
		Step_End(28, "Click upload.", test, test1);

		Step_Start(29, "System check the data,Its a exsiting data,it shows the validity.", test, test1);
		...
		Step_End(29, "System check the data,Its a exsiting data,it shows the validity.", test, test1);
