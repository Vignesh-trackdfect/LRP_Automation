...
public class TC_DG_Creation_SC_036 extends Keywords {

	public void DG_Creation_SC_036(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url)
			throws EncryptedDocumentException, InvalidFormatException, IOException {
		// Value are taken from excel sheet
		String testcase_Name = "TC_DG_Creation_SC_036";
		...
		String Cancel_Popup = Excel_data.get("Cancel_Popup");
		String  Cannot_Edited_Popup= Excel_data.get("Cannot_Edited_Popup");
...
//		Module Search
		...
		waitForElement(driver, cancel_Button_DG);
		safeclick(driver, cancel_Button_DG);
		
		
		waitForElement(driver, Cancel_Ok_Button);
		safeclick(driver, Cancel_Ok_Button);
		
		waitForPopup(driver, popup_Message,Cancel_Popup);
		String Act_Cancel_Popup = getText(driver, popup_Message);
		System.out.println(Act_Cancel_Popup);
		if(Act_Cancel_Popup.contains(Cancel_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup, test,test1);
		}
	...
	input_Fields.dg_Creation_Input_Fields(driver,Excel_data, test, test1);
		...
		safeclick(driver, Multi_Apply_Btn);
		waitForPopup(driver, popup_Message,Applied_Popup_Exp);
		 Applied_Popup = getText(driver, popup_Message);
		System.out.println(Applied_Popup);
		if(Applied_Popup.equals(Applied_Popup_Exp)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Applied_Popup_Exp + " || Actual Report Activity is : " + Applied_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is: " + Applied_Popup_Exp + " || Actual Report Activity is : " + Applied_Popup, test,test1);     
		...
		System.out.println(Applied_Popup);
		if(Saved_Popup1.equals(Details_Saved_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Details_Saved_Popup + " || Actual Report Activity is : " + Saved_Popup1);            
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is: " + Details_Saved_Popup + " || Actual Report Activity is : " + Saved_Popup1, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Details_Saved_Popup + " || Actual Report Activity is : " + Saved_Popup1);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Details_Saved_Popup + " || Actual Report Activity is : " + Saved_Popup1, test,test1); 
		}
		waitForElement(driver, Send_Btn);
		safeclick(driver, Send_Btn);
		...
		scrollTop(driver);
		waitForElement(driver, DG_no);
		String generated_DG_Number2=getAttribute(driver, DG_no,"value");
		System.out.println(" generated_DG_Number : "+ generated_DG_Number2);
		
		if(!generated_DG_Number2.equals("")) {
			
			System.out.println("Matched || Expected : DG Number should be generated || Actual : Generated DG Number : "+generated_DG_Number2);            
			Extent_pass_New(driver, "Matched || Expected : DG Number should be generated || Actual : Generated DG Number : "+generated_DG_Number2, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || Expected : DG Number should be generated || Actual : Generated DG Number : "+generated_DG_Number2);        
			Extent_fail(driver, "Not Matched || Expected : DG Number should be generated || Actual : Generated DG Number : "+generated_DG_Number2, test,test1);
		}
		
		Step_Start(1, "Retrieve  the old  cancel  status DG number .", test, test1);
		...
		globalValueSearchWindow(driver, GlobalSearch_Condition, DG_No_Type, generated_DG_Number2, "", "", "", "");
		...
		waitForPopup(driver, popup_Message,Cancel_Popup);
		 Act_Cancel_Popup = getText(driver, popup_Message);
		System.out.println(Act_Cancel_Popup);
		if(Act_Cancel_Popup.contains(Cancel_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Cancel_Popup + " || Actual Popup is : " + Act_Cancel_Popup, test,test1);     
		...
		Step_End(1, "Retrieve  the old  cancel  status DG number .", test, test1);
		
		
		Step_Start(2, "click recall button .", test, test1);
		...
		waitForPopup(driver, popup_Message,Cannot_Edited_Popup);
		 Act_Cancel_Popup = getText(driver, popup_Message);
		System.out.println(Act_Cancel_Popup);
		if(Act_Cancel_Popup.contains(Cannot_Edited_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + Cannot_Edited_Popup + " || Actual Popup is : " + Act_Cancel_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Cannot_Edited_Popup + " || Actual Popup is : " + Act_Cancel_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + Cannot_Edited_Popup + " || Actual Popup is : " + Act_Cancel_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + Cannot_Edited_Popup + " || Actual Popup is : " + Act_Cancel_Popup, test,test1);
	...
	Step_End(2, "click recall button .", test, test1);
