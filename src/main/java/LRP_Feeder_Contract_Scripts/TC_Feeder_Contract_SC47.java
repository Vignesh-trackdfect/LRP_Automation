...
public class TC_Feeder_Contract_SC47 extends Keywords {

	public void Feeder_Contract_SC47(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC47";
		...
		String Remove_Charge_Code = Excel_data.get("Surchage_Charge_Code");
		...
		Step_Start(24, ".Select the Location pair details and click the Apply surcharge", test, test1);
		...
		Step_End(24, ".Select the Location pair details and click the Apply surcharge", test, test1);
