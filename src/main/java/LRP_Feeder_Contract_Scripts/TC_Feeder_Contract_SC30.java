...
public class TC_Feeder_Contract_SC30 extends Keywords {

	public void Feeder_Contract_SC30(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC30";
		...
		if (POL_Value.equals(gridLocation)) {

			System.out.println("Expected result || The selected Location To Pay " + POL_Value
			...
			Extent_pass_New(driver, "Expected result || The selected Location To Pay " + POL_Value
					+ " should be displayed in the grid LocationToPay || Actual result : The selected Location To Pay "
			...
			Extent_fail(driver, "Expected result || The selected Location To Pay " + POL_Value
					+ " should be displayed in the grid LocationToPay || Actual result : The selected Location To Pay "
