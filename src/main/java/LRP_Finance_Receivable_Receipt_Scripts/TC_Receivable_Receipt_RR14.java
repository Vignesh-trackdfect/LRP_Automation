...
public class TC_Receivable_Receipt_RR14 extends Keywords {

	public void Receivable_Receipt_RR14(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Receivable_Receipt_RR14";
		...
		waitForDisplay(driver, cheque_Drpdwn_Items_Rr);

		if (isDisplayed(driver, cheque_Drpdwn_Items_Rr)) {

			System.out.println("Matched || Expected : After click the dropdown Cheque/Cash/TT should be display. || Actual :After click the dropdown Cheque/Cash/TT Is display");
			Extent_pass_New(driver, "Matched || Expected : After click the dropdown Cheque/Cash/TT should be display. || Actual :After click the dropdown Cheque/Cash/TT Is display", test, test1);
		} else {

			System.out.println("Not Matched || Expected : After click the dropdown Cheque/Cash/TT should be display. || Actual :After click the dropdown Cheque/Cash/TT Is Not display");
			Extent_fail(driver, "Not Matched || Expected : After click the dropdown Cheque/Cash/TT should be display. || Actual :After click the dropdown Cheque/Cash/TT Is Not display", test, test1);
		}
