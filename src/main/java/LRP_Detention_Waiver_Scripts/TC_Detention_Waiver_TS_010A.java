...
public class TC_Detention_Waiver_TS_010A extends Keywords {

	public void Detention_Waiver_TS_010A(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Detention_Waiver_TS_010A";
		...
		String WaiverPercentage_greaterzero_popup = Excel_data.get("WaiverPercentage_greaterzero_popup");
...
Step_Start(1, "Open Detention weiver Module", test, test1);
		...
		Step_Start(6, "Go to % Field and enter the Value as -1 ", test, test1);
		...
		Step_End(6, "Go to % Field and enter the Value as -1 ", test, test1);
		...
		waitForPopup(driver, Popup_Message, WaiverPercentage_greaterzero_popup);
		String negative_value_greaterzero_validation = getText(driver, Popup_Message);

		if (negative_value_greaterzero_validation.equals(WaiverPercentage_greaterzero_popup)) {

			System.out.println("Matched ||   Expected popup : " + WaiverPercentage_greaterzero_popup
					+ "   ||   Actual popup   : " + negative_value_greaterzero_validation);
			Extent_pass_New(driver, "  Matched ||   Expected popup : " + WaiverPercentage_greaterzero_popup
					+ "   ||   Actual popup    : " + negative_value_greaterzero_validation, test, test1);
		} else {
			System.out.println(" Not Matched ||   Expected popup  : " + WaiverPercentage_greaterzero_popup
					+ "   ||   Actual popup    : " + negative_value_greaterzero_validation);
			Extent_fail(driver, " Not Matched ||   Expected popup  : " + WaiverPercentage_greaterzero_popup
					+ "   ||   Actual popup    : " + negative_value_greaterzero_validation, test, test1);
		}
