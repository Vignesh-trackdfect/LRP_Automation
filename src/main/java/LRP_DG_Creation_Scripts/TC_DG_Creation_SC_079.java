...
public class TC_DG_Creation_SC_079 extends Keywords {


	public void DG_Creation_SC_079(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_079";
		...
		String Load_Confirmation_Done_Popup = Excel_data.get("Load_Confirmation_Done_Popup");
...
//		Load Confirmation module
	...
	//		Select service
			...
			sendKeys(driver, L_vessel_Input,Vessel );
	...
	if(retrivedBookNo.equals(booknum)) {
		Extent_pass_New(driver, "Matched || Expected Booking Number : "+booknum+" || Actual Booking Number : "+retrivedBookNo, test,test1);
		System.out.println( "Matched || Expected Booking Number : "+booknum+" || Actual Booking Number : "+retrivedBookNo);
		...
		waitForElement(driver, LC_actualContainerNo_Inputfield);
		sendKeys(driver, LC_actualContainerNo_Inputfield, equipment_No);
		...
		System.out.println( "Not Matched || Expected Booking Number : "+booknum+" || Actual Booking Number : "+retrivedBookNo);
		Extent_fail(driver, "Not Matched || Expected Booking Number : "+booknum+" || Actual Booking Number : "+retrivedBookNo, test,test1);
	}
...
//			DG Creation
			...
			waitForPopup(driver, popup_Message,Load_Confirmation_Done_Popup);
			String Actual_LoadConfirmed_Popup = getText(driver, popup_Message);
			if(Actual_LoadConfirmed_Popup.equals(Load_Confirmation_Done_Popup)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Popup is : " + Load_Confirmation_Done_Popup + " || Actual Popup is : " + Actual_LoadConfirmed_Popup);            
				Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Load_Confirmation_Done_Popup + " || Actual Popup is : " + Actual_LoadConfirmed_Popup, test,test1);     
				
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + " Expected Popup is : " + Load_Confirmation_Done_Popup + " || Actual Popup is : " + Actual_LoadConfirmed_Popup);        
				Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + Load_Confirmation_Done_Popup + " || Actual Popup is : " + Actual_LoadConfirmed_Popup, test,test1); 
			} 
