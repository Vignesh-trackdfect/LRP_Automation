...
public class TC_DG_Creation_SC_082 extends Keywords {


	public void DG_Creation_SC_082(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_082";
...
//		Plugin Configuration
		...
		Step_Start(2, "make sure   netweight  button enable", test, test1);
		...
		Step_End(2, "make sure   netweight  button enable", test, test1);
