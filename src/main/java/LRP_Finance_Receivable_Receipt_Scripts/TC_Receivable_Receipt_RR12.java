...
public class TC_Receivable_Receipt_RR12 extends Keywords {

	public void Receivable_Receipt_RR12(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Receivable_Receipt_RR12";
		...
		Step_Start(9, "system should show pop up validation as \" Enter the Description\"", test, test1);
		...
		Step_End(9, "system should show pop up validation as \" Enter the Description\"", test, test1);
