...
public class TC_PartBL_TC014 extends Keywords {

	public void PartBL_TC014(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws Exception {

		String testCaseName = "TC_PartBL_TC014";
		String username = Excel_data.get("Username");
		String password = Excel_data.get("Password");
		String Agency_Name = Excel_data.get("Agency_Name");
		String GC_Module = Excel_data.get("GC_Module");
		...
		String GlobalValue_Yes = Excel_data.get("GlobalValue_Yes");
		...
		Step_Start(1, "Set LPC global config is Y", test, test1);

		moduleNavigate(driver, GC_Module);

		waitForElement(driver, Attribute_Filter);
		sendKeys(driver, Attribute_Filter, pluginID);

		formatLocatorDoubleClick(driver, Attribute_Select, pluginID);
		waitForElement(driver, Edit_Button_toolBar);
		safeclick(driver, Edit_Button_toolBar);

		waitForElement(driver, valueTextfield);
		clear(driver, valueTextfield);
		sendKeys(driver, valueTextfield, GlobalValue_Yes);
		...
		Step_End(1, "Set LPC global config is Y", test, test1);
		...
		Step_Start(22, "Retrieve the BL in the Bill of Lading module and check the LP charges in BL charge tab.", test,
				test1);
		...
		Step_End(22, "Retrieve the BL in the Bill of Lading module and check the LP charges in BL charge tab.", test,
				test1);
