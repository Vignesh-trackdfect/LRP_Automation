...
public class TC_Rate_Request_SC092   extends Keywords{

	
	public void Rate_Request_SC092(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Rate_Request_SC092";
