...
public class TC_Recurring_Journal_RJ18 extends Keywords{
	public void Recurring_Journal_RJ18(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws EncryptedDocumentException, InvalidFormatException, IOException{
		String testcase_Name="TC_Recurring_Journal_RJ18";
		...
		Step_Start(7, "Choose the Post type as CLOSED", test, test1);
		...
		Step_End(7, "Choose the Post type as CLOSED", test, test1);
		...
		Step_Start(9, "Recurring JV should be showed which is in Closed status", test, test1);
		...
		Step_End(9, "Recurring JV should be showed which is in Closed status", test, test1);
