...
public class TC_Contract_Management_System_SC050 extends Keywords {
	public void Contract_Management_System_SC50(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC050";
		...
		isElementEnabled(driver, Contract_Management_System_Edit);
		...
		waitForElement(driver, CMS_Verify_Duplicate_Table);
