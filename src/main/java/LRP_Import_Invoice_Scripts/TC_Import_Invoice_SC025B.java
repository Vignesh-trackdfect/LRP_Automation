...
public class TC_Import_Invoice_SC025B extends Keywords {
	public void Import_Invoice_SC025B(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Import_Invoice_SC025B";
		...
		int freedays = convertStringToInteger(Additional_FreeDays);
		int temp=0;
		...
		String actualFreedays = String.valueOf(temp);
		List<Double> totalFreeDaysValues = addStringValueToList(free_Days_From_ImportDoc, actualFreedays);
		// Import Invoice
			...
			for (int i = 0; i < doubleList.size(); i++) {
				...
				if (Double.compare(ExpectedFreeDays, ActualFreeDays) == 0) {
					System.out.println("Matched || The Container Number is : " + givencontainers.get(i) + " || The "
							...
							+ " The Free days Added From The Detention Waiver value is : " + actualFreedays
