...
public class TC_Ecommerce_Gateway_Validator_028 extends Keywords{

	public void Ecommerce_Gateway_Validator_028(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Ecommerce_Gateway_Validator_028";
		...
		String Actual_Routing_Service;
		waitForDisplay(driver, Routing_Service_value_EV);
		if(!isdisplayed(driver, Routing_Service_value_EV)) {
			waitForElement(driver, Routing_Add_Btn_EComm_Validator);
			click(driver,Routing_Add_Btn_EComm_Validator);
			
			String Select_Routing=String.format(Select_Routing_Row_value_EV, Routing_Value,Routing_Service);
			...
			if(isDisplayed(driver, popup_Message)) {
				...
				if(Popup_Act.equals(No_Schedule_Poup) || Popup_Act.equals(Schedule_Not_Available_Popup)) {
					System.out.println("Expected : Given Routing input Shedule should be present || Actual : Given Routing input shedule is not present ,  Popup msg "+Popup_Act);
					Extent_FailNew(driver, "Expected : Given Routing input Shedule should be present || Actual : Given Routing input shedule is not present ,  Popup msg "+Popup_Act, test, test1);
				}else {
					System.out.println("Expected : Routing Should be Selected without any popup after selecting it || Actual : Popup displayed after Selecting the routing,  Popup : "+Popup_Act);
					Extent_fail(driver, "Expected : Routing Should be Selected without any popup after selecting it || Actual : Popup displayed after Selecting the routing,  Popup : "+Popup_Act, test, test1);
				}
			}
			
			waitForElement(driver, Routing_Service_value_EV);
			 Actual_Routing_Service=getText(driver, Routing_Service_value_EV);
			if(Actual_Routing_Service.equals(Routing_Service)) {
				System.out.println("Expected : Selected Routing Service ('"+Routing_Service+"') Should be update in the Routing Column || Actual : Selected Routng Serivice is updated in the Routing Column ('"+Actual_Routing_Service+"')");
				Extent_pass_New(driver, "Expected : Selected Routing Service ('"+Routing_Service+"') Should be update in the Routing Column || Actual : Selected Routng Serivice is updated in the Routing Column ('"+Actual_Routing_Service+"')", test, test1);
			}else {
				System.out.println("Expected : Selected Routing Service ('"+Routing_Service+"') Should be update in the Routing Column || Actual : Selected Routng Serivice is not updated in the Routing Column ('"+Actual_Routing_Service+"')");
				Extent_fail(driver, "Expected : Selected Routing Service ('"+Routing_Service+"') Should be update in the Routing Column || Actual : Selected Routng Serivice is not updated in the Routing Column ('"+Actual_Routing_Service+"')", test, test1);
			}
		...
		Step_Start(5, "system list the scedule details based on POL portpair ", test, test1);
		waitForDisplay(driver, First_Row_EComm_Validator);
		if(isdisplayed(driver, First_Row_EComm_Validator)) {
			System.out.println("Expected : System Should list the scedule details based on POL portpair || Actual : system list the scedule details based on POL portpair");
			Extent_pass_New(driver, "Expected : System Should list the scedule details based on POL portpair || Actual : system list the scedule details based on POL portpair", test, test1);
		}else {
			System.out.println("Expected : System Should list the scedule details based on POL portpair || Actual : system Not list the scedule details based on POL portpair");
			Extent_fail(driver, "Expected : System Should list the scedule details based on POL portpair || Actual : system Not list the scedule details based on POL portpair", test, test1);
		}
		Step_End(5, "system list the scedule details based on POL portpair ", test, test1);
