...
public class TC_Contract_Management_System_SC014 extends Keywords {

public void Contract_Management_System_SC14(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC014";
	...
	if (Draft.equals(InActive_field)) {
		...
		Extent_pass(driver,"Matched || Expected value is : After inactive on save button, The status should be : " + Draft + "|| Actual value is : After click on inactive button, The status is  : " + InActive_field, test,test1);
