...
public class TC_Endpoint_Configuration_TS10 extends Keywords {

	public void Endpoint_Configuration_TS10(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Endpoint_Configuration_TS10";
		...
		if (DeleteOption.equals("Delete")) {
			...
			waitForElement(driver, SP_GridRow1);
			click(driver, SP_GridRow1);
			RightClick(driver, SP_GridRow1);
