...
public class TC_PartBL_TC036 extends Keywords {

	public void PartBL_TC036(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws Exception {

		String test_Case_Name = "TC_PartBL_TC036";
...
//	Switch the Profile
		...
		Step_Start(7, "Enter the weight more then BL weight", test, test1);
		...
		Step_End(7, "Enter the weight more then BL weight", test, test1);
		...
		Step_Start(9, "\"Weight given should be less than the total weight\" message shown.", test, test1);
		...
		Step_End(9, "\"Weight given should be less than the total weight\" message shown.", test, test1);
