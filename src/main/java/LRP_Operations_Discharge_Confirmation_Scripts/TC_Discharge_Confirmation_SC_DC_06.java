...
public class TC_Discharge_Confirmation_SC_DC_06 extends Keywords {
	...
	public void Discharge_Confirmation_SC_DC_06(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
	...
	if(date_Picker.equalsIgnoreCase("Yes")) {
		...
		sendKeys(driver, Ddischarge_bookingnumber, Booking_id);	
		...
		waitForElement(driver, DDischarge_Checkbox);
		safeclick(driver, DDischarge_Checkbox);
