...
public class TC_Haulage_Contract_SC25 extends Keywords{
	public void Haulage_Contract_SC25(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC25";
		...
		Step_Start(5, "Click the POD in the Payat details.", test, test1);
		waitForElement(driver, Payable_At_Pod);
		click(driver, Payable_At_Pod);
		...
		String Act_Pickup_Location = getFirstRowValueByHeaderFromTableData(tabledata, "Port To Pay");
		
		System.out.println(Act_Pickup_Location);
		if(Drop_Location_Code.equals(Act_Pickup_Location)) {
			System.out.println("Expected Result is : "+Drop_Location_Code + " || Actual Result is : "+Act_Pickup_Location  );
			Extent_pass_New(driver, "Expected Result is : "+Drop_Location_Code + " || Actual Result is : "+Act_Pickup_Location  , test, test1);
		}else {
			System.out.println("Expected Result is : "+Drop_Location_Code + " || Actual Result is : "+Act_Pickup_Location  );
			Extent_fail(driver, "Expected Result is : "+Drop_Location_Code + " || Actual Result is : "+Act_Pickup_Location  , test, test1);
		}
		
		Step_End(5, "Click the POD in the Payat details.", test, test1);
