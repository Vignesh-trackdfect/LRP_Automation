...
public class TC_Import_Documentation_SC010 extends Keywords{

	public void Import_Documentation_SC010(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String testCaseName="TC_Import_Documentation_SC010";
...
//		Login
		...
		if(BL_Retrive_Option.equalsIgnoreCase("By_BL")) {
			...
			Step_Start(16, "cargo type has to be shown as 'Local'for all the bl's(navigate all the bl's )", test, test1);
			...
			String Expected_Cargo_Type_ID="Local";
			...
			Step_End(16, "cargo type has to be shown as 'Local'for all the bl's(navigate all the bl's )", test, test1);
