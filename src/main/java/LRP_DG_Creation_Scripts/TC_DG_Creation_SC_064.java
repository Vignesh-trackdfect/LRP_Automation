...
public class TC_DG_Creation_SC_064 extends Keywords{
	
	public void DG_Creation_SC_064(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data, String url) throws Exception {

		String testCaseName = "TC_DG_Creation_SC_064";
		...
		scrollElementToView(driver, SearchButton_Toolbar);
