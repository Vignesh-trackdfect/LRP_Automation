...
public class TC_Enquiry_History_TS025 extends Keywords{
	...
	public void EnquiryHistoryTS025(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {
