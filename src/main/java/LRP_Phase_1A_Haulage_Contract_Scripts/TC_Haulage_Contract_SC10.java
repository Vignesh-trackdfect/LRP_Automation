...
public class TC_Haulage_Contract_SC10 extends Keywords{
	public void Haulage_Contract_SC10(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC10";
		...
		waitForElement(driver, HC_drop_Type_Dropdown);
         ...
         String pickup_Type_Value_Actual = getText(driver, HC_Pickup_Search_Header);	
         
         if(pickup_Type_Value_Actual.contains(Pickup_Type_Value)) {
        	 System.out.println("Expected Value taken in test data for selecting pickup type :"+Pickup_Type_Value + " ||  Actual Value taken in  pickup Terminal: "+pickup_Type_Value_Actual);
        	 Extent_pass_New(driver, "Expected Value taken in test data for selecting pickup type:"+Pickup_Type_Value + " ||  Actual Value taken in  pickup Terminal  : "+pickup_Type_Value_Actual, test, test1);
         }else {
        	 System.out.println("Expected Value taken in test data for selecting pickup type:"+Pickup_Type_Value + "||   Actual Value taken in  pickup Terminal  : "+pickup_Type_Value_Actual);
             Extent_fail(driver, "Expected Value taken in test data for selecting pickup type :"+Pickup_Type_Value + " || Actual Value taken in  pickup Terminal: "+pickup_Type_Value_Actual, test, test1);
         }
