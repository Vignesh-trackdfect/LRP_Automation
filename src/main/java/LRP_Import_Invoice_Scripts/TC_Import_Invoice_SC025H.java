...
public class TC_Import_Invoice_SC025H extends Keywords {
	public void Import_Invoice_SC025H(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Import_Invoice_SC025H";
		...
		String Waiver_Count = Excel_data.get("Waiver_Count");
		...
		int count = convertStringToInteger(Waiver_Count);
		int freedays = convertStringToInteger(Additional_FreeDays_Exclusive);
		int temp1=0;
		for(int i=0;i<count;i++) {
			temp1=temp1+freedays;
			scrollTop(driver);
			newButton(driver);
			waitForElement(driver, DW_WaiverFor);
			click(driver, DW_WaiverFor);
		...
		String actualFreedays = String.valueOf(temp1);
		List<Double> Expected_Value = addStringValueToList(free_Days, actualFreedays);
		// Import Invoice
			...
			for (int i = 0; i < doubleList.size(); i++) {
				...
				if (Double.compare(ExpectedFreeDays, ActualFreeDays) == 0) {
					System.out.println("Matched || The Container Number is : " + givencontainers.get(i) + " || The "
							...
							+" || The Free days Added From The Exclusive Detention Waiver value is : " + ExpectedFreeDays
					...
					Extent_fail(driver,"Not Matched || The Container Number is : " + givencontainers.get(i) + " || The "
							+ Container_columns_Headers +" The Free days Added From The Inclusive Detention Waiver value is : " + Expected_Freedays.get(i)
							+" The Free days Added From The Inclusive Detention Waiver value is : " + ExpectedFreeDays
							+ " || The Actual Value from the Import Invoice Freedays Value is : " + ActualFreeDays
							+ " in " + Detention_Tab_Name_In_Iport_Invoice + " Tab.",
							test, test1);
				}
