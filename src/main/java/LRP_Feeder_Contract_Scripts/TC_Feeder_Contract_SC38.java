...
public class TC_Feeder_Contract_SC38 extends Keywords {

	public void Feeder_Contract_SC38(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC38";
		...
		String Act_Popup_Message = getText(driver, popup_Message);

		if (Act_Popup_Message.equals(Verify_popup)) {
			System.out.println("Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message);
			Extent_pass_New(driver, "Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message, test, test1);
		} else {

			System.out.println("Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message);
			Extent_fail(driver, "Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message, test, test1);
		}
		...
		waitForElement(driver, FC_Grid_Row);
		List<WebElement> HC_row = listOfElements(driver, FC_Grid_Row);
		int HC_row_Count = HC_row.size();
		System.out.println("Haulage contract row After :" + HC_row_Count);

		if (HC_row_Count == HC_row_Count_before) {
			System.out.println("Matched || Expected : No row should be added after selecting 'No'. Row count before : "
					+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count);
			Extent_pass_New(driver,
					"Matched || Expected : No row should be added after selecting 'No'. Row count before : "
							+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count,
					test, test1);
			...
			System.out.println("Matched || Expected : No row should be added after selecting 'No'. Row count before : "
					+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count);
			Extent_fail(driver, "Matched || Expected : No row should be added after selecting 'No'. Row count before : "
					+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count, test, test1);

		}

		waitForElement(driver, FC_Grid_Row);
		List<WebElement> HC_row_before1 = listOfElements(driver, FC_Grid_Row);
		int HC_row_Count_before1 = HC_row_before1.size();
		...
		waitForPopup(driver, popup_Message, Verify_popup);
		String Act_Popup_Message1 = getText(driver, popup_Message);

		if (Act_Popup_Message1.equals(Verify_popup)) {
			System.out.println("Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message1);
			Extent_pass_New(driver, "Matched || Expected popup message was : " + Verify_popup
					+ " || Actual popup message was : " + Act_Popup_Message1, test, test1);
		} else {
		...
		waitForElement(driver, FC_Grid_Row);
		List<WebElement> HC_row1 = listOfElements(driver, FC_Grid_Row);
		int HC_row_Count1 = HC_row1.size();
		System.out.println("Haulage contract row After :" + HC_row_Count);

		if (HC_row_Count1 == HC_row_Count_before1 + 1) {
			System.out.println("Matched || Expected :  row should be added after selecting 'Yes'. Row count before : "
					+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count);
			Extent_pass_New(driver,
					"Matched || Expected :  row should be added after selecting 'Yes'. Row count before : "
							+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count,
					test, test1);

		} else {
			System.out
					.println("Not Matched || Expected :  row should be added after selecting 'Yes'. Row count before : "
							+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count);
			Extent_fail(driver,
					"Not Matched || Expected :  row should be added after selecting 'Yes'. Row count before : "
							+ HC_row_Count_before + " || Actual :  Row count after : " + HC_row_Count,
					test, test1);
