...
public class TC_Rate_Request_SC25  extends Keywords {
	...
	public void rate_Request_Sc25(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String Special_TypeEXP = Excel_data.get("Special_TypeEXP");
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			waitForPopup(driver, Popup_Message, Special_TypeEXP);
			String PopUp_Msg1=getText(driver, Popup_Message);    
			System.out.println(PopUp_Msg1);
			if(Special_TypeEXP.equals(PopUp_Msg1)) {                                                                                                                  
				System.out.println("Matched || " + "Expected : popup message should be shown as : " + Special_TypeEXP + " || Actual : popup message is shown as : " + PopUp_Msg1);            
				Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + Special_TypeEXP + " || Actual : popup message is shown as :  " + PopUp_Msg1, test,test1);     
			}else {                                  

				System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + Special_TypeEXP + " || Actual : popup message is shown as : " + PopUp_Msg1);        
				Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + Special_TypeEXP + " || Actual : popup message is shown as : " + PopUp_Msg1, test,test1); 
