...
public class TC_Recurring_Journal_RJ07  extends Keywords{
	public void  Recurring_Journal_RJ07(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		String testcase_Name="TC_Recurring_Journal_RJ07";
		...
		Step_Start(7, "Posted Journal showed in Journal screen", test, test1);
		...
		String afterHyphen = recurring_journal_user_date.substring(hyphenIndex + 3);  // +3 to skip the " - " part
		// Print the results
		System.out.println("Before hyphen: " + beforeHyphen);  // Output: "SUPERUSER"
		System.out.println("After hyphen: " + afterHyphen);    // Output: "Tue Dec 10 12:49:26 IST 2024"
		...
		if (Status.equals(recurring_journal_statuss)) {
			System.out.println("Matched || " + " Expected  status is : " + Status+ " || Actual status is : " + recurring_journal_statuss);
			Extent_pass_New(driver, "Matched || " + " Expected  status is : " + Status+ " || Actual  status is : " + recurring_journal_statuss, test, test1);
		} else {
			System.out.println("Not matched || " + " Expected  status is : " + Status+ " || Actual  status is : " + recurring_journal_statuss);
			Extent_fail(driver, "Not matched || " + " Expected  status is : " + Status+ " || Actual  status is : " + recurring_journal_statuss, test, test1);
		}
		Step_End(7, "Posted Journal showed in Journal screen", test, test1);
