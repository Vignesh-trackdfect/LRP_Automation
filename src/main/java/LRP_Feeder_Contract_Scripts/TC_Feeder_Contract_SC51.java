...
public class TC_Feeder_Contract_SC51 extends Keywords {

	public void Feeder_Contract_SC51(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC51";
		...
		String DG_removed = Excel_data.get("DG_removed");
		...
		Step_Start(23, "Click the '-' in DG ,It should deleted. ", test, test1);
		...
		for (String DGtypes : removeDGs) {
			...
			waitForElement(driver, FC_DG_remove_Button);
			click(driver, FC_DG_remove_Button);

			waitForPopup(driver, popup_Message, DG_removed);

			String removed_popup = getText(driver, popup_Message);
			System.out.println("Removed popup :" + removed_popup);

			if (DG_removed.equals(removed_popup)) {
				Extent_pass(driver,
						"Matched || Expected popup is : " + DG_removed + " ||  Actual popup   is : " + removed_popup,
						test, test1);
				System.out.println(
						"Matched || Expected popup is : " + DG_removed + " || Actual popup  is : " + removed_popup);
			} else {
				System.out.println("Not Matched || Expected popup  + is : " + DG_removed + " || Actual popup  is : "
						+ removed_popup);
				Extent_fail(driver,
						"Not Matched || Expected popup is : " + DG_removed + " || Actual popup  is : " + removed_popup,
						test, test1);
		...
		Step_End(23, "Click the '-' in DG ,It should deleted. ", test, test1);
