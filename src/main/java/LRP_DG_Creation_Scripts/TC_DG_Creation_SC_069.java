...
public class TC_DG_Creation_SC_069 extends Keywords {


	public void DG_Creation_SC_069(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_069";
...
//		Module Search
		...
		if(!Cancel_Reason.equals("")) {
		
			waitForElement(driver, cancel_Reason_Dropdown);
			safeclick(driver, cancel_Reason_Dropdown);
			
		formatLocatorClick(driver, DropDown_Select, Cancel_Reason);
		}
		...
		String Act_Popup = getText(driver, popup_Message);
		System.out.println(Act_Popup);
		if(Act_Popup.contains(cancelled_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + cancelled_Popup + " || Actual Popup is : " + Act_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + cancelled_Popup + " || Actual Popup is : " + Act_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + cancelled_Popup + " || Actual Popup is : " + Act_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + cancelled_Popup + " || Actual Popup is : " + Act_Popup, test,test1); 
		}
