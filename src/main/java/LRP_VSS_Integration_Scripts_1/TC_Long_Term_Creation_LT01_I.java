...
public class TC_Long_Term_Creation_LT01_I extends Keywords {

	public void createlongterm_IP(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		String testcase_Name = "TC_Long_Term_Creation_LT01_I";
		...
		String Proforma_code = Excel_data.get("Proforma_code");
		...
		if (Vessels_verify_perform.equals("YES")) {
			...
			System.out.println("Expected Result is : Equipment type Should be added || Actual Result is : Equipment type is not  added");
			Extent_fail(driver, "Expected Result is : Equipment type Should be added || Actual Result is : Equipment type is not  added", test, test1);
		}
		...
		if (Add_Vessels_Perform.equals("YES")) {
			...
			System.out.println("Expected Result is : Vesssels Should be added || Actual Result is : Vessels is not  added");
		}
		...
		if (Add_TBN_Vessels_Perform.equals("YES")) {
			...
			System.out.println("Expected Result is : No.of.TBM  Should be selected || Actual Result is :  No.of.TBM is not selected");
		...
		if (Add_Empty_Vessels_Perform.equals("YES")) {
			...
			System.out.println("Expected Result is : No.of.Blank vessel  Should be selected || Actual Result is :  No.of.Blank vessel  is not selected");
