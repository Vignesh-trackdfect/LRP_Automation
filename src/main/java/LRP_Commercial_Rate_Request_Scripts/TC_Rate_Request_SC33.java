...
public class TC_Rate_Request_SC33  extends Keywords{
	...
	public void rate_Request_Sc33(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String Alreaypopexp =Excel_data.get("Alreaypopexp");
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			waitForPopup(driver, Popup_Message, Alreaypopexp);	
			String PopUp_Msg7=getText(driver, Popup_Message);    
			System.out.println(PopUp_Msg7);
			if(Alreaypopexp.equals(PopUp_Msg7)) {                                                                                                                  
				System.out.println("Matched || " + "Expected : popup message should be shown as : " + Alreaypopexp + " || Actual : popup message is shown as : " + PopUp_Msg7);            
				Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + Alreaypopexp + " || Actual : popup message is shown as : " + PopUp_Msg7, test,test1);     
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + Alreaypopexp + " || Actual : popup message is shown as : " + PopUp_Msg7);        
				Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + Alreaypopexp + " || Actual : popup message is shown as : " + PopUp_Msg7, test,test1); 
