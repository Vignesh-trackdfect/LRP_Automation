...
public class TC_Rate_Request_SC08 extends Keywords {
	...
	public void Rate_Request_SC08(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
...
newButton(driver);
		...
		if(Request_Input.equals(actualRequestType)) {                                                                                                                  
			...
			Extent_pass_New(driver, "Matched || " + " Expected Rate Request Type  is : " + Request_Input + " || Actual Rate Request Type  is : " + actualRequestType, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
		...
		String actualNOR_CheckBoxStatus=getAttribute(driver, nor_checkbox, "class");
		if(actualNOR_CheckBoxStatus.contains("active")) {
			System.out.println("Matched || Expected Result is : After Rate Request Submitted the NOR Checkbox Sholud be selected status || Actual Result is : After Rate Request Submitted the NOR Checkbox is selected status");
			Extent_pass_New(driver, "Matched || Expected Result is : After Rate Request Submitted the NOR Checkbox Sholud be selected status || Actual Result is : After Rate Request Submitted the NOR Checkbox is selected status", test, test1);
		}else {
			System.out.println("Not Matched || Expected Result is : After Rate Request Submitted the NOR Checkbox Sholud be selected status || Actual Result is : After Rate Request Submitted the NOR Checkbox is selected status");
			Extent_fail(driver, "Not Matched || Expected Result is : After Rate Request Submitted the NOR Checkbox Sholud be selected status || Actual Result is : After Rate Request Submitted the NOR Checkbox is selected status", test, test1);
		}
