...
public class TC_DG_Creation_SC_051 extends Keywords {


	public void DG_Creation_SC_051(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_051";
...
//		Module Search
		...
		if(actual_VIN_Chassis_Num.equals(containerNumber_After)) {
			System.out.println("Matched || " + " VIN Chassis Number in Booking : " + containerNumber_After + " ||  VIN Chassis Number in DG Creation : " + actual_VIN_Chassis_Num);            
			Extent_pass_New(driver, "Matched || " + " VIN Chassis Number in Booking : " + containerNumber_After + " ||  VIN Chassis Number in DG Creation : " + actual_VIN_Chassis_Num, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " VIN Chassis Number in Booking : " + containerNumber_After + " ||  VIN Chassis Number in DG Creation : " + actual_VIN_Chassis_Num);        
			Extent_fail(driver, "Not Matched || " + " VIN Chassis Number in Booking : " + containerNumber_After + " ||  VIN Chassis Number in DG Creation : " + actual_VIN_Chassis_Num, test,test1); 
		}
