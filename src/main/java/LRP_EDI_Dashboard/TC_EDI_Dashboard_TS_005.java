...
public class TC_EDI_Dashboard_TS_005 extends Keywords {
	public void EDI_Dashboard_TS_005(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Dashboard_TS_005";
		...
		Step_Start(2, "Enter the EDI details (EDI774)", test, test1);
		...
		Step_End(2, "Enter the EDI details (EDI774)", test, test1);
		...
		if (IsElementEnabled(driver, EDI_DB_Mess_Function_Dropdwn)) {
			...
			System.out.println(
					" Matched: Expected || Providing the EDI details, 'Message Function' dropdown is enabled and it should be showing : "
							+ Mess_Function_Drop_Down
							+ " || Actual: Providing the EDI details, 'Message Function' dropdown is enabled and it is showing : "
							+ Mess_Function_Drop_Down);
		...
		if (IsElementEnabled(driver, EDI_DB_Operation_Type_DropDown)) {
			...
			System.out.println(
					"Not Matched: Expected || Providing the EDI details, 'Operation Type' dropdown is disabled and it should be showing 'No record found' || Actual: Providing the EDI details, 'Operation Type' dropdown is disabled and it is showing 'No record found'.");
			Extent_fail(driver,
					"Not Matched: Expected || Providing the EDI details, 'Operation Type' dropdown is disabled and it should be showing 'No record found' || Actual: Providing the EDI details, 'Operation Type' dropdown is disabled and it is showing 'No record found'.",
					test, test1);
		}
		...
		Step_Start(4, "Select Service code field (0610)", test, test1);
		Step_Start(5, "Select any data from the favorite search", test, test1);
		...
		Step_End(5, "Select any data from the favorite search", test, test1);

		Step_End(4, "Select Service code field (0610)", test, test1);
		...
		Step_Start(7, "And select all the datas ", test, test1);
		...
		Step_End(7, "And select all the datas ", test, test1);
		Step_Start(8, "Click the Generate EDI button", test, test1);
		...
		Step_End(8, "Click the Generate EDI button", test, test1);
