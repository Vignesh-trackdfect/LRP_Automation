...
public class TC_Vendor_Invoice_Registration_SC26 extends Keywords{
	
	public void Vendor_Invoice_Registration_SC26(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Vendor_Invoice_Registration_SC26";
		//  Get data from excel sheet	
			...
			String Equipment_Type_Header_STP = Excel_data.get("Equipment_Type_Header_STP");
			String Port_Code_Value_STP = Excel_data.get("Port_Code_Value_STP");
			String Port_Code_Header_STP = Excel_data.get("Port_Code_Header_STP");
...
//			Vendor Invoice Registration
		...
		// Vendor invoice number
			...
			waitForElement(driver, stp_Manual_Activity_Button_VIR);
			click(driver, stp_Manual_Activity_Button_VIR);
			Step_End(12, "Click the Manual activity", test, test1);
			
			Step_Start(13, "Click the Sub activity \"+\" and select the require activity", test, test1);
			waitForElement(driver, stp_Sub_Activity_Plus_Button_VIR);
			click(driver, stp_Sub_Activity_Plus_Button_VIR);
			
			twoColumnSearchWindow(driver, Sub_Activity_Code_Header, condition, Sub_Activity_Code_Value);
			
			Step_End(13, "Click the Sub activity \"+\" and select the require activity", test, test1);
		
			Step_Start(14, "Click eqp type search and select the Equipment type", test, test1);
			waitForElement(driver, stp_Equip_typ_search_Button_VIR);
			click(driver, stp_Equip_typ_search_Button_VIR);
			
			twoColumnSearchWindow(driver, Equipment_Type_Header_STP, condition, Equipment_Type_Value);
			Step_End(14, "Click eqp type search and select the Equipment type", test, test1);
			
			Step_Start(15, "Click the Port search and select the required Port", test, test1);
			waitForElement(driver, stp_port_Search_Button_VIR);
			click(driver, stp_port_Search_Button_VIR);
			
			twoColumnSearchWindow(driver, Port_Code_Header_STP, condition, Port_Code_Value_STP);
	
			Step_End(15, "Click the Port search and select the required Port", test, test1);
	       
			Step_Start(16, "Click the \"+ADD\" button, Details added in the Grid", test, test1);
			waitForElement(driver, stp_Manual_Activity_Add_Button_VIR);
	        click(driver, stp_Manual_Activity_Add_Button_VIR);
			...
			Step_Start(17, "Here the invoice quantity and invoice amount based on Main activity code and Sub activity code", test, test1);
			...
			enter(driver);
			Step_End(17, "Here the invoice quantity and invoice amount based on Main activity code and Sub activity code", test, test1);
            
            scrollTop(driver);

			Step_Start(18, "Click the save", test, test1);
			mouseOverToElement(driver, SaveButton_ToolBar);
			waitForElement(driver, SaveButton_ToolBar);
			jsClick(driver, SaveButton_ToolBar);
			Step_End(18, "Click the save", test, test1);
			...
			Step_Start(20, "It auto generate the Invoice Reg No", test, test1);
