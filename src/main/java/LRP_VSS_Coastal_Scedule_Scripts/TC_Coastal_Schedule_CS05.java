...
public class TC_Coastal_Schedule_CS05 extends Keywords {

	public void Coastal_Schedule_CS05(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String testCaseName="TC_Coastal_Schedule_CS05";
...
//		}
		...
		if (Portcode_Color.equals(blackcolorcode_CS05)) {
			...
			System.out.println("Not Matched || Expected Color : "+blackcolorcode_CS05+" || Actual Color : "+Portcode_Color+" || The Selected Port Was Not Roll Backed");
			Extent_fail(driver,  "Not Matched || Expected Color : "+blackcolorcode_CS05+" || Actual Color : "+Portcode_Color+" || The Selected Port Was Not Roll Backed", test,test1);
		}
