...
public class TC_Movement_Entry_Integration_TS045 extends Keywords {
	...
	public void Movement_Entry_Integration_TS045(WebDriver driver, ExtentTest test, ExtentTest test1,
		...
		String eqpNumLODF = Excel_data.get("EqpNumLODF");
		String lodfActivity = Excel_data.get("LodfActivity");
		String activityPlacePOLSameError = Excel_data.get("ActivityPlacePOLSameError");
		String activityDateSingle45 = Excel_data.get("activityDateSingle45");
