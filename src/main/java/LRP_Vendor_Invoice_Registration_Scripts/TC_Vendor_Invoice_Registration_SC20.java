...
public class TC_Vendor_Invoice_Registration_SC20 extends Keywords{
	
	public void Vendor_Invoice_Registration_SC20(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Vendor_Invoice_Registration_SC20";
		//  Get data from excel sheet	
			...
			String Bound_Header = Excel_data.get("Bound_Header");
...
//			Vendor Master
			...
			waitForDisplay(driver, new_Button_VM);
			if(IsElementEnabled(driver, new_Button_VM)) {
...
//			Vendor Invoice Registration
		...
		// Vendor invoice number		
			...
			Step_Start(18, "Click the Port code search and select the Required POL Port code.", test, test1);
			...
			Step_End(18, "Click the Port code search and select the Required POL Port code.", test, test1);
			...
			Step_Start(20, "Right click the Data and Click the Vessel info", test, test1);
			...
			waitForElement(driver, manualActivity_Table_Gridcell_VIR);
			RightClick(driver, manualActivity_Table_Gridcell_VIR);
			
			waitForElement(driver, vesselInfo_ManualActivity_VIR);
			click(driver, vesselInfo_ManualActivity_VIR);
			
			
			Step_End(20, "Right click the Data and Click the Vessel info", test, test1);
			Step_Start(21, "Click Service and select the require service ,Click Vessel serach and Select the Require Vessel", test, test1);

			
			waitForElement(driver, service_SearchButton_ScheduleInfo_VIR);
			click(driver, service_SearchButton_ScheduleInfo_VIR);
			
			twoColumnSearchWindow(driver, Service_Header, condition, Service_Code_Input);

			waitForElement(driver, vessel_SearchButton_ScheduleInfo_VIR);
			click(driver, vessel_SearchButton_ScheduleInfo_VIR);
			
			twoColumnSearchWindow(driver, Vessel_Header, condition, Vessel_Code_Input);

			Step_End(21, "Click Service and select the require service ,Click Vessel serach and Select the Require Vessel", test, test1);
			Step_Start(22, "Click the Voyage search and Select the require voyage", test, test1);

			waitForElement(driver, voyage_SearchButton_ScheduleInfo_VIR);
			click(driver, voyage_SearchButton_ScheduleInfo_VIR);
			
			twoColumnSearchWindow(driver, Voyage_Header, condition, Voyage_Code_Input);

			waitForElement(driver, bound_SearchButton_ScheduleInfo_VIR);
			click(driver, bound_SearchButton_ScheduleInfo_VIR);
			
			twoColumnSearchWindow(driver, Bound_Header, condition, Bound_Input);

			waitForElement(driver, scheduleInfo_OK_Button_VIR);
			click(driver, scheduleInfo_OK_Button_VIR);
			
			Step_End(22, "Click the Voyage search and Select the require voyage", test, test1);

			Step_Start(23, "Click the save.", test, test1);

			scrollTop(driver);
			waitForElement(driver, SaveButton_ToolBar);
			jsClick(driver, SaveButton_ToolBar);
			
			Step_End(23, "Click the save.", test, test1);
			Step_Start(24, "It auto generate the Invoice Reg No. ", test, test1);
			...
			Step_End(24, "It auto generate the Invoice Reg No. ", test, test1);
