...
public class TC_Detention_Waiver_TS_002B extends Keywords {

	public void Detention_Waiver_TS_002B(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testcase_Name = "TC_Detention_Waiver_TS_002B";
		...
		for (int i = 0; i < Numbers.size(); i++) {
			...
			Step_Start(3, "Verify that BL is in Confirm (or) Issued", test,
					test1);
			...
			Step_End(3, " Verify that BL is in Confirm (or) Issued***", test,
					test1);
			
			if(Colour_Name.equalsIgnoreCase("Green")) {
				...
				if(Colour_Name.contains(bill_number_colour11)) {                                                                                                                  
					System.out.println("Matched || " + " Expected Report Activity  colour for confirmed is : " + Colour_Name + " || Actual Report Activity  colour for confirmed is : " + bill_number_colour11);            
					Extent_pass_New(driver, "Matched || " + " Expected Report Activity  colour for confirmed is : " + Colour_Name + " || Actual Report Activity  colour for confirmed is : " + bill_number_colour11, test,test1);     
				}                                                                                                                                                                        
				else {                                                                                                                                                                   
					System.out.println("Not Matched || " + " Expected Report Activity  colour for confirmed is : " + Colour_Name + " || Actual Report Activity  colour for confirmed is : " + bill_number_colour11);        
					Extent_fail(driver, "Not Matched || " + " Expected Report Activity  colour for confirmed is : " + Colour_Name + " || Actual Report Activity  colour for confirmed is : " + bill_number_colour11, test,test1); 
					
				}}
				if(Colour_Name.equalsIgnoreCase("Blue")) {
			...
			if (StatuValue.equalsIgnoreCase("Confirmed") || StatuValue.equalsIgnoreCase("Issued")) {

				Step_Start(7, "Input your Confirm And Issued BL No and verify the same BL not to listed", test, test1);

				waitForElement(driver, DW_Global_BL_Number);
				String actualNumber = getText(driver, DW_Global_BL_Number);

				if (number.equals(actualNumber)) {
					System.out.println("Matched || Expected BL Number Value : " + number
							+ " || Actual BL Number Shown in Detention Waiver Module : " + actualNumber
							+ " The BL Status is : " + StatuValue);
					Extent_pass_New(driver,
							"Matched || Expected BL Number Value : " + number
									+ " || Actual BL Number Shown in Detention Waiver Module : " + actualNumber
									+ " The BL Status is : " + StatuValue,
							test, test1);
				} else {
					System.out.println("Not Matched || Expected BL Number Value : " + number
							+ " || Actual BL Number Shown in Detention Waiver Module : " + actualNumber
							+ " The BL Status is : " + StatuValue);
					Extent_fail(driver,
							"Not Matched || Expected BL Number Value : " + number
									+ " || Actual BL Number Shown in Detention Waiver Module : " + actualNumber
									+ " The BL Status is : " + StatuValue,
							test, test1);
				}
				...
				click(driver, SelectButton);
				elementnotvisible1(driver, SelectButton);
				Step_End(7, "Input your Confirm And Issued BL No and verify the same BL not to listed", test, test1);
			}
