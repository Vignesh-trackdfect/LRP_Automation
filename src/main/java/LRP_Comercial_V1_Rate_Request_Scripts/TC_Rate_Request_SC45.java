...
public class TC_Rate_Request_SC45 extends Keywords {
	...
	public void Rate_Request_SC45(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		String min_Base_Rate_Input = Excel_data.get("min_Base_Rate_Input");
		String min_Base_Rate_Quantity_Input = Excel_data.get("min_Base_Rate_Quantity_Input");
		String SRR_Status = Excel_data.get("SRR_Status").trim();
		String SRR_Grid_Status = Excel_data.get("SRR_Grid_Status").trim();
		String rate_Calc_Type = Excel_data.get("rate_Calc_Type").trim();
		String tService = Excel_data.get("T_Service");
		String TOS=Excel_data.get("TOS_Option");
		String dim_Gross_Weight_Input = Excel_data.get("dim_Gross_Weight_Input");
		String dimension_Length_Input = Excel_data.get("dimension_Length_Input");
		String dimension_Width_Input = Excel_data.get("dimension_Width_Input");
		String dimension_Height_Input = Excel_data.get("dimension_Height_Input");
		String dimension_Quantity_Input = Excel_data.get("dimension_Quantity_Input");
