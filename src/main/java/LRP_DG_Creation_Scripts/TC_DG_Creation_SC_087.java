...
public class TC_DG_Creation_SC_087 extends Keywords {


	public void DG_Creation_SC_087(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_087";
		...
		String Inner_Packing_Size_Popup = Excel_data.get("Inner_Packing_Size_Popup");
...
//		Module Search
		...
		Step_Start(3, "enter the manadatory details  and set Limited Qty Yes.", test, test1);
		...
		Step_End(3, "enter the manadatory details  and set Limited Qty Yes.", test, test1);
		...
		Step_Start(5, "System   validated inner packing size and qty.", test, test1);

		waitForPopup(driver, popup_Message,Inner_Packing_Size_Popup);
		String Actual_Inner_Packing_Size_Popup = getText(driver, popup_Message);
		System.out.println(Actual_Inner_Packing_Size_Popup);
		if(Actual_Inner_Packing_Size_Popup.equals(Inner_Packing_Size_Popup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Popup is : " + Inner_Packing_Size_Popup + " || Actual Popup is : " + Actual_Inner_Packing_Size_Popup);            
			Extent_pass_New(driver, "Matched || " + " Expected Popup is: " + Inner_Packing_Size_Popup + " || Actual Popup is : " + Actual_Inner_Packing_Size_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Popup is : " + Inner_Packing_Size_Popup + " || Actual Popup is : " + Actual_Inner_Packing_Size_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + Inner_Packing_Size_Popup + " || Actual Popup is : " + Actual_Inner_Packing_Size_Popup, test,test1); 
		} 
		
		Step_End(5, "System   validated inner packing size and qty.", test, test1);
