...
public class TC_Contract_Management_System_SC109 extends Keywords{

	public void Contract_Management_System_SC109(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
	
		String testCaseName = "TC_Contract_Management_System_SC109";
		...
		String Gross_Weight_Validation = Excel_data.get("Gross_Weight_Validation");
		...
		Step_Start(6, "Trying to add without the Gross weight.", test, test1);
		...
		waitForPopup(driver, popup_Message, Gross_Weight_Validation);
		String Act_Popup=getText(driver, popup_Message);
		if(Gross_Weight_Validation.equals(Act_Popup)) {
			System.out.println("Popup Matched ||  Expected : "+Gross_Weight_Validation+" || Actual :  "+Act_Popup);
			Extent_pass_New(driver, "Popup Matched ||  Expected : "+Gross_Weight_Validation+" || Actual :  "+Act_Popup, test, test1);
		}else {
			System.out.println("Popup Not Matched ||  Expected : "+Gross_Weight_Validation+" || Actual :  "+Act_Popup);
			Extent_fail(driver, "Popup Not Matched ||  Expected : "+Gross_Weight_Validation+" || Actual :  "+Act_Popup, test, test1);
		}		
		...
		Step_End(6, "Trying to add without the Gross weight.", test, test1);
