...
public class TC_Discharge_Reconciliation_MD64 extends Keywords {
	
	public void Discharge_Reconciliation_MD64(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Discharge_Reconciliation_MD64";
...
moduleNavigate(driver, Dis_Recon_Module);
		...
		if (DPD_Code_input_Value.equals(Code_DPD_Actual)) {
			System.out.println(
					"Matched || Expected DPD Value given in the Discharge Reconciliation module  : " + DPD_Code_input_Value + " || Actual DPD Value present in the import documentation: " + Code_DPD_Actual);
			Extent_pass(driver,
					"Matched || Expected DPD Value given in the Discharge Reconciliation module : " + DPD_Code_input_Value + " || Actual DPD Value present in the import documentation : " + Code_DPD_Actual, test,
					test1);
		} else {
			System.out.println(
					"Not Matched || Expected DPD Value given in the Discharge Reconciliation module : " + DPD_Code_input_Value + " || Actual DPD Value present in the import documentation : " + Code_DPD_Actual);
			Extent_fail(driver,
					"Not Matched || Expected DPD Value given in the Discharge Reconciliation module : " + DPD_Code_input_Value + " || Actual DPD Value present in the import documentation  : " + Code_DPD_Actual,
					test, test1);
		}
