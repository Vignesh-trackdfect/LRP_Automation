...
public class TC_Contract_Management_System_SC222 extends Keywords{

	public void Contract_Management_System_SC222(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC222";
		...
		Step_Start(6, "Import the port pair lanes with DG NO and OOG NO and with the DG and OOG details.", test, test1);
