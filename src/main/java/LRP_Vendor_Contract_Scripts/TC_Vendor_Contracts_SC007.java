...
public class TC_Vendor_Contracts_SC007 extends Keywords{

	public void Vendor_Contracts_SC007(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Vendor_Contracts_SC007";
		...
		Step_Start(7, "Select the main activity which is present and Click the 'Enter edit input fields' option", test, test1);
		...
		Step_End(7, "Select the main activity which is present and Click the 'Enter edit input fields' option", test, test1);
		
		Step_Start(8, "Select the charge type as 'Lumpsum'.   ", test, test1);
		...
		Step_End(8, "Select the charge type as 'Lumpsum'.   ", test, test1);

		Step_Start(9, "Select the required equipment type and equipment status. ", test, test1);
		...
		elementnotvisible1(driver, Popup_Message);
		Step_End(9, "Select the required equipment type and equipment status. ", test, test1);

		Step_Start(10, "Select the required currency. ", test, test1);
		...
		elementnotvisible1(driver, Popup_Message);
		Step_End(10, "Select the required currency. ", test, test1);

		Step_Start(11, " Select the Send to Disbursement and click 'Yes'.       ", test, test1);
		...
		elementnotvisible1(driver, Popup_Message);
		Step_End(11, " Select the Send to Disbursement and click 'Yes'.       ", test, test1);

		Step_Start(12, "Select the main activity in the grid and right click and select 'add item' option.    ", test, test1);
		...
		Step_End(12, "Select the main activity in the grid and right click and select 'add item' option.    ", test, test1);

		Step_Start(13, "Click on the required activities and click 'select' option.", test, test1);
		...
		Step_End(13, "Click on the required activities and click 'select' option.", test, test1);

		Step_Start(14, "Double click on the amount column an give the required amount for the activities.", test, test1);
		...
		Step_End(14, "Double click on the amount column an give the required amount for the activities.", test, test1);

		Step_Start(15, "Select the required activity and change the charge type as 'Sub to Formula' for the activity.", test, test1);

		waitForElement(driver, vc_rows);
		click(driver,vc_rows);
		...
		elementnotvisible1(driver, Popup_Message);
		Step_End(15, "Select the required activity and change the charge type as 'Sub to Formula' for the activity.", test, test1);

		Step_Start(16, "Select that activity and click on Formula builder option. ", test, test1);
		formatLocatorClick(driver, Activity_Amount_Column_VC, Sub_To_Formula_Activity);
		...
		Step_End(16, "Select that activity and click on Formula builder option. ", test, test1);
		...
		if(Formula_Build_Option.equals("By_Sendkeys")) {
			...
			Step_Start(17, "Click on Variable search and select the required variable code.", test, test1);
			...
			Step_End(17, "Click on Variable search and select the required variable code.", test, test1);

			Step_Start(18, "Click Assign option and give the formula as per the requirement.", test, test1);
			...
			Step_End(18, "Click Assign option and give the formula as per the requirement.", test, test1);
			

			Step_Start(19, "Click on slab builder and double click on the variable to give from,to and constant", test, test1);
			Step_Start(20, "Click on add option to give multiple slabs", test, test1);
			...
			Step_End(20, "Click on add option to give multiple slabs", test, test1);
			Step_End(19, "Click on slab builder and double click on the variable to give from,to and constant", test, test1);

			Step_Start(21, "Select Cumulative and Report by agency if required and click ok option.  ", test, test1);
			...
			Step_End(21, "Select Cumulative and Report by agency if required and click ok option.  ", test, test1);

		}
		Step_Start(22, "Click ok Option.  ", test, test1);

		waitForElement(driver, Formula_Ok_Btn_VC);
		click(driver,Formula_Ok_Btn_VC);
		Step_End(22, "Click ok Option.  ", test, test1);

		Step_Start(23, "Click on save option in toolbar and check whether the system shows a confirmation message as 'Vendor contracts saved' and click ok and generates the contract number", test, test1);
		...
		Step_End(23, "Click on save option in toolbar and check whether the system shows a confirmation message as 'Vendor contracts saved' and click ok and generates the contract number", test, test1);
