...
public class TC_Transportation_Dispatch_Notice_SC_TDN_07 extends Keywords {
	...
	public void Transportation_Dispatch_Notice_SC_TDN_07(WebDriver driver,ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
...
//		Get data from test data
		...
		String Transportation_Popup =Excel_data.get("TDN_Popup");
...
//	Plugin Configuration
	...
	scrollTop(driver);
		...
		waitForPopup(driver, messagePopup_TDN, Transportation_Popup);   
		...
		if(Transportation_Popup.equals(Transportation_dispatch_savedpopup1)) {                                                                                                                  
			...
			Extent_pass_New(driver, "Matched || " + " Expected Popup : " + Transportation_Popup + " || Actual Popup : " + Transportation_dispatch_savedpopup1, test, test1);
