...
public class TC_CRO_SC030 extends Keywords {

	public void CRO_SC030(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) throws Exception {

		String testCaseName="TC_CRO_SC030";
...
//  CRO 
		...
		Step_Start(10, "Check the Release terminal and acceptance terminal details dispaly from CRO", test, test1);

		
		Step_End(10, "Check the Release terminal and acceptance terminal details dispaly from CRO", test, test1);
