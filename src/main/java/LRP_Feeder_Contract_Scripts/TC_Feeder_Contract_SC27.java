...
public class TC_Feeder_Contract_SC27 extends Keywords {

	public void Feeder_Contract_SC27(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC27";
		...
		Step_Start(5, "Select the Duratyion type ,while click the Drop down", test, test1);
		...
		String selected_option = getText(driver, FC_DurationType);

		if (DurationType.equals(selected_option)) {

			System.out.println("Expected result : The given Duration Type " + DurationType
					+ " should be selected || Actual result :  The given Duration Type " + selected_option
					+ " was selected");
			Extent_pass_New(driver,
					"Expected result : The given Duration Type " + DurationType
							+ " should be selected || Actual result :  The given Duration Type " + selected_option
							+ " was selected",
					test, test1);
		...
		Step_End(5, "Select the Duratyion type ,while click the Drop down", test, test1);
