...
public class TC_Billing_Invoice_B01 extends Keywords {

	public void  Billing_Invoice_B01(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Billing_Invoice_B01";
	...
	newButton(driver);
		...
		isdisplayed(driver, vendor_search_ok);
		...
		isdisplayed(driver, billing_Dr_cr_droupdwn);
		click(driver,billing_Dr_cr_droupdwn);
	   ...
	   if(isdisplayed(driver, first_Voyage_Bound_CheckBox_Jnl)) {
		...
		if (trans_num_colour_exp.equals(trans_num_colour)) {
			System.out.println("Matched || " + " Expected colour is : " + trans_num_colour_exp+ " || Actual colour is : " + trans_num_colour);
			Extent_pass_New(driver, "Matched || " + " Expected colour is : " + trans_num_colour_exp+ " || Actual colour is : " + trans_num_colour, test, test1);
			Extent_call(test, test1, Actualpopmsg);
		} else {
			System.out.println("Not matched || " + " Expected colour is : " + trans_num_colour_exp+ " || Actual colour is : " + trans_num_colour);
			Extent_fail(driver, "Not matched || " + " Expected colour is : " + trans_num_colour_exp+ " || Actual colour is : " + trans_num_colour, test, test1);
