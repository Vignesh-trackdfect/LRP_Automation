...
public class TC_Arrival_Notice_TS_044 extends Keywords {
	
	public void Arrival_Notice_TS_044(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws EncryptedDocumentException, InvalidFormatException, IOException{
		
		String testcase_Name="TC_Arrival_Notice_TS_044";
	...
	List<String> datas = splitAndExpand(BL_Number_box);
		...
		if(isElementAccessible(driver, auction_Notice_Button_AN)) {
			
			Extent_pass(driver, "Matched || Expected Result is : Auction_Notice button Should be Enable  and displayed|| Actual Result is : Auction_Notice button  Enable  and displayed", test, test1);
			...
			Extent_fail(driver,"Not Matched || Expected Result is : Auction_Notice button Should be Enable  and displayed || Actual Result is : Auction_Notice button not Enable  and displayed", test, test1);
		}}
