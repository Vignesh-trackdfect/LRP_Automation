...
public class TC_Vendor_Invoice_Registration_SC51 extends Keywords {
	public void Vendor_Invoice_Registration_SC51(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {


		String testCaseName = "TC_Vendor_Invoice_Registration_SC51";
		...
		if(Exp_popup.equals(Act_popup)) {
			...
			System.out.println("Matched || Expected popup was : " + Credit_Exp_popup+ " || Actual popup message was : " + Act_popup);
			Extent_pass_New(driver, "Matched || Expected popup was : " + Credit_Exp_popup+ " || Actual popup message was : " + Act_popup, test, test1);

		}else if(Debit_Exp_popup.equals(Act_popup)) {
			System.out.println("Matched || Expected popup was : " + Debit_Exp_popup+ " || Actual popup message was : " + Act_popup);
			Extent_pass_New(driver, "Matched || Expected popup was : " + Debit_Exp_popup+ " || Actual popup message was : " + Act_popup, test, test1);
			...
			Extent_pass_New(driver, "Matched || Expected popup was : " + Disbursement_Exp_pop+ " || Actual popup message was : " + Act_popup, test, test1);
