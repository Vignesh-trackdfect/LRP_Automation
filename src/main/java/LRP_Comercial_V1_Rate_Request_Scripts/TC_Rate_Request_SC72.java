...
public class TC_Rate_Request_SC72   extends Keywords {
	public void Rate_Request_SC72(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String request_Status = Excel_data.get("request_Status");
...
formatLocatorClick(driver, RequestType, Request_Input);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			if(actDGDetailsFrame.equals(dGDetailsFrame)) {
				Extent_pass_New(driver,"Matched || Expected Report Activity is : "+dGDetailsFrame+" Actual Report Activity is : "+ actDGDetailsFrame, test,test1);
				System.out.println("Matched || Expected Report Activity is : "+dGDetailsFrame+" Actual Report Activity is : "+ actDGDetailsFrame);
				...
				System.out.println("Not Matched || Expected Report Activity is : "+dGDetailsFrame+" Actual Report Activity is : "+ actDGDetailsFrame);

				Extent_fail(driver,"Not Matched || Expected Report Activity is : "+dGDetailsFrame+" Actual Report Activity is : "+ actDGDetailsFrame, test,test1);
			}
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if (actGridRequestStatus.trim().equals(request_Status.trim())) {
				...
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + request_Status+ " || Actual Report Activity is : " + actGridRequestStatus, test,test1);
			} else {
