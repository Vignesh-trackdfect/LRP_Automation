...
public class TC_Haulage_Contract_SC37 extends Keywords{
	public void Haulage_Contract_SC37(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC37";
								    		...
								    		for (String surcharge : surcharge_Value) {
								    		    if (surcharge != null && !surcharge.trim().isEmpty()) {
								    		        ...
								    		        if (isdisplayed(driver, added)) {
								    		            mouseOverToElement(driver, added);
								    		            System.out.println("✅ Charge code was added: " + surcharge);
								    		            Extent_pass_New(driver, "✅ Charge code was added: " + surcharge, test, test1);
								    		            Extent_call(test, test1, "✅ Charge code was added: " + surcharge);
								    		        } else {
								    		            System.out.println("❌ Charge code NOT displayed: " + surcharge);
								    		            Extent_fail(driver, "❌ Charge code NOT displayed: " + surcharge, test, test1);
								    		        }
								    		    } else {
