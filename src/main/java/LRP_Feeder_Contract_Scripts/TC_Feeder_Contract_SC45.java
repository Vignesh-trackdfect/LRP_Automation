...
public class TC_Feeder_Contract_SC45 extends Keywords {

	public void Feeder_Contract_SC45(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws AWTException {

		String testcase_Name = "TC_Feeder_Contract_SC45";
		...
		Step_End(22, "Click and select the EQP behaviour.", test, test1);
