...
public class TC_Contract_Management_System_SC011 extends Keywords {


	public void Contract_Management_System_SC011(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC011";
		...
		if (Contract_Activated.equals(ActivatePopup)) {
			System.out.println("Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is : " + ActivatePopup);
			Extent_pass(driver,"Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is :" + ActivatePopup,test, test1);
			
		} else {
			System.out.println("Not Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is not display : "+ ActivatePopup);

			Extent_fail(driver,"Not Matched || Expected value is : After click on edit button, The status should be : " + Contract_Activated + " Actual value is : After click on edit button, The status is not display : " + ActivatePopup,test, test1);
		...
		if (Contract_Amendment.equals(AmendmentPopup)) {
			System.out.println("Matched || Expected  popup value  is : " + Contract_Amendment + " || Actual popup value is : " + AmendmentPopup);
			Extent_pass(driver,"Matched || Expected popup value  is : " + Contract_Amendment + " || Actual popup value is : " + AmendmentPopup,test, test1);
			
		} else {
			System.out.println("Not Matched || Expected popup value  is : " + Contract_Amendment + " || Actual popup value is : "
					+ AmendmentPopup);
			Extent_fail(driver,"Not Matched || Expected popup value  is : " + Contract_Amendment + "||  Actual popup value is : " + AmendmentPopup,test, test1);
