...
public class TC_Haulage_Contract_SC28 extends Keywords{
	public void Haulage_Contract_SC28(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC28";
						    		 ...
						    		 waitForElement(driver, HC_Amount_Select);
								   		click(driver, HC_Amount_Select);
								    		...
								    		String HC_LDN_MTY_Select_Act = getText(driver, HC_LDN_MTY_Select);
											   ...
											   String HC_Pickup_Type_Droupdown_Act = getText(driver, HC_Pickup_Type_Dropdown);
											   String HC_drop_Type_Droupdown_Act = getText(driver, HC_drop_Type_Dropdown);
											   ...
											   if(Pickup_Type_Value.equals(HC_Pickup_Type_Droupdown_Act)) {
										        	 System.out.println("Matched||Expected Result is taken from Test Data:"+Pickup_Type_Value + " ||Actual Result is Taken from Application: "+HC_Pickup_Type_Droupdown_Act);
										        	 Extent_pass_New(driver, "Matched||Expected Result is taken from Test Data :"+Pickup_Type_Value + " ||Actual Result is Taken from Application : "+HC_Pickup_Type_Droupdown_Act, test, test1);
										         }else {
										        	 System.out.println("NotMatched || Expected Result is taken from Test Data :"+Pickup_Type_Value + " ||Actual Result is Taken from Application: "+HC_Pickup_Type_Droupdown_Act);
										             Extent_fail(driver, "NotMatched || Expected Result is taken from Test Data :"+Pickup_Type_Value + " ||Actual Result is Taken from Application: "+HC_Pickup_Type_Droupdown_Act, test, test1);
										         }	
											   if(Drop_Type_Value.equals(HC_drop_Type_Droupdown_Act)) {
										        	 System.out.println("Matched||Expected Result is taken from Test Data:"+Drop_Type_Value + " ||Actual Result is Taken from Application: "+HC_drop_Type_Droupdown_Act);
										        	 Extent_pass_New(driver, "Matched||Expected Result is taken from Test Data :"+Drop_Type_Value + " ||Actual Result is Taken from Application : "+HC_drop_Type_Droupdown_Act, test, test1);
										         }else {
										        	 System.out.println("NotMatched || Expected Result is taken from Test Data :"+Drop_Type_Value + " ||Actual Result is Taken from Application: "+HC_drop_Type_Droupdown_Act);
										             Extent_fail(driver, "NotMatched || Expected Result is taken from Test Data :"+Drop_Type_Value + " ||Actual Result is Taken from Application: "+HC_drop_Type_Droupdown_Act, test, test1);
										         }	
