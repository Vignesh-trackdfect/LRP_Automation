...
public class TC_Endpoint_Configuration_TS20 extends Keywords {

	public void Endpoint_Configuration_TS20(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Endpoint_Configuration_TS20";
		...
		String New_Attribute = Excel_data.get("New_Attribute");
		String New_Value = Excel_data.get("New_Value");
		...
		clear(driver, WS_ProfileID);
		sendKeys(driver, WS_ProfileID, New_ProfileID);

		Step_End(4, "Change the profile id ", test, test1);

		Step_Start(5, "Change the attribute", test, test1);

		waitForElement(driver, WS_Attribute);
		click(driver, WS_Attribute);

		String locator = String.format(DropDown_Select, New_Attribute);
		jsClick(driver, locator);

		Step_End(5, "Change the attribute", test, test1);

		Step_Start(6, "Change the value", test, test1);

		waitForElement(driver, WS_Value);
		clear(driver, WS_Value);
		sendKeys(driver, WS_Value, New_Value);

		Step_End(6, "Change the value", test, test1);

		Step_Start(7, "Click the save button now the popup should show like EDI Transmission profiler details updated",
				test, test1);
		...
		waitForElement(driver, WS_ProfileID_Filter);
		sendKeys(driver, WS_ProfileID_Filter, New_ProfileID);

		waitForElement(driver, WS_Attribute_Filter);
		sendKeys(driver, WS_Attribute_Filter, New_Attribute);

		waitForElement(driver, WS_Value_Filter);
		sendKeys(driver, WS_Value_Filter, New_Value);

		if (isdisplayed(driver, WS_Row1)) {

			System.out.println("Expected result : The given Profile Id : " + New_ProfileID + " , Attribute : "
					+ New_Attribute + " and value : " + New_Value
					+ " should be updated in the grid || Actual result : The given Profile Id : " + New_ProfileID
					+ " , Attribute : " + New_Attribute + " and value : " + New_Value + " was updated in the grid");
			Extent_pass_New(driver, "Expected result : The given Profile Id : " + New_ProfileID + " , Attribute : "
					+ New_Attribute + " and value : " + New_Value
					+ " should be updated in the grid || Actual result : The given Profile Id : " + New_ProfileID
					+ " , Attribute : " + New_Attribute + " and value : " + New_Value + " was updated in the grid",
					test, test1);
			...
			System.out.println("Expected result : The Profile Id : " + New_ProfileID + " , Attribute : " + New_Attribute
					+ " and value : " + New_Value
					+ " should be updated in the grid || Actual result : The given Profile Id : " + New_ProfileID
					+ " , Attribute : " + New_Attribute + " and value : " + New_Value + " was not updated in the grid");
			Extent_fail(driver, "Expected result : The given Profile Id : " + New_ProfileID + " , Attribute : "
					+ New_Attribute + " and value : " + New_Value
					+ " should be updated in the grid || Actual result : The given Profile Id : " + New_ProfileID
					+ " , Attribute : " + New_Attribute + " and value : " + New_Value + " was not updated in the grid",
					test, test1);
		...
		Step_End(7, "Click the save button now the popup should show like EDI Transmission profiler details updated",
				test, test1);
