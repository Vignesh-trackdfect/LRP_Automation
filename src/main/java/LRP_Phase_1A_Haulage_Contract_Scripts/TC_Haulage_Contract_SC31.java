...
public class TC_Haulage_Contract_SC31 extends Keywords{
	public void Haulage_Contract_SC31(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC31";
						    		 ...
						    		 waitForElement(driver, HC_Amount_Select);
								   		click(driver, HC_Amount_Select);
								    		...
								    		click(driver, HC_Add_Gird_Table);
								    		 Step_Start(20, "Click the copy for the selected row in the Haulage contract.", test, test1);
								    		...
								    		String copied_Pop_Act = getText(driver, Popup_Message);
								    		  ...
								    		  if(Copied_Popup.equals(copied_Pop_Act)) {
										        	 ...
										        	 System.out.println("NotMatchedExpected Popup is  :"+Copied_Popup + "|| Actual Popup is: "+copied_Pop_Act);
										        	 Extent_fail(driver, "NotMatchedExpected Popup is :"+Copied_Popup + " ||Actual Popup is: "+copied_Pop_Act, test, test1);
										         }
