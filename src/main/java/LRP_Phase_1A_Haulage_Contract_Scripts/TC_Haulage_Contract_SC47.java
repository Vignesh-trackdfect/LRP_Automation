...
public class TC_Haulage_Contract_SC47 extends Keywords{
	public void Haulage_Contract_SC47(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC47";
						    		 ...
						    		 waitForElement(driver, HC_Amount_Select);
								   		click(driver, HC_Amount_Select);
								    		...
								    		if(isdisplayed(driver, HC_Add_Gird_Table)) {
								    			System.out.println("All mandatory fields are filled and added in the gird");
								    			Extent_pass_New(driver, "All mandatory fields are filled and added in the gird", test, test1);
								    			Extent_call(test, test1, "All mandatory fields are filled and added in the gird");
								    		}else {
								    			System.out.println("All mandatory fields are not filled and added in the gird");
								    			Extent_fail(driver, "All mandatory fields are not filled and added in the gird", test, test1);	
								    		...
								    		for (String surcharge : surcharge_Value) {
								    		    if (surcharge != null && !surcharge.trim().isEmpty()) {
								    		        ...
								    		        String added = formatLocatorClick(driver, HC_DGCharge_Grid_Value, surcharge);
								    				...
								    				clearAndType(driver, HC_DG_Amount_Gridcell_Textfield, Amount_Edit_Value);
								    				enter(driver);
								    		 
								    				  Step_End(21, "Double click the charge and edit the amount.", test, test1);
								    				  
								    				  Step_Start(22, ".Select the Location pair details and click apply DG.", test, test1);
								    		    	
								    		    	click(driver, added);
								    		    	
								    		    	
								    		    	waitForElement(driver, HC_DG_Apply_Button);
										    		click(driver, HC_DG_Apply_Button);
								    		    	
										    		String dg_pop = getText(driver, popup_Message);
										    		System.out.println(dg_pop);
										    		
										    		  if(DC_POP_Expected.equals(dg_pop)) {
										    	        	 System.out.println(" Matched|| Expected Popup is :"+DC_POP_Expected + " ||Actual Popup Is : "+dg_pop);
										    	        	 Extent_pass_New(driver, "Matched||Expected Popup is :"+DC_POP_Expected + " ||Actual Popup Is  : "+dg_pop, test, test1);
										    	         }else {
										    	        	 System.out.println("NotMatched ||Expected Popup is :"+DC_POP_Expected + " ||Actual Popup Is  : "+dg_pop);
										    	        	 Extent_fail(driver, "NotMatched ||Expected Popup is :"+DC_POP_Expected + " ||Actual Popup Is  : "+dg_pop, test, test1);
										    	         }
										    		...
										    		click(driver, popup_Message_Ok_Button);
								    		    	  ...
								    		    	  Step_End(22, ".Select the Location pair details and click apply DG.", test, test1);
									    		    	
										    	
								    		    	
								    		    	  Step_Start(23, ".Select the Location pair detail and Click the remove DG.", test, test1);
									    		    	
										    		waitForElement(driver, HC_DG_remove_Button);
										    		click(driver, HC_DG_remove_Button);
										    		...
										    		System.out.println(remove_popup);
										    		  ...
										    		  if(remove_popup1.equals(remove_popup_Act1)) {
										    	        	 System.out.println("Matched||Expected Popup is :"+remove_popup1 + " || Actual Popup Is : "+remove_popup_Act1);
										    	        	 Extent_pass_New(driver, "Matched||Expected Popup is :"+remove_popup1 + " || Actual Popup Is  : "+remove_popup_Act1, test, test1);
										    	         }else {
										    	        	 System.out.println("NotMatched||Expected Popup is :"+remove_popup1 + " || Actual Popup Is  : "+remove_popup_Act1);
										    	        	 Extent_fail(driver, "NotMatched||Expected Popup is :"+remove_popup1 + " || Actual Popup Is  : "+remove_popup_Act1, test, test1);
										    	         }
								    		  ...
								    		  Step_End(23, ".Select the Location pair detail and Click the remove DG.", test, test1);
