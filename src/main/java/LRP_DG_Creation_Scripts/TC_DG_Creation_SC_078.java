...
public class TC_DG_Creation_SC_078 extends Keywords {


	public void DG_Creation_SC_078(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_078";
...
//		Module Search
		...
		Step_Start(3, "System not  allow to edit the Technical name.", test, test1);
		...
		if(elementNotEditable(driver, Technical_Name_Textfield)) {
			System.out.println("Matched || " + " Expected : Technical Name Text field should not be editabe || Actual : Technical Name Text field is not editabe");            
			Extent_pass_New(driver, "Matched || " + " Expected : Technical Name Text field should not be editabe || Actual : Technical Name Text field is not editabe", test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected : Technical Name Text field should not be editabe || Actual : Technical Name Text field is editabe");        
			Extent_fail(driver, "Not Matched || " + " Expected : Technical Name Text field should not be editabe || Actual : Technical Name Text field is editabe", test,test1); 
		} 
		Step_End(3, "System not  allow to edit the Technical name.", test, test1);
