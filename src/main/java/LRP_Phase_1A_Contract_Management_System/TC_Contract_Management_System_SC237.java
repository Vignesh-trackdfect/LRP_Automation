...
public class TC_Contract_Management_System_SC237 extends Keywords {

	public void Contract_Management_System_SC237(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC237";
		...
		selectDatePicker(driver, Amd_Effective_date_Input, Amd_Effective_Date);
