...
public class TC_Ecommerce_Gateway_Validator_002 extends Keywords {

	public void Ecommerce_Gateway_Validator_002(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Ecommerce_Gateway_Validator_002";
		...
		Step_Start(1,
				"Select the by-date option to use from date-to-date-based and click the refresh button. Booking and SI records should show up in the grid",
				test, test1);
		...
		checkBox(driver, EG_byDate_Checkbox, Checkbox_Status);
		...
		while (flag == true) {
			...
			try {
				...
				if (grid_status.equals(Received_Status) || grid_status.equals(Error_Status)) {
					...
					System.out.println(
							"If the Non Processed CheckBox is enabled, Only The received Status data's are showing in the Grid and the Displayed status is : "
									+ grid_status);
					Extent_pass_New(driver,
							"If the Non Processed CheckBox is enabled, Only The received Status data's are showing in the Grid and the Displayed status is : "
									+ grid_status,
					...
					System.out.println(
							"If the Non Processed CheckBox is enabled, All the data's are showing in the Grid and the Displayed status is : "
									+ grid_status);
					Extent_fail(driver,
							"If the Non Processed CheckBox is enabled, All the data's are showing in the Grid and the Displayed status is : "
									+ grid_status,
		...
		Step_Start(3,
				"Select the by-date option to use from date-to-date-based, uncheck the non-processed checkbox, and click the refresh button to show received, processed, and void records show",
				test, test1);
				...
				if (!Reference_Number2.isEmpty()) {
					...
					if (grid_RefNo.equals(Reference_Number2)) {
						...
						System.out.println("All the reference number details are showing in the grid || Expected : "
								+ Reference_Number2 + " || Actual : " + grid_RefNo);
						Extent_fail(driver, "All the reference number details are showing in the grid || Expected : "
								+ Reference_Number2 + " || Actual : " + grid_RefNo, test, test1);
					}
				...
				if (!Booking_Number2.isEmpty()) {
					...
					if (grid_BookNo.equals(Booking_Number2)) {
						...
						System.out.println("All the Booking number details are showing in the grid || Expected : "
								+ Booking_Number2 + " || Actual : " + grid_BookNo);
						Extent_fail(driver, "All the Booking number details are showing in the grid || Expected : "
								+ Booking_Number2 + " || Actual : " + grid_BookNo, test, test1);
					}
				}
		...
		for (String Expected : ExpectedStatuses) {
			...
			if (NonProcessed.contains(Expected)) {
				...
				System.out.println(
						"Expected result is : If the Non Processed CheckBox is disabled, All the data's should show in the Grid  || Actual result is : If the Non Processed CheckBox is disabled, All the data's are showing in the Grid and the Displayed status is : "
								+ NonProcessed);
				Extent_pass_New(driver,
						"Expected result is : If the Non Processed CheckBox is disabled, All the data's should show in the Grid  || Actual result is : If the Non Processed CheckBox is disabled, All the data's are showing in the Grid and the Displayed status is : "
								+ NonProcessed,
				...
				System.out.println(
						"Expected result is : If the Non Processed CheckBox is disabled, All the data's should show in the Grid  || Actual result is : If the Non Processed CheckBox is disabled, Only The received Status data's are showing in the Grid and the Displayed status is : "
								+ NonProcessed);
				Extent_fail(driver,
						"Expected result is : If the Non Processed CheckBox is disabled, All the data's should show in the Grid  || Actual result is : If the Non Processed CheckBox is disabled, Only The received Status data's are showing in the Grid and the Displayed status is : "
								+ NonProcessed,
