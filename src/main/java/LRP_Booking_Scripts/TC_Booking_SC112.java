...
public class TC_Booking_SC112 extends Keywords{

public void Booking_SC112 (WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
	
	String tc_Name="TC_Booking_SC112";
		 ...
		 //locators
		String Limited_Quant_value =String.format(Booking_Locators.Limited_Quant_Option, Limited_Quant_data);
		String Expected_Quant_value = String.format(Booking_Locators.Expected_Quant_Option, Expected_Quant_data);
		String Reported_Quant_value = String.format(Booking_Locators.Reported_Quant_Option, Reported_Quant_data);
		String Waste_value =String.format(Booking_Locators.Waste_Option, Waste_data);
	String con_click =String.format(Booking_Locators.Container_Select, Container_select_input);
		...
		if(isdisplayed(driver, Rate_Grid)) {
			...
			if(Applied_Popup.equals(appliedPopupExp)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Report Activity popup is : " + appliedPopupExp + " || Actual Report Activity popup is : " + Applied_Popup);            
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity  popupis: " + appliedPopupExp + " || Actual Report Activity popup is : " + Applied_Popup, test, test1);     
			...
			if(Saved_Popup.equals(detailsSavedPopup)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Report Activity popup is : " + detailsSavedPopup + " || Actual Report Activity popup is : " + Saved_Popup);            
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity popup is: " + detailsSavedPopup + " || Actual Report Activity popup is : " + Saved_Popup, test, test1);     
			click(driver, popup_Message_Ok_Button);
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
			...
			System.out.println("DG number values is: "+DG_num);
			...
			safeclick(driver, popup_Message_Ok_Button);
			 ...
			 globalValueSearchWindow(driver, dd1_condition, select_by_book_number, booknum, "", "", "", "");
			   ...
			   waitForElement(driver, Edit_Button_toolBar);
				...
				waitForElement(driver, DG_select_container);
				String DG_con_num=getText(driver, DG_select_container);
				if(DG_con_num.contains(book_con_num)) {
					System.out.println("Matched || Expected value number should shown was : "+book_con_num+" || Actual value number shown was : "+DG_con_num);
					Extent_pass_New(driver, "Matched || Expected value number should shown was : "+book_con_num+" || Actual value number shown was : "+DG_con_num, test, test1);
				}
				else {
					System.out.println("NotMatched || Expected value number should shown was : "+book_con_num+" || Actual value number shown was : "+DG_con_num);
					Extent_fail(driver,  "NotMatched || Expected number should shown value was : "+book_con_num+" || Actual value number shown was : "+DG_con_num, test, test1);
				}
