...
public class TC_Vendor_Contracts_SC011 extends Keywords {

	public void Vendor_Contracts_SC011(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Vendor_Contracts_SC011";
		...
		String Warning_PopupMessage = Excel_data.get("Warning_PopupMessage");
		...
		if (Warning_PopupMessage.equals(Warning_Popup)) {

			System.out.println("Matched || Expected popup message was : " + Warning_PopupMessage
					+ " || Actual popup message was : " + Warning_Popup);
			Extent_pass_New(driver, "Matched || Expected popup message was : " + Warning_PopupMessage
					+ " || Actual popup message was : " + Warning_Popup, test, test1);
		} else {

			System.out.println("Not Matched || Expected popup message was : " + Warning_PopupMessage
					+ " || Actual popup message was : " + Warning_Popup);
			Extent_fail(driver, "Not Matched || Expected popup message was : " + Warning_PopupMessage
					+ " || Actual popup message was : " + Warning_Popup, test, test1);
