...
public class TC_Booking_SC135 extends Keywords{
	public void Booking_SC135(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String test_Case_Name = "TC_Booking_SC135";
		...
		String restricted_pop = Excel_data.get( "prohibited_pop");
		...
		Step_Start(5, "select confirm button and System shoud validate the Restrictrd Popup", test, test1);

		waitForPopup(driver, popup_Message,restricted_pop);
		String savepopACT = getText(driver, popup_Message);
		System.out.println(savepopACT);
		if(savepopACT.contains(restricted_pop)) {                                                                                                                  
			System.out.println("Matched || " + " Actual Report Activity POPUP  is : " + savepopACT + " || Expected Report Activity POPUP is : " + restricted_pop);            
			Extent_pass_New(driver, "Matched || " + " Actual Report Activity  POPUP is : " + savepopACT + " || Expected Report Activity POPUP is : " + restricted_pop, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Actual Report Activity POPUP is : " + savepopACT + " || Expected Report Activity POPUP is : " + restricted_pop);        
			Extent_fail(driver, "Not Matched || " + " Actual Report Activity POPUP is : " + savepopACT + " || Expected Report Activity POPUP is : " + restricted_pop, test,test1); 
		} 
		Step_End(5, "select confirm button and System shoud validate the Restrictrd Popup", test, test1);
