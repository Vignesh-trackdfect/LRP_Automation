...
public class TC_EDI_Dashboard_TS_006 extends Keywords {
	public void EDI_Dashboard_TS_006(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Dashboard_TS_006";
		...
		String Ext_Reset_Confirmation = Excel_data.get("Ext_Reset_Confirmation");
		...
		Step_Start(10, "EDI Request submitted successfully notification as been shows ", test, test1);
		...
		Step_End(10, "EDI Request submitted successfully notification as been shows ", test, test1);

		Step_Start(11, "Click Yes button It will navigation EDI tracker ", test, test1);
		...
		if (isdisplayed(driver, EDI_Tracks_Show_Button)) {
			System.out.println(
					"Matched: Expected: Clicking the 'Yes' button should navigate to the EDI Tracker || Actual: Clicking the 'Yes' button navigates to the EDI Tracker.");
			Extent_pass_New(driver,
					"Matched: Expected: Clicking the 'Yes' button should navigate to the EDI Tracker || Actual: Clicking the 'Yes' button navigates to the EDI Tracker.",
					test, test1);
		...
		Step_End(11, "Click Yes button It will navigation EDI tracker ", test, test1);

		Step_Start(12, "Now click the show button until status as been completed ", test, test1);
		...
		Step_End(12, "Now click the show button until status as been completed ", test, test1);

		Step_Start(13,
				".Once record move to completed status and go back to EDI dashboard if theEDI generated record colour as been change  to sent (orange colour) ",
				test, test1);
		...
		Step_Start(14, "Again select same data in AG grid ", test, test1);
		...
		Step_End(14, "Again select same data in AG grid ", test, test1);

		Step_Start(15, "Click the reset button  ", test, test1);
		...
		Step_End(15, "Click the reset button  ", test, test1);

		Step_Start(16, "Click the Yes button ", test, test1);

		waitForElement(driver, popup_Message_Yes_Button);
		click(driver, popup_Message_Yes_Button);

		Step_End(16, "Click the Yes button ", test, test1);

		Step_Start(17, "Record has been reset popup as been should able to show ", test, test1);

		waitForPopup(driver, Popup_Message, Ext_Reset_Confirmation);
		String act_reset_popup1 = getText(driver, Popup_Message);
		System.out.println("act_reset_popup1 :" + act_reset_popup1);

		if (act_reset_popup1.equals(Ext_Reset_Confirmation)) {
			System.out.println(
					"Popup Matched ||  Expected : " + Ext_Reset_Confirmation + " || Actual : " + act_reset_popup1);
			Extent_pass_New(driver,
					"Popup Matched ||  Expected : " + Ext_Reset_Confirmation + " || Actual : " + act_reset_popup1, test,
					test1);
		} else {
			System.out.println(
					"Popup Not Matched ||  Expected : " + Ext_Reset_Confirmation + " || Actual : " + act_reset_popup1);
			Extent_fail(driver,
					"Popup Not Matched ||  Expected : " + Ext_Reset_Confirmation + " || Actual : " + act_reset_popup1,
					test, test1);
		}

		Step_End(17, "Record has been reset popup as been should able to show ", test, test1);
