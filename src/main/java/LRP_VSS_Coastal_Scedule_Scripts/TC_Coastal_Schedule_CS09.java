...
public class TC_Coastal_Schedule_CS09 extends Keywords{

	public void Coastal_Schedule_CS09 (WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		String testCaseName="TC_Coastal_Schedule_CS09";

		String Add_Bound_1_CS09 =Excel_data.get("Add_Bound_1");
		String Add_Bound_2_CS09 =Excel_data.get("Add_Bound_2");
		String Add_Bound_3_CS09 =Excel_data.get("Add_Bound_3");
		String pivotBound1_CS09=Excel_data.get( "PivotBound1");
		String pivotBound2_CS09=Excel_data.get( "PivotBound2");
		String pivotBound3_CS09=Excel_data.get( "PivotBound3");
		String Username_CS09 =Excel_data.get("Username");
		String Password_CS09 =Excel_data.get("Password");
		String ModuleSearch_CS09 =Excel_data.get("Module_Search");
		String ServiceCode_CS09 =Excel_data.get("Service_Code"); 
		String VesselCode_CS09 =Excel_data.get("Vessel_Code");
		String voyageNumber_CS09 =Excel_data.get("Voyage_Number");
		String portName_CS09 =Excel_data.get("Port_Name");
		String Bound_1_CS09=Excel_data.get("Bound_1");
		String Bound_2_CS09 =Excel_data.get("Bound_2");
		String Bound_3_CS09= Excel_data.get("Bound_3");
		String remove_Bound_1_CS09=Excel_data.get("remove_Bound_1");
		String remove_Bound_2_CS09 =Excel_data.get("remove_Bound_2");
		String remove_Bound_3_CS09= Excel_data.get("remove_Bound_3");
		String Do_You_Want_Remove_Bound= Excel_data.get("Do_You_Want_Remove_Bound");
		...
		LRP_Login(driver, Username_CS09, Password_CS09);
