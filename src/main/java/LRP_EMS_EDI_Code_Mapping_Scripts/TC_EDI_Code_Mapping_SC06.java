...
public class TC_EDI_Code_Mapping_SC06 extends Keywords {
	public void EDI_Code_Mapping_SC06(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_EDI_Code_Mapping_SC06";
		...
		formatLocatorDoubleClick(driver, DoubleClick_EDI_DepCode_ECM, EDI_Dep_Code);
		...
		waitForElement(driver, Status_Btn_Click_Depot_Tab);
		click(driver, Status_Btn_Click_Depot_Tab);
