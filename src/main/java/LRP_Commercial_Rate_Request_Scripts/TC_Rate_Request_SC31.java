...
public class TC_Rate_Request_SC31  extends Keywords{
	...
	public void rate_Request_Sc31(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String removesurchargeexp =Excel_data.get("removesurchargeexp");
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			waitForPopup(driver, Popup_Message, removesurchargeexp);
			String PopUp_Msg61=getText(driver, Popup_Message);    
			System.out.println(PopUp_Msg61);
			if(PopUp_Msg61.contains(removesurchargeexp)) {                                                                                                                  
				System.out.println("Matched || " + "Expected : popup message should be shown as : " + removesurchargeexp + " || Actual : popup message is shown as : " + PopUp_Msg61);            
				Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + removesurchargeexp + " || Actual : popup message is shown as : " + PopUp_Msg61, test,test1);     
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + removesurchargeexp + " || Actual : popup message is shown as : " + PopUp_Msg61);        
				Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + removesurchargeexp + " || Actual : popup message is shown as : " + PopUp_Msg61, test,test1); 
