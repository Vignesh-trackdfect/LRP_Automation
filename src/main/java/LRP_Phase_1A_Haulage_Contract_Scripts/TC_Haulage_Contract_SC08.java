...
public class TC_Haulage_Contract_SC08 extends Keywords{
	public void Haulage_Contract_SC08(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC08";
		...
		waitForElement(driver, HC_Pickup_Type_Dropdown);
         String Pickup_Type_Value_Actual = getText(driver, HC_Pickup_Type_Dropdown);	
         
         if(Pickup_Type_Value.equals(Pickup_Type_Value_Actual)) {
        	 System.out.println("Expected Value taken in test data :"+Pickup_Type_Value + " || Actual Value taken in Dropdown : "+Pickup_Type_Value_Actual);
        	 Extent_pass_New(driver, "Expected Value taken in test data :"+Pickup_Type_Value + " || Actual Value taken in Dropdown  : "+Pickup_Type_Value_Actual, test, test1);
         }else {
        	 System.out.println("Expected Value taken in test data :"+Pickup_Type_Value + " || Actual Value taken in Dropdown  : "+Pickup_Type_Value_Actual);
             Extent_fail(driver, "Expected Value taken in test data :"+Pickup_Type_Value + "||  Actual Value taken in Dropdown  : "+Pickup_Type_Value_Actual, test, test1);
         }
