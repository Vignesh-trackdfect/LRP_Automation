...
public class TC_Haulage_Contract_SC40 extends Keywords{
	public void Haulage_Contract_SC40(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC40";
								   		...
								   		click(driver, HC_Amount_Select);
								    		...
								    		for (String surcharge : surcharge_Value) {
								    		 ...
								    		 if(EQP_Equipment.equals(eqp)) {
								            	 System.out.println("Matched||Expected Value taken From test data  :"+EQP_Equipment + " || Actual Value taken EQP Behaviour Drop Down: "+eqp);
								            	 Extent_pass_New(driver, "Matched||Expected Value taken From test data:"+EQP_Equipment + " || Actual Value taken EQP Behaviour Drop Down : "+eqp, test, test1);
								             }else {
								            	 System.out.println("NotMatched ||Expected Value taken From test data:"+EQP_Equipment + "|| Actual Value taken EQP Behaviour Drop Down  : "+eqp);
								            	 Extent_fail(driver, "NotMatched ||Expected Value taken From test data :"+EQP_Equipment + "||  Actual Value taken EQP Behaviour Drop Down: "+eqp, test, test1);
								             }
