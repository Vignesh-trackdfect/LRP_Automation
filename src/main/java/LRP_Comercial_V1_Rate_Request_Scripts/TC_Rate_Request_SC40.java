...
public class TC_Rate_Request_SC40 extends Keywords{
	...
	public void Rate_Request_SC40(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if(Req_Submit_Popup_Txt.equals(PopUp_Msg)) {                                                                                                                  
				...
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : popup message should be shown" + Req_Submit_Popup_Txt + " || Actual : popup message is shown as : " + PopUp_Msg, test, test1);     
				...
				Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : popup message should be shown" + Req_Submit_Popup_Txt + " || Actual : popup message is shown as : " + PopUp_Msg, test, test1); 
			} 
