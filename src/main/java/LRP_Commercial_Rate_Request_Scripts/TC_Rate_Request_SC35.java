...
public class TC_Rate_Request_SC35 extends Keywords {
	...
	public void rate_Request_Sc35(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String samedatepopexp =Excel_data.get("samedatepopexp");
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			waitForPopup(driver, Popup_Message, samedatepopexp);		

			String PopUp_Msg8=getText(driver, Popup_Message);    
			System.out.println(PopUp_Msg8);
			if(samedatepopexp.equals(PopUp_Msg8)) {                                                                                                                  
				System.out.println("Matched || " + "Expected : popup message should be shown as : " + samedatepopexp + " || Actual : popup message is shown as : " + PopUp_Msg8);            
				Extent_pass_New(driver, "Matched || " + "Expected : popup message should be shown as : " + samedatepopexp + " || Actual : popup message is shown as : " + PopUp_Msg8, test,test1);     
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + "Expected : popup message should be shown as : " + samedatepopexp + " || Actual : popup message is shown as : " + PopUp_Msg8);        
				Extent_fail(driver, "Not Matched || " + "Expected : popup message should be shown as : " + samedatepopexp + " || Actual : popup message is shown as : " + PopUp_Msg8, test,test1); 
