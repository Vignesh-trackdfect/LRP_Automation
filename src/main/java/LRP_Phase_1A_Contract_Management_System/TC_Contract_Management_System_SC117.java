...
public class TC_Contract_Management_System_SC117 extends Keywords{

	public void Contract_Management_System_SC117(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
	
	
		String testCaseName = "TC_Contract_Management_System_SC117";
		...
		String Signatory_Name_Carrier_Info = Excel_data.get("Signatory_Name_Carrier_Info");
		String Signatory_Title_Carrier_Infor = Excel_data.get("Signatory_Title_Carrier_Infor");
		String Contract_Saved_Popup = Excel_data.get("Contract_Saved_Popup");

		
		String Customer_Info_Validation = Excel_data.get("Customer_Info_Validation");
		...
		twoColumnSearchWindow(driver, Equipment_Type_Header, Two_Column_Search_Condition, Equipment_Type_Value);			
		...
		Step_Start(7, "without entering the Customer info trying to Verify", test, test1);
		...
		sendKeys(driver, Cari_info_Signatory_Name, Signatory_Name_Carrier_Info);
		
		waitForElement(driver, Cari_info_Signatory_Title);
		Newclear(driver, Cari_info_Signatory_Title);
		sendKeys(driver, Cari_info_Signatory_Title, Signatory_Title_Carrier_Infor);
		
		scrollTop(driver);
		waitForElement(driver, SaveButton_ToolBar);
		jsClick(driver, SaveButton_ToolBar);
		
		waitForPopup(driver, Popup_Message, Contract_Saved_Popup);
		String ActSave_Popup=getText(driver, Popup_Message);
		if(Contract_Saved_Popup.equals(ActSave_Popup)) {
			System.out.println("Contract Saved Popup Macthed || Expected : "+Contract_Saved_Popup+" || Actual : "+ActSave_Popup);
			Extent_pass_New(driver, "Contract Saved Popup Macthed || Expected : "+Contract_Saved_Popup+" || Actual : "+ActSave_Popup, test, test1);
		}else {
			System.out.println("Contract Saved Popup Not Macthed || Expected : "+Contract_Saved_Popup+" || Actual : "+ActSave_Popup);
			Extent_fail(driver, "Contract Saved Popup Not Macthed || Expected : "+Contract_Saved_Popup+" || Actual : "+ActSave_Popup, test, test1);
		}
		...
		Newclear(driver, Contract_Management_System_Signatory_Name);
		
		waitForElement(driver, Contract_Management_System_Signatory_Title);
		Newclear(driver, Contract_Management_System_Signatory_Title);
		
		waitForElement(driver, Contract_Management_System_Approved);
		click(driver,Contract_Management_System_Approved);
		
		waitForPopup(driver, Popup_Message, Customer_Info_Validation);
		String Act_Popup=getText(driver, Popup_Message);
		if(Customer_Info_Validation.equals(Act_Popup)) {
			System.out.println("Popup Macthed || Expected : "+Customer_Info_Validation+" || Actual : "+Act_Popup);
			Extent_pass_New(driver, "Popup Macthed || Expected : "+Customer_Info_Validation+" || Actual : "+Act_Popup, test, test1);
		}else {
			System.out.println("Popup Not Macthed || Expected : "+Customer_Info_Validation+" || Actual : "+Act_Popup);
			Extent_fail(driver, "Popup Not Macthed || Expected : "+Customer_Info_Validation+" || Actual : "+Act_Popup, test, test1);
		}
		
		Step_End(7, "without entering the Customer info trying to Verify", test, test1);
