...
public class TC_Contract_Management_System_SC157 extends Keywords {
	public void Contract_Management_System_SC157(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC157";
		...
		for (int i = 0; i <= amendmentCount; i++) {
			...
			if (Activated_avl.equals(Contract_Activated)) {
				System.out.println(
						"Matched || Expected value is : After click on Activate button, The status should be  : "
								+ Contract_Activated
								+ " || Actual value is : After click on Activate button, The status is :"
								+ Activated_avl);
				Extent_pass(driver,
						"Matched || Expected value is : After click on Activate button, The status should be  : "
								+ Contract_Activated
			...
			if (Contract_Amendment.equals(AmendmentPopup)) {
				...
				System.out.println(
						"Matched || Expected value is : After click on amendment button the value should be  : "
								+ Contract_Amendment
								+ " || Actual value is : After click on amendment button the value  is : "
								+ AmendmentPopup);
				Extent_pass(driver,
						"Matched || Expected value is : After click on amendment button the value should be : "
								+ Contract_Amendment
		...
		Step_Start(9, "switch to log tab and click on previous amendment.", test, test1);
		...
		for (int i = 0; i <= amendmentCount; i++) {
			...
			formatLocatorDoubleClick(driver, CMS_ammendment_gridrow, row);

			waitForElement(driver, CMS_updated_amendment);
			String amendment_updatednumber = getAttribute(driver, CMS_updated_amendment, "value");
			System.out.println("previous amendment number : " + amendment_updatednumber);

			Extent_pass(driver, " After adding the amendment, the previously captured amendment number is "
					+ amendment_updatednumber, test, test1);

		}

		Step_End(9, "switch to log tab and click on previous amendment.", test, test1);
