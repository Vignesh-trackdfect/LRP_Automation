...
public class TC_Haulage_Contract_SC42 extends Keywords{
	public void Haulage_Contract_SC42(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Haulage_Contract_SC42";
		...
		String Surcharge_Remove_Popup = Excel_data.get("Surcharge_Remove_Popup");
...
Step_Start(18, ".Click the \"+\" in surcharge and select the Charge code .", test, test1);
		...
		Step_Start(19, "click RemoveSurcharge_Button", test, test1);
		waitForElement(driver, HC_Remove_surcharge_Button);
		click(driver, HC_Remove_surcharge_Button);

		waitForPopup(driver, popup_Message, Surcharge_Remove_Popup);
		String Act_surcharge_Remove_Popup=getText(driver, popup_Message);
		if(Surcharge_Remove_Popup.equals(Act_surcharge_Remove_Popup)) {
			System.out.println("Expected Result is : "+Surcharge_Remove_Popup + " || Actual Result is :  "+ Act_surcharge_Remove_Popup);
			Extent_pass_New(driver, "Expected Result is : "+Surcharge_Remove_Popup + " || Actual Result is :  "+ Act_surcharge_Remove_Popup, test, test1);
		}else {
			System.out.println("Expected Result is : "+Surcharge_Remove_Popup + " Actual Result is :  "+ Act_surcharge_Remove_Popup);
			Extent_fail(driver, "Expected Result is : "+Surcharge_Remove_Popup + " Actual Result is :  "+ Act_surcharge_Remove_Popup, test, test1);
		}

		waitForElement(driver, popup_Message_Yes_Button);
		click(driver, popup_Message_Yes_Button);

       Step_End(19, ".Click the \"+\" in surcharge and select the Charge code .", test, test1);
