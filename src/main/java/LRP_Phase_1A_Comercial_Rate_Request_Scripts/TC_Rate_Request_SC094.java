...
public class TC_Rate_Request_SC094 extends Keywords{
	public void Rate_Request_SC094(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "Rate_Request_SC094";
		...
		String Exp_Popup_Message = Excel_data.get("Exp_Popup_Message");
		...
		waitForPopup(driver, Popup_Message, Exp_Popup_Message);
		String Act_Popupmessage=getText(driver, Popup_Message);
		
		
		if(Act_Popupmessage.equals(Exp_Popup_Message)) {
			Extent_pass_New(driver,"Matched || Expected : popup message should be shown as : "+Exp_Popup_Message+" || Actual : popup message is shown as : "+ Act_Popupmessage, test,test1);
			System.out.println("Matched || Expected : popup message should be shown as : "+Exp_Popup_Message+" || Actual : popup message is shown as : "+ Act_Popupmessage);
		}else {
			Extent_pass_New(driver,"Not Matched || Expected : popup message should be shown as : "+Exp_Popup_Message+" || Actual : popup message is shown as : "+ Act_Popupmessage, test,test1);
			System.out.println("Not Matched || Expected : popup message should be shown as : "+Exp_Popup_Message+" || Actual : popup message is shown as : "+ Act_Popupmessage);
		}
