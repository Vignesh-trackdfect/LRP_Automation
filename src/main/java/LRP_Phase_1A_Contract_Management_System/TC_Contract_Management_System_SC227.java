...
public class TC_Contract_Management_System_SC227 extends Keywords{

	public void Contract_Management_System_SC227(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC227";
		...
		if (isdisplayed(driver, CMS_Verify_Duplicate_Table_Page)) {
			...
			String DuplicateReportTable = TableDataForReport(driver, tableData, "Invalid DG details",
					bookingHeaders);
			  ...
			  String DG_Class_Exceed_popup_2 = getText(driver, CMS_DG_Missing_window_Row_2);
				System.out.println("DG_Class_Exceed_popup is"+DG_Class_Exceed_popup_2);
					...
					if (DG_Details_Missing_popup1.equals(DG_Class_Exceed_popup_1)){
						System.out.println("After Clicking ON upload Button , If we try in valid  DG  details, we will get this message "
								+ DuplicateReportTable);
						Extent_pass(driver, "After Clicking ON upload Button ,If we try in valid  DG  details, we will get this message "
					...
					Extent_fail(driver, "After Clicking ON upload Button ,If we try in valid  DG  details, wew will  not get this message  ", test, test1);
				}
				}
					else {
						
						Extent_fail(driver, "After Clicking ON upload Button , If we try in valid  DG  details, wew will  not get this Window ", test, test1);
					}
