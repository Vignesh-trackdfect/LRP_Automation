...
public class TC_Rate_Request_SC096 extends Keywords{
	
	public void Rate_Request_SC096(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Rate_Request_SC096";
		...
		if(actualPopup.equals(Already_Exist_Popup)) {
			Extent_pass_New(driver,"Matched || Expected : popup message should be shown as : "+Already_Exist_Popup+" || Actual : popup message is shown as : "+ actualPopup, test,test1);
			System.out.println("Matched || Expected : popup message should be shown as : "+Already_Exist_Popup+" || Actual : popup message is shown as : "+ actualPopup);
			

		}else {
			System.out.println("Not Matched || Expected : popup message should be shown as : "+Already_Exist_Popup+" || Actual : popup message is shown as : "+ actualPopup);

			Extent_fail(driver,"Not Matched || Expected : popup message should be shown as : "+Already_Exist_Popup+" || Actual : popup message is shown as : "+ actualPopup, test,test1);
		}
