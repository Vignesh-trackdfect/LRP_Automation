...
public class TC_Rate_Request_SC63 extends Keywords{
	...
	public void Rate_Request_SC63(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if(already_Exist_Popup.equals(exist_PopUp_Msg)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Report Activity Popup value is : " + already_Exist_Popup + " || Actual Report Activity Popup value is : " + exist_PopUp_Msg);            
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity Popup value is : " + already_Exist_Popup + " || Actual Report Activity Popup value is : " + exist_PopUp_Msg, test,test1);     
			}                                                                                                                                                                        
			else {                                                                                                                                                                   
				System.out.println("Not Matched || " + " Expected Report Activity Popup value is : " + already_Exist_Popup + " || Actual Report Activity Popup value is : " + exist_PopUp_Msg);        
				Extent_fail(driver, "Not Matched || " + " Expected Report Activity Popup value is : " + already_Exist_Popup + " || Actual Report Activity Popup value is : " + exist_PopUp_Msg, test,test1); 
			}
			...
			if(Req_Submit_Popup_Txt.equals(PopUp_Msg)) {                                                                                                                  
				System.out.println("Matched || " + " Expected Report Activity Popup value Popup value is : " + Req_Submit_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg);            
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity Popup value Popup value is : " + Req_Submit_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg, test, test1);     
				...
				System.out.println("Not Matched || " + " Expected Report Activity Popup value is : " + Req_Submit_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg);        
				Extent_fail(driver, "Not Matched || " + " Expected Report Activity Popup value is : " + Req_Submit_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg, test, test1); 
			} 
			...
			if(isdisplayed(driver, Popup_Message)) {
				...
				if(Rate_Req_Submitted_Popup_Txt.equals(PopUp_Msg2)) {                                                                                                                  
					System.out.println("Matched || " + " Expected Report Activity Popup value is : " + Rate_Req_Submitted_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg2);            
					Extent_pass_New(driver, "Matched || " + " Expected Report Activity Popup value is : " + Rate_Req_Submitted_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg2, test,test1);     
				}                                                                                                                                                                        
				else {                                                                                                                                                                   
					System.out.println("Not Matched || " + " Expected Report Activity Popup value is : " + Rate_Req_Submitted_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg2);        
					Extent_fail(driver, "Not Matched || " + " Expected Report Activity Popup value is : " + Rate_Req_Submitted_Popup_Txt + " || Actual Report Activity Popup value is : " + PopUp_Msg2, test,test1); 
				} 
			}
