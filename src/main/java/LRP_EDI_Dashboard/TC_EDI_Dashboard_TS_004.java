...
public class TC_EDI_Dashboard_TS_004 extends Keywords {

	public void EDI_Dashboard_TS_004(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Dashboard_TS_004";
		...
		if (!IsElementEnabled(driver, EDI_DB_Mess_Function_Dropdwn)) {
			...
			System.out.println(
					"Not Matched: Expected || Providing the EDI details, 'Message Function' dropdown is enabled || Actual: Providing the EDI details, 'Message Function' dropdown is enabled");
			Extent_fail(driver,
					"Not Matched: Expected || Providing the EDI details, 'Message Function' dropdown is enabled || Actual: Providing the EDI details, 'Message Function' dropdown is enabled",
					test, test1);
		}

		Step_Start(3, "Select the operation type(Export)", test, test1);
		...
		Step_End(3, "Select the operation type(Export)", test, test1);
		...
		Step_End(4, "Select Service code field (FIMS)", test, test1);
		...
		if (Act_Popup.trim().contains(Exp_Generate_Edi_Popup.trim())) {
