...
public class TC_Transportation_Dispatch_Notice_SC_TDN_21 extends Keywords{
	...
	public void Transportation_Dispatch_Notice_SC_TDN_21(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		if(actual_UpdatedPopup.equals(Transportation_Updated)) {
			Extent_pass_New(driver, "Matched || Expected Pop up : "+Transportation_Updated +" || Actual Pop up : "+actual_UpdatedPopup, test, test1);
		...
		twoColumnSearchWindow(driver, return_location_header, condition, Terminal_code_value);
...
//		click(driver, Terminalcode_select);
		...
		waitForDisplay(driver, vendor_Code_addbtn);
		...
		if(Transportation_Updated.contains(Transportation_dispatch_savedpopup1)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity POPUP is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup1);   
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity POPUP is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup1, test, test1);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity POPUP is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup1);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity POPUP is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup1, test,test1); 
		} 
		waitForElement(driver, popup_Message_Ok_Button);
		click(driver, popup_Message_Ok_Button);
