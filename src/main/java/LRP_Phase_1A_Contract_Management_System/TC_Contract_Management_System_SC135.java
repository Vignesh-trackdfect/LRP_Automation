...
public class TC_Contract_Management_System_SC135 extends Keywords {

	public void Contract_Management_System_SC135(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC135";
		...
		if (Popup_Text_Act.equals(Ratenotenotdefined_popup)) {
			System.out.println(
					"Matched || when containerized FMC contract imports lanes with rate number and no rate note entered in the rate note tab ,the Expected popup is "
							+ Ratenotenotdefined_popup
							+ "|| when containerized FMC contract imports lanes with rate number  and no rate note entered in the rate note tab , the Actual popup is "
							+ Popup_Text_Act);
			Extent_pass(driver,
					" Matched  || when containerized FMC contract imports lanes with rate number  and no rate note entered in the rate note tab ,the Expected popup is "
							+ Ratenotenotdefined_popup
			...
			System.out.println(
					" Not Matched  ||when containerized FMC contract imports lanes with rate number  and no rate note entered in the rate note tab , the Expected popup is "
							+ Ratenotenotdefined_popup
							+ "   ||  when containerized FMC contract imports lanes with rate number  and no rate note entered in the rate note tab , the Acutal popup is "
							+ Popup_Text_Act);
			Extent_fail(driver,
					" Not Matched  || when containerized FMC contract imports lanes with rate number  and no rate note entered in the rate note tab , the Expected popup is"
							+ Ratenotenotdefined_popup
