...
public class TC_Payable_Payment_PP20 extends Keywords{
	public void Payable_Payment_PP20(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) throws EncryptedDocumentException, InvalidFormatException, IOException{

		String testcase_Name="TC_Payable_Payment_PP20";
	   ...
	   newButton(driver);
		...
		if(payment_Date.equals("")) {
			...
			if(Date_Picker.equalsIgnoreCase("Yes")) {
				// added
				selectDatePicker(driver, payment_Date_PPT, payment_Date);
		...
		Step_Start(6, "Select the two transaction number and select and make  payment", test, test1);
		...
		for(String Trans_Number:Trans_Numbers) {
			...
			sendKeys(driver, transNumber_Filter_PPT, Trans_Number);
			String Select_Trans_Number=String.format(select_Checkbox_PPT, Trans_Number);
			waitForElement(driver, Select_Trans_Number);
			click(driver, Select_Trans_Number);
			waitForElement(driver, transNumber_Filter_PPT);
			clear(driver, transNumber_Filter_PPT);
		}
		
		Step_End(6, "Select the two transaction number and select and make  payment", test, test1);
		...
		twoColumnMultipleSearchWindow(driver,Account,dropdownCondition,value_1);


		
		
		Step_Start(10, "Enter the ROE Difference and select ROE/Diff value if different currency", test, test1);
		...
		Step_End(10, "Enter the ROE Difference and select ROE/Diff value if different currency", test, test1);
		...
		Step_Start(15, "Click on save, should show the pop up message as payable payment saved", test, test1);
		...
		String PPT_Popup=getText(driver, popup_Message);
         ...
         Step_End(15, "Click on save, should show the pop up message as payable payment saved", test, test1);
