...
public class TC_Feeder_Contract_SC32 extends Keywords {

	public void Feeder_Contract_SC32(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC32";
		...
		String Other_Header = Excel_data.get("Other_Header");
		String Other_Value = Excel_data.get("Other_Value");
		...
		waitForElement(driver, FC_Others_radiobutton);
		click(driver,FC_Others_radiobutton);
		
		waitForElement(driver, FC_OtherTerminalSearch);
		click(driver, FC_OtherTerminalSearch);

		twoColumnSearchWindow(driver, Other_Header, Two_Column_Condition, Other_Value);
