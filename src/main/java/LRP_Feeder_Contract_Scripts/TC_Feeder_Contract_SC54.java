...
public class TC_Feeder_Contract_SC54 extends Keywords {

	public void Feeder_Contract_SC54(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC54";
		...
		doubleClick(driver, FC_Fdr_Contract_number_field);
