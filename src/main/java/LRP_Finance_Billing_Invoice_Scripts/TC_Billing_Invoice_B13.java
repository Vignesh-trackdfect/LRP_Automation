...
public class TC_Billing_Invoice_B13  extends Keywords{
	public void  Billing_Invoice_B13(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Billing_Invoice_B13";
	...
	//  First Voyage/Bound
		...
		if (Billing_saved_popup.equals(Actualpopmsg)) {
			...
			Extent_call(test, test1, "*****Biiling was able to save in the [ACTIVE] Financial year***"+Actualpopmsg);

		} else {
			System.out.println("Not matched || Expected : After click on save button Popup value should be display in the Billing Invoice Screen : " + Billing_saved_popup+ " || Actual : After click on save button Popup value is Not display in the Billing Invoice Screen : " + Actualpopmsg);
			Extent_fail(driver, "Not matched || Expected : After click on save button Popup value should be display in the Billing Invoice Screen : " + Billing_saved_popup+ " || Actual : After click on save button Popup value is Not display in the Billing Invoice Screen : " + Actualpopmsg, test, test1);
		...
		waitForElement(driver, trans_number);
		String colour = getTextBackgroundColor(driver, trans_number);
		String trans_num_colour=getColorName(colour);
		
		if (trans_num_colour_exp.equals(trans_num_colour)) {
			System.out.println("Matched || " + " Expected Trans_Number color is : " + trans_num_colour_exp+ " || Actual Trans_Number color is  : " + trans_num_colour);
			Extent_pass_New(driver, "Matched || " + " Expected Trans_Number color is  : " + trans_num_colour_exp+ " || Actual Trans_Number color is  : " + trans_num_colour, test, test1);
			Extent_call(test, test1, Actualpopmsg);
		} else {
			System.out.println("Not matched || " + " Expected Trans_Number color is  : " + trans_num_colour_exp+ " || Actual Trans_Number color is  : " + trans_num_colour);
			Extent_fail(driver, "Not matched || " + " Expected Trans_Number color is  : " + trans_num_colour_exp+ " || Actual Trans_Number color is : " + trans_num_colour, test, test1);
