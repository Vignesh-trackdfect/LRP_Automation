...
public class TC_Contract_Management_System_SC220 extends Keywords {

	public void Contract_Management_System_SC220(WebDriver driver, ExtentTest test, ExtentTest test1,

			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Contract_Management_System_SC220";
		...
		Step_Start(6, "Import the port pair lanes with DG YES and OOG YES and without  the DG and OOG details.", test, test1);
		...
		if (isdisplayed(driver, CMS_Verify_Duplicate_Table_Page)) {
			...
			String DuplicateReportTable = TableDataForReport(driver, tableData, "OOG And DG missing details",
					bookingHeaders);
			...
			System.out.println("DG_Class_Exceed_popup is"+DG_Class_Exceed_popup_1);
			  ...
			  String DG_Class_Exceed_popup_2 = getText(driver, CMS_DG_Missing_window_Row_2);
				...
				if (isdisplayed(driver, CMS_Verify_Duplicate_Table_Page)) {
					...
					Extent_fail(driver,
							"After Clicking ON upload Button , OOG missing details should be displayed  " + DuplicateReportTable,
							test, test1);
				}

				Step_End(6, "Import the port pair lanes with DG NO and OOG NO and with the DG and OOG details.", test, test1);
				Extent_completed(testCaseName, test, test1);
			}
		Step_End(6, "Import the port pair lanes with DG YES and OOG YES and without  the DG and OOG details.", test, test1);
		Extent_completed(testCaseName, test, test1);
	}
