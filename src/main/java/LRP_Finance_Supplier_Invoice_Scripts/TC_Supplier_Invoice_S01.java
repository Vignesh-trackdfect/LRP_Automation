...
public class TC_Supplier_Invoice_S01  extends Keywords{
	
	public void  Supplier_Invoice_S01(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Supplier_Invoice_S01";
		...
		String Suplier_saved_popup =Excel_data.get("Suplier_saved_popup");
		...
		String globalSearchFilterOption_Customer1_Cr = Excel_data.get("GlobalSearchFilterOption_Customer2_Dr");
		...
		waitForDisplay(driver, Supplier_nomination_search);
		if(isdisplayed(driver, Supplier_nomination_search)&&!Nomination_name_CR.equals("")){
			waitForElement(driver, Supplier_nomination_search);
			click(driver,Supplier_nomination_search);
		...
		waitForDisplay(driver, Supplier_currency_search);
		if(isdisplayed(driver, Supplier_currency_search)&&!Currency_code_CR.equals("")) {
			waitForElement(driver, Supplier_currency_search);
			click(driver,Supplier_currency_search);
		...
		Step_Start(18, "Total Cr and Dr will match ,transactions will save successfully .", test, test1);

		
		

		waitForPopup(driver, popup_Message,Suplier_saved_popup);
		
		String Actualpopmsg = getText(driver, popup_Message);
		System.out.println(Actualpopmsg);

		if (Suplier_saved_popup.equals(Actualpopmsg)) {
			System.out.println("Matched || " + " Expected popup value should be display in the Suplier invoice Screen : " + Suplier_saved_popup+ " || Actual popup value is  display in the Suplier invoice Screen  : " + Actualpopmsg);
			Extent_pass_New(driver, "Matched || " + " Expected popup value should be display in the Suplier invoice Screen  : " + Suplier_saved_popup+ " || Actual popup value is  display in the Suplier invoice Screen : " + Actualpopmsg, test, test1);
			Extent_call(test, test1, Actualpopmsg);
		} else {
			System.out.println("Not matched || " + " Expected popup  value should be display in the Suplier invoice Screen : " + Suplier_saved_popup+ " || Actual popup value is not display in the Suplier invoice Screen: " + Actualpopmsg);
			Extent_fail(driver, "Not matched || " + " Expected popup  value should be display in the Suplier invoice Screen : " + Suplier_saved_popup+ " ||Actual popup value is not display in the Suplier invoice Screen : " + Actualpopmsg, test, test1);
		...
		Extent_call(test, test1, "*****trans_Number was created as***"+trans_num);


		waitForElement(driver, supplier_trans_number);
		String draft_bookingColorCode = getTextBackgroundColor(driver, supplier_trans_number);
		String bookingColor=getColorName(draft_bookingColorCode);
		
		if(trans_num_colour_exp.equals(bookingColor)) {                                                                                                                  
			System.out.println("Matched || " + " Expected : Once trans_Number was created as Booking number input field should be change to the yellow colour : " + trans_num_colour_exp + " || Actual Once trans_Number was created as Booking number input field is change to the yellow colour : " + bookingColor);            
			Extent_pass_New(driver, "Matched || " + " Expected : Once trans_Number was created as Booking number input field should be change to the yellow colour : " + trans_num_colour_exp + " ||Actual Once trans_Number was created as Booking number input field is change to the yellow colour : " + bookingColor, test, test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + "Expected : Once trans_Number was created as Booking number input field should be change to the yellow colour " + trans_num_colour_exp + " || Actual Once trans_Number was created as Booking number input field is not  change to the yellow colour : " + bookingColor);        
			Extent_fail(driver, "Not Matched || " + " Expected : Once trans_Number was created as Booking number input field should be change to the yellow colour : " + trans_num_colour_exp + " || Actual Report Activity is[Booking number input field is not changed yellow colour] : " + bookingColor, test, test1); 
		} 
		Step_End(18, "Total Cr and Dr will match ,transactions will save successfully .", test, test1);
