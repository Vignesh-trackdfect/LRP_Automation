...
public class TC_Contract_Management_System_SC017 extends Keywords {

	
public void Contract_Management_System_SC17(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		
		String testCaseName="TC_Contract_Management_System_SC017";
       ...
       Step_Start(14, "click edit", test, test1);
		...
		if (isDisplayed(driver, popup_Message)) {
			...
			click(driver, popup_Message_Yes_Button);
			elementnotvisible1(driver, popup_Message_Yes_Button);
		} else {
			System.out.println("Popup message is not display");
		}
		...
		if (Filed.equals(Filed_avl)) {
			System.out.println("Matched || Expected value is : After click on file button, The status should be : " + Filed + "||  Actual value is : After click on file button, The status is : " + Filed_avl);
			Extent_pass(driver,"Matched || Expected value is : After click on file button, The status should be : " + Filed + "|| Actual value is : After click on file button, The status is  : " + Filed_avl, test,test1);

		} else {
			System.out.println("Not Matched || Expected value is : After click on file button, The status should be : " + Filed + "|| Actual value is : After click on file button, The status is : " + Filed_avl);
			Extent_fail(driver,"Not Matched || Expected value is : After click on file button, The status should be : " + Filed + " || Actual value is : After click on file button, The status is: " + Filed_avl, test,test1);
			

		}
		Step_End(19, "Click on the file button", test, test1);
		
		Step_Start(20, "search the contract through global search and click on save as", test, test1);
		...
		Step_End(20, "search the contract through global search and click on save as", test, test1);
		
		Step_Start(21, "change the cust code and re-do the process till file status", test, test1);
		...
		String select_Internal_Commmodity1=String.format(Contract_Management_System_Commodity_val, Internal_Commodity);
		waitForElement(driver, select_Internal_Commmodity1);
		safeclick(driver, select_Internal_Commmodity1);
...
//		
		...
		if(Verified.equals(verifiednumber1)) {
			Extent_pass(driver,"Matched || Expected value is : After click on save button, The status should be : "+Verified+" || Actual value is : After click on save button, The status is :"+ verifiednumber1, test,test1);
			System.out.println("Matched || Expected value is After click on save button, The status should be : "+Verified+" || Actual value is : After click on save button, The status is :"+ verifiednumber1);
		}else {
			System.out.println("Not Matched || Expected value is : After click on save button, The status should be : "+Verified+" || Actual value is : After click on save button, The status is : "+ verifiednumber1);
			Extent_fail(driver,"Not Matched || Expected value is : After click on save button, The status should be : "+Verified+" || Actual value is : After click on save button, The status is : "+ verifiednumber1, test,test1);
		...
		waitForElement(driver, Contract_Management_System_status);
		String Filed_avl1 = getAttribute(driver, Contract_Management_System_status, "value");
		System.out.println("Filed_avl :" + Filed_avl1);
		
		if (Filed.equals(Filed_avl1)) {
			System.out.println("Matched || Expected value is : After click on file button, The status should be : " + Filed + "||  Actual value is : After click on file button, The status is : " + Filed_avl1);
			Extent_pass(driver,"Matched || Expected value is : After click on file button, The status should be : " + Filed + "|| Actual value is : After click on file button, The status is  : " + Filed_avl1, test,test1);

		} else {
			System.out.println("Not Matched || Expected value is : After click on file button, The status should be : " + Filed + "|| Actual value is : After click on file button, The status is : " + Filed_avl1);
			Extent_fail(driver,"Not Matched || Expected value is : After click on file button, The status should be : " + Filed + " || Actual value is : After click on file button, The status is: " + Filed_avl1, test,test1);
		...
		Step_End(21, "change the cust code and re-do the process till file status", test, test1);
