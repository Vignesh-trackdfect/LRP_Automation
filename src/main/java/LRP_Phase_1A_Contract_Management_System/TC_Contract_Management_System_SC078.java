...
public class TC_Contract_Management_System_SC078 extends Keywords {

	public void Contract_Management_System_SC78(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testCaseName = "TC_Contract_Management_System_SC078";
		...
		if (BackRoundColor.equals(color1)) {
			System.out
					.println("Expected ||  When adding the lane, the system should highlight the no surcharge lanes in "
							+ BackRoundColor
							+ " || Actual:  When adding the lane, the system should highlight the no surcharge lanes in "
							+ color1);
			Extent_pass(driver,
					"Expected||   When adding the lane, the system should highlight the no surcharge lanes in "
							+ BackRoundColor
							+ " || Actual:   When adding the lane, the system should highlight the no surcharge lanes in "
							+ color1,
					test, test1);
