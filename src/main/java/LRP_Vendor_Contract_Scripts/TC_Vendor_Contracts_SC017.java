...
public class TC_Vendor_Contracts_SC017 extends Keywords {

	public void Vendor_Contracts_SC017(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_Excel_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Vendor_Contracts_SC017";
		...
		String Accept_Required = Excel_data.get("Accept_Required");
		...
		Step_Start(5, "Click on the import excel option", test, test1);

		waitForElement(driver, VC_ImportExcel);
		click(driver, VC_ImportExcel);

		Step_End(5, "Click on the import excel option", test, test1);

		Step_Start(6, "Click on the select excel file option", test, test1);

		Step_Start(7, "Select the excel file from the system and click open", test, test1);

		waitForDisplay(driver, VC_IE_SelectExcel);
		uploadfile_new(driver, VC_IE_SelectExcel, ImportFilePath);

		Step_End(6, "Click on the select excel file option", test, test1);

		Step_End(7, "Select the excel file from the system and click open", test, test1);

		Step_Start(8, "Select the Master tab", test, test1);

		formatLocatorClick(driver, VC_ImportTabs, ImportExcel_MasterTab);

		Step_End(8, "Select the Master tab", test, test1);

		Step_Start(9, "Click the select sheet and select the sheet 1 name", test, test1);
		...
		Step_End(9, "Click the select sheet and select the sheet 1 name", test, test1);

		Step_Start(10, "Click on Load sheet option", test, test1);

		waitForElement(driver, VC_Load_Sheet);
		click(driver, VC_Load_Sheet);

		Step_End(10, "Click on Load sheet option", test, test1);

		Step_Start(11, "The system validates a message as 'Do you want to map the column automatically?'", test, test1);
		...
		if (isdisplayed(driver, VC_MapColumn_popup)) {
			...
			Step_End(11, "The system validates a message as 'Do you want to map the column automatically?'", test,
					test1);

			Step_Start(12, "Click on Yes option", test, test1);
		...
		Step_End(12, "Click on Yes option", test, test1);
		...
		if (!D_Columnvalue.contains("Sub To Formula")) {
			...
			Step_Start(13, "Select the Formula tab", test, test1);

			formatLocatorClick(driver, VC_ImportTabs, ImportExcel_FormulaTab);

			Step_End(13, "Select the Formula tab", test, test1);

			Step_Start(14, "Click the select sheet and select the sheet 2 name", test, test1);
			...
			Step_End(14, "Click the select sheet and select the sheet 2 name", test, test1);

			Step_Start(15, "Click on Load sheet option", test, test1);

			waitForElement(driver, VC_Load_Sheet);
			click(driver, VC_Load_Sheet);

			Step_End(15, "Click on Load sheet option", test, test1);

			Step_Start(16, "The system validates a message as 'Do you want to map the column automatically?'", test,
					test1);
			...
			if (isdisplayed(driver, VC_MapColumn_popup)) {
				...
				Step_End(16, "The system validates a message as 'Do you want to map the column automatically?'", test,
						test1);

				Step_Start(17, "Click on Yes option", test, test1);
			...
			Step_End(17, "Click on Yes option", test, test1);
			...
			if (!D_Columnvalue2.contains("Y")) {
				...
				Step_Start(18, "Select the slab tab", test, test1);

				formatLocatorClick(driver, VC_ImportTabs, ImportExcel_SlabTab);

				Step_End(18, "Select the slab tab", test, test1);

				Step_Start(19, "Click the select sheet and select the sheet 3 name", test, test1);
				...
				Step_End(19, "Click the select sheet and select the sheet 3 name", test, test1);

				Step_Start(20, "Click on Load sheet option", test, test1);

				waitForElement(driver, VC_Load_Sheet);
				click(driver, VC_Load_Sheet);

				Step_End(20, "Click on Load sheet option", test, test1);

				Step_Start(21, "The system validates a message as 'Do you want to map the column automatically?'", test,
						test1);
				...
				if (isdisplayed(driver, VC_MapColumn_popup)) {
					...
					Step_End(21, "The system validates a message as 'Do you want to map the column automatically?'",
							test, test1);

					Step_Start(22, "Click on Yes option", test, test1);
				...
				Step_End(22, "Click on Yes option", test, test1);

			}

		}

		Step_Start(23, "Click upload option", test, test1);

		waitForElement(driver, VC_UploadButton);
		click(driver, VC_UploadButton);

		Step_End(23, "Click upload option", test, test1);

		Step_Start(24, "System validates as Successfully imported and Click ok Option", test, test1);
		...
		Step_End(24, "System validates as Successfully imported and Click ok Option", test, test1);
		...
		if (Saved_popup_msg.equals(Saved_popup)) {
			...
			System.out.println("Matched || Expected saved popup was : " + Saved_popup + " || Actual saved popup was : "
					+ Saved_popup_msg);
			Extent_pass_New(driver, "Matched || Expected saved popup was : " + Saved_popup + " || Actual saved popup was : "
					+ Saved_popup_msg, test, test1);
		} else {
		...
		Step_Start(26, "Click Accept option", test, test1);

		waitForElement(driver, accept_Button_VC);
		click(driver, accept_Button_VC);

		Step_End(26, "Click Accept option", test, test1);

		Step_Start(27, "Click Yes for contract mapping and No if it is not required", test, test1);

		if (Accept_Required.equals("Yes")) {
		...
		waitForElement(driver, CM_VendorCode);

		String contract_Mapping_Vendorcode = getAttribute(driver, CM_VendorCode, "value");

		if (contract_Mapping_Vendorcode.equals(Ventor_Code)) {

			System.out.println("Selected contracts are accepted || Expected vendor code: " + Ventor_Code
					+ " || Actual vendor code: " + contract_Mapping_Vendorcode);
			Extent_pass_New(driver, "Selected contracts are accepted || Expected vendor code: " + Ventor_Code
					+ " || Actual vendor code: " + contract_Mapping_Vendorcode, test, test1);
		} else {
			System.out.println("Selected contracts are not accepted || Expected vendor code: " + Ventor_Code
					+ " || Actual vendor code: " + contract_Mapping_Vendorcode);
			Extent_fail(driver, "Selected contracts are not accepted || Expected vendor code: " + Ventor_Code
					+ " || Actual vendor code: " + contract_Mapping_Vendorcode, test, test1);

		}

		Step_End(27, "Click Yes for contract mapping and No if it is not required", test, test1);
