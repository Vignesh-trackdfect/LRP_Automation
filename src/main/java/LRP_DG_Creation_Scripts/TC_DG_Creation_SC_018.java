...
public class TC_DG_Creation_SC_018 extends Keywords {


	public void DG_Creation_SC_018(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url)
			throws EncryptedDocumentException, InvalidFormatException, IOException {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_018";
		...
		String DG_Remove_Popup = Excel_data.get("DG_Remove_Popup");
...
//		Module Search
		...
		Step_Start(5, "Select the container in Grid.)", test, test1);
		...
		Step_End(5, "Select the container in Grid.)", test, test1);
		Step_Start(6, "Click remove button.)", test, test1);
		waitForElement(driver, DG_Remove);
		safeclick(driver, DG_Remove);
		waitForPopup(driver, popup_Message, DG_Remove_Popup);
		String DG_Remove_Popup1 = getText(driver, popup_Message);
		if (DG_Remove_Popup1.equals(DG_Remove_Popup)) {
			System.out.println(
					"Matched || " + " Expected Popup is : " + DG_Remove_Popup + " || Actual Popup is : " + DG_Remove_Popup1);
			Extent_pass_New(driver,
					"Matched || " + " Expected Popup is: " + DG_Remove_Popup + " || Actual Popup is : " + DG_Remove_Popup1,
					test, test1);
			
		} else {
			System.out.println("Not Matched || " + " Expected Popup is : " + DG_Remove_Popup + " || Actual Popup is : "
					+ DG_Remove_Popup1);
			Extent_fail(driver, "Not Matched || " + " Expected Popup is : " + DG_Remove_Popup + " || Actual Popup is : "
					+ DG_Remove_Popup1, test, test1);
			
		}
		click(driver, popup_Message_Ok_Button);
		
		Step_End(6, "Click remove button.)", test, test1);
