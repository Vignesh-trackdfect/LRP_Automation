...
public class TC_Vendor_Invoice_Registration_SC47 extends Keywords{

	public void Vendor_Invoice_Registration_SC47(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_Excel_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName="TC_Vendor_Invoice_Registration_SC47";
		...
		waitForElement(driver, sor_Manual_activity_Button);
		click(driver, sor_Manual_activity_Button);
		...
		waitForElement(driver, sor_Main_Activity_Search_Button);
		click(driver, sor_Main_Activity_Search_Button);
		...
		waitForElement(driver, sor_Sub_Activity_Plus_Button);
		click(driver, sor_Sub_Activity_Plus_Button);
		...
		waitForElement(driver, sor_eqp_Type_Search_Button);
		click(driver, sor_eqp_Type_Search_Button);
		...
		waitForElement(driver, sor_ports_Search_Button);
		click(driver, sor_ports_Search_Button);
		...
		if(!DA_Month_Input.trim().equals("")) {
			waitForElement(driver, sor_manual_Activity_Month_Dropdown);
			click(driver, sor_manual_Activity_Month_Dropdown);
		...
		if(!Activity_Input.trim().equals("")) {
			waitForElement(driver, sor_manual_DA_Month_Dropdown);
			click(driver, sor_manual_DA_Month_Dropdown);
		...
		waitForElement(driver, sor_Manual_Activity_Plus_Button);
		click(driver, sor_Manual_Activity_Plus_Button);
