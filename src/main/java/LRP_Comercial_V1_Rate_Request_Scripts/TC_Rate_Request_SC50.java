...
public class TC_Rate_Request_SC50 extends Keywords {
	...
	public void Rate_Request_SC50(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url){
		...
		String ofr_data_2 = Excel_data.get("ofr_data_2");
		String remarks_txtfld_data_agency = Excel_data.get("remarks_txtfld_data_agency");
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if(actualPopup.equals(wantToProceedPopup)) {
				...
				System.out.println("Matched || Expected :popup message should be shown "+wantToProceedPopup+" || Actual : popup message is shown as : "+ actualPopup);
				...
				System.out.println("Not Matched || Expected :popup message should be shown "+wantToProceedPopup+" || Actual : popup message is shown as : "+ actualPopup);

				Extent_fail(driver,"Not Matched || Expected :popup message should be shown "+wantToProceedPopup+" || Actual : popup message is shown as : "+ actualPopup, test,test1);
			}
