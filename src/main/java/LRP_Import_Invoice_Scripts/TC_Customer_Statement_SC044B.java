...
public class TC_Customer_Statement_SC044B extends Keywords {

	public void Customer_Statement_SC044B(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws EncryptedDocumentException, InvalidFormatException {

		String testcase_Name = "TC_Customer_Statement_SC044B";
		...
		waitForElement(driver, By_Service_Radio_Button);
		click(driver, By_Service_Radio_Button);
