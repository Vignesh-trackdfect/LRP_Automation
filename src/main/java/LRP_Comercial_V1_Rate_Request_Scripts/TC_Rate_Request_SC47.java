...
public class TC_Rate_Request_SC47 extends Keywords {
	...
	public void Rate_Request_SC47(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		...
		String surcharge_Input = Excel_data.get("surcharge_Input");
...
if(isdisplayed(driver, empty_Checkbox_RR)) {
	...
	formatLocatorClick(driver, on_Carriage_Radiobtn, On_Carriage_Radiobtn);
			...
			if (actRequestStatus.equals(requestStatus)) {
				...
				Extent_pass_New(driver, "Matched || " + " Expected Report Activity is : " + actRequestStatus+ " || Actual Report Activity is : " + requestStatus, test,test1);
			} else {
