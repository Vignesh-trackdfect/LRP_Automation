...
public class TC_Ecommerce_Gateway_Validator_014 extends Keywords {
	public void Ecommerce_Gateway_Validator_014(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name = "TC_Ecommerce_Gateway_Validator_014";
		...
		Step_Start(6, " cilck the save button ,  E-Commerce SI Saved", test, test1);
		...
		if (Excepted_Save_PopUp.equals(ActualP_Save_PopUp)) {
			System.out.println("Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp +" || The Actual PopUP Msg is : " + ActualP_Save_PopUp);
			 Extent_pass_New(driver,"Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp +" || The Actual PopUP Msg is : " + ActualP_Save_PopUp , test, test1);
			...
			System.out.println("Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp1 +"|| The Actual PopUP Msg is : " + ActualP_Save_PopUp);
			 Extent_pass_New(driver,"Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp1 +"|| The Actual PopUP Msg is : " + ActualP_Save_PopUp , test, test1);
			...
			System.out.println(" Not Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp +" || The Actual PopUP Msg is : " + ActualP_Save_PopUp);
			 Extent_fail(driver," Not Matched || The Excepted POPUP Msg is : "+Excepted_Save_PopUp +" || The Actual PopUP Msg is : " + ActualP_Save_PopUp , test, test1);
		
		}
		
		Step_End(6, " cilck the save button ,  E-Commerce SI Saved", test, test1);
		
		Step_Start(7, "To accept the SI, click the accept button once the actual BL number is generated,  Selected BL has been updated   ", test, test1);
		...
		if (ActualP_Update_PopUp.contains(Excepted_Update_PopUp)) {
			System.out.println("Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp +" || The Actual PopUP Msg is : " + ActualP_Update_PopUp);
			 Extent_pass_New(driver,"Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp +"|| The Actual PopUP Msg is : " + ActualP_Update_PopUp , test, test1);
			...
			System.out.println("Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp1 +" || The Actual PopUP Msg is : " + ActualP_Update_PopUp);
			 Extent_pass_New(driver,"Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp1 +"|| The Actual PopUP Msg is : " + ActualP_Update_PopUp , test, test1);
			...
			System.out.println(" Not Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp +" || The Actual PopUP Msg is : " + ActualP_Update_PopUp);
			 Extent_fail(driver," Not Matched || The Excepted POPUP Msg is : "+Excepted_Update_PopUp +" || The Actual PopUP Msg is : " + ActualP_Update_PopUp , test, test1);
		
		}
		
		Step_End(7, "To accept the SI, click the accept button once the actual BL number is generated,  Selected BL has been updated   ", test, test1);
