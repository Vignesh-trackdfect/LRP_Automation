...
public class TC_Arrival_Notice_TS_011 extends Keywords {


	public void Arrival_Notice_TS_011(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Arrival_Notice_TS_011";
...
//		String agencyUser = Excel_data.get("AgencyUser");
		...
		String Customer_Code =Excel_data.get("New_Customer_Code");
...
//		String Delete_Perform = Excel_data.get("Delete_Perform");
		String select_checkbox =  String.format(Arrival_Notice_Locators.bl_select_box,BL_Number_box); 
...
//		Step_End(1, " Switch the agency", test, test1);
		...
		Step_Start(5, ".Enter the valid customer code and click select", test, test1);
		globalValueSearchWindow(driver, dropdown_Condition, customer_select, Customer_Code, "", "", "", "");

		Step_End(5, ".Enter the valid customer code and click select", test, test1);
		...
		Step_Start(7, "Select the mentioned Bl number in below grid", test, test1);
		waitForElement(driver, select_checkbox);
		click(driver,select_checkbox);
		Step_End(7, "Select the mentioned Bl number in below grid", test, test1);
