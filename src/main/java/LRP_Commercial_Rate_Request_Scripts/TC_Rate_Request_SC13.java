...
public class TC_Rate_Request_SC13 extends Keywords {
	public void Rate_RequestSC13(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws Exception {
		...
		String Ofr_Value1=Excel_data.get("Ofr_Value1");		
		...
		String Customer_Code = Excel_data.get("Cust_code").trim();
...
newButton(driver);
		...
		Actionsendkeys(driver, Commodity_Input, commodity);
			...
			if(Ofr_Value1.equals(Rates_Loc_Value)) {
				...
				Extent_pass_New(driver, "Matched || Expected value was : "+Ofr_Value1+" || Actual value was : "+Rates_Loc_Value, test, test1);
