...
public class TC_Discharge_Reconciliation_MD18 extends Keywords {

	public void Discharge_Reconciliation_MD18(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset, Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Discharge_Reconciliation_MD18";
		...
		Step_End(8, " Copy the 20s and 40S Container Count", test, test1);
          ...
          moduleNavigate(driver, MCN_Module);
				...
				globalValueSearchWindow(driver, Condition, MCN_No_Header, MCN_No_Text, "", "", "", "");
			     ...
			     scrollToElement(driver, Equipment1);
			       String ContainerNo_DV20_Verify = getText(driver, Equipment1);
				    ...
				    System.out.println("DV20 Value" +ContainerNo_DV20_Verify);
				    
				    
				    
				    
				      String Equipment2 = String.format(Equipment_MCN_field,Container_No2 );
				      if(isdisplayed(driver, Equipment2)) {
				       String ContainerNo_DV40_Verify = getText(driver, Equipment2);
						Extent_pass(driver, "DV20 NO value is :"+ContainerNo_DV20_Verify, test, test1);
						  System.out.println("DV40 Value" +ContainerNo_DV40_Verify);
						  
						  
						   	if (DR_40s_no.equals(ContainerNo_DV40_Verify)) {
								Extent_pass(driver, " Matched || Discharge reconciliation module is :"+ DR_40s_no+ "||Total count in Bill Lading  BL/MCN  is :"+ContainerNo_DV40_Verify , test, test1);
								System.out.println(" Matched || Discharge reconciliation module is :"+ DR_40s_no+ "|| Total count in Bill Lading   BL/MCN is :"+ContainerNo_DV40_Verify );
								
								
							} else {
								Extent_fail(driver, "UnMatched ||Discharge reconciliation module is :"+ DR_40s_no+ "|| Total count in Bill Lading  BL/MCNis :"+ContainerNo_DV40_Verify , test, test1);
								System.out.println("UnMatched || Discharge reconciliation module  is :"+ DR_40s_no+ "|| Total count in Bill Lading   BL/MCN is :"+ContainerNo_DV40_Verify );
