...
public class TC_DG_Creation_SC_007 extends Keywords {
	public void DG_Creation_SC_007(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) throws Exception {

		String testCaseName = "TC_DG_Creation_SC_007";
		...
		String Pending_exp_Value = Excel_data.get("Pending_exp_Value");
		...
		Step_Start(12, "Click pending  button.", test, test1);
		waitForElement(driver, DG_Pending_Button);
		click(driver, DG_Pending_Button);
		...
		if (act_Popup1.contains(Pending_popup)) {
			System.out.println("Matched || " + " Expected Report Activity is : " + Pending_popup
					+ " || Actual Report Activity is : " + act_Popup1);
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is: " + Pending_popup
					+ " || Actual Report Activity is : " + act_Popup1, test, test1);
			safeclick(driver, popup_Message_Ok_Button);
		} else {
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Pending_popup
					+ " || Actual Report Activity is : " + act_Popup1);
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Pending_popup
					+ " || Actual Report Activity is : " + act_Popup1, test, test1);
		}
		...
		waitForElement(driver, Pending_Text);
		String act_popup = getText(driver, Pending_Text);

		if (Pending_exp_Value.equals(act_popup)) {
			System.out.println("Matched || " + " Expected Report Activity is : " + Pending_exp_Value
					+ " || Actual Report Activity is : " + act_popup);
			Extent_pass_New(driver, "Matched || " + " Expected Report Activity is: " + Pending_exp_Value
					+ " || Actual Report Activity is : " + act_popup, test, test1);

		} else {
			System.out.println("Matched || " + " Expected Report Activity is : " + Pending_exp_Value
					+ " || Actual Report Activity is : " + act_popup);
			Extent_fail(driver, "Matched || " + " Expected Report Activity is: " + Pending_exp_Value
					+ " || Actual Report Activity is : " + act_popup, test, test1);

		}
		Step_End(12, "Click pending  button.", test, test1);
