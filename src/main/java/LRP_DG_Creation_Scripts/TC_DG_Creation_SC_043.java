...
public class TC_DG_Creation_SC_043 extends Keywords {


	public void DG_Creation_SC_043(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset,Map<String, String> Excel_data,String url) {
		//		Get data from excel sheet

		String testCaseName="TC_DG_Creation_SC_043";
...
//		Module Search
		...
		if(Saved_Popup.equals(Popup_Saved_Detail)) {                                                                                                                  
			...
			Extent_pass_New(driver, "Matched || " + " Expected PoPup is: " + Popup_Saved_Detail + " || Actual Report Activity is : " + Saved_Popup, test,test1);     
			safeclick(driver, popup_Message_Ok_Button);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected PoPup is : " + Popup_Saved_Detail + " || Actual Report Activity is : " + Saved_Popup);        
			Extent_fail(driver, "Not Matched || " + " Expected PoPup is : " + Popup_Saved_Detail + " || Actual Report Activity is : " + Saved_Popup, test,test1); 
		} 
