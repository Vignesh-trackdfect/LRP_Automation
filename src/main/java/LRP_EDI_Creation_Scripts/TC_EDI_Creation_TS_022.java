...
public class TC_EDI_Creation_TS_022 extends Keywords {
	public void EDI_Creation_TS_022(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_EDI_Creation_TS_022";
		...
		Step_Start(3, "double click the data based on the filter by segment  name ", test, test1);
		Step_Start(4,
		...
		List<String> Segment_Name_Input_Value = splitAndExpand(Segment_Name_Input, ",");
		List<String> Agency_Input_Value = splitAndExpand(Agency_Code_input, ",");
		List<String> Value_Inputs = splitAndExpand(Value_Input, ",");
		List<String> Element_Input_Value = splitAndExpand(Element_Input, ",");
		...
		for (int i = 0; i < Agency_Input_Value.size(); i++) {
			...
			clear(driver, EDI_Content_Segment_Input);
			sendKeys(driver, EDI_Content_Segment_Input, Segment_Name_Input_Value.get(i));

			waitForElement(driver, EDI_Content_Value_Input);
			clear(driver, EDI_Content_Value_Input);
			sendKeys(driver, EDI_Content_Value_Input, Value_Inputs.get(i));

			waitForElement(driver, EDI_Content_Element_Input);
			clear(driver, EDI_Content_Element_Input);
			sendKeys(driver, EDI_Content_Element_Input, Element_Input_Value.get(i));

			formatLocatorClick(driver, EDI_Content_Segement_Check_Box, Segment_Name_Input_Value.get(i));
			if (i == Segment_Name_Input_Value.size() - 1) {

				formatRightClick(driver, EDI_Content_Segement_Check_Box, Segment_Name_Input_Value.get(i));
		...
		for (int i = 0; i < Agency_Input_Value.size(); i++) {
			...
			if (IsEmpty(driver, EDI_Content_First_values)) {
				System.out.println("Matched ||  Expected result : Given Agency Code : " + Agency_Input_Value.get(i)
						+ " , Sagment  Name : " + Segment_Name_Input_Value.get(i) + " , value : " + Value_Inputs.get(i)
						+ " should be removed  in the grid || Actual result : Given  Agency Code : "
						+ Agency_Input_Value.get(i) + ", Segment Name : " + Segment_Name_Input_Value.get(i)
						+ "  and  , value : " + Value_Inputs.get(i) + " removed in the grid  ");
				Extent_pass_New(driver, "Matched ||  Expected result : Given Agency Code : " + Agency_Input_Value.get(i)
						+ " ,Sagment Name : " + Segment_Name_Input_Value.get(i) + " , value : " + Value_Inputs.get(i)
						+ "  should be removed  in the grid || Actual result : Given  Agency Code :  "
						+ Agency_Input_Value.get(i) + ", Segment Name : " + Segment_Name_Input_Value.get(i)
						+ "  and  , value : " + Value_Inputs.get(i) + " removed in the grid  ", test, test1);
			} else {
				System.out.println("Not Matched ||  Expected result : Given Agency Code : " + Agency_Input_Value.get(i)
						+ " ,Sagment Name : " + Segment_Name_Input_Value.get(i) + " , Value : " + Value_Inputs.get(i)
						+ " should be removed  in the grid || Actual result : Given  Agency Code : "
						+ Agency_Input_Value.get(i) + ", Segment Name : " + Segment_Name_Input_Value.get(i)
						+ "  and  , value : " + Value_Inputs.get(i) + " Not removed in the grid  ");
				Extent_fail(driver,
						"Not Matched ||  Expected result : Given Agency Code : " + Agency_Input_Value.get(i)
								+ "  , Sagment Name :  " + Segment_Name_Input_Value.get(i) + " , value  : "
								+ Value_Inputs.get(i)
								+ " should be removed  in the grid || Actual result : Given  Agency Code : "
								+ Agency_Input_Value.get(i) + ", Segment Name : " + Segment_Name_Input_Value.get(i)
								+ " and  , value : " + Value_Inputs.get(i) + " Not  removed in the grid  ",
		...
		Step_End(3, "double click the data based on the filter by segment  name ", test, test1);
		Step_End(4,
				"And click the remove button (or) user want to remove more than one record at time user can select the reqiured data from the grid and rightclick -> click remove option ",
				test, test1);
