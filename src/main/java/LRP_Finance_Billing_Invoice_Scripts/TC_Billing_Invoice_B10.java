...
public class TC_Billing_Invoice_B10  extends Keywords{
	public void  Billing_Invoice_B10(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url){

		String testcase_Name="TC_Billing_Invoice_B10";
		...
		if (Billing_date_popup.equals(Actualpopmsg)) {
			...
			System.out.println("Not matched || Expected : After click on save button Popup value should be display in the Billing Invoice Screen : " + Billing_date_popup+ " || Actual : After click on save button Popup value is display in the Billing Invoice Screen :" + Actualpopmsg);
			Extent_fail(driver, "Not matched || Expected : After click on save button Popup value should be display in the Billing Invoice Screen : " + Billing_date_popup+ " || Actual : After click on save button Popup value is display in the Billing Invoice Screen : " + Actualpopmsg, test, test1);
