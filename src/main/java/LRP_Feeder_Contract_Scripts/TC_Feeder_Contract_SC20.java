...
public class TC_Feeder_Contract_SC20 extends Keywords {
	public void Feeder_Contract_SC20(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_Excel_dataset,
			Map<String, String> Excel_data, String url) {

		String testcase_Name = "TC_Feeder_Contract_SC20";
		...
		Step_Start(5, "Enter the value and select the Service code using search", test, test1);
		...
		click(driver, FC_ServiceCode_Input);
		sendKeys(driver, FC_ServiceCode_Input, ServiceCode_Spl_Value);

		tab(driver);

		waitForElement(driver, FC_ServiceCode_Input);
		String Act_Specialtext = getAttribute(driver, FC_ServiceCode_Input, "value");
		...
		waitForElement(driver, FC_ServiceCode_Input);
		Newclear(driver, FC_ServiceCode_Input);
		sendKeys(driver, FC_ServiceCode_Input, ServiceCode_char_Value);

		tab(driver);

		waitForElement(driver, FC_ServiceCode_Input);
		String morecharacters = getAttribute(driver, FC_ServiceCode_Input, "value");
		...
		if (isdisplayed(driver, popup_Message)) {
			...
			System.out.println(
					"Expected result || The Pickup point field only should allows upto 4 characters || Actual result : The Pickup point field only allows upto 4 characters");
			Extent_pass_New(driver,
					"Expected result || The Pickup point field only should allows upto 4 characters || Actual result : The Pickup point field only allows upto 4 characters",
					test, test1);
			...
			if (morecharacters.length() <= 10) {
				...
				System.out.println(
						"Expected result || The Pickup point field only should allows upto 4 characters || Actual result : The Pickup point field only allows more than 4 characters");
				Extent_fail(driver,
						"Expected result || The Pickup point field only should allows upto 4 characters || Actual result : The Pickup point field only allows more than 4 characters",
						test, test1);
		...
		waitForElement(driver, FC_ServiceCode_Input);
		Newclear(driver, FC_ServiceCode_Input);
		sendKeys(driver, FC_ServiceCode_Input, ServiceCode_Value);

		tab(driver);

		waitForElement(driver, FC_ServiceCode_Input);
		String actual_ServiceCode = getAttribute(driver, FC_ServiceCode_Input, "value");

		if (ServiceCode_Value.equals(actual_ServiceCode)) {

			System.out.println(
					"Expected result : User should be able to select the Service Code value using entering the value || Actual result : User can able to select the Service Code value using entering the value");
			Extent_pass_New(driver,
					"Expected result : User should be able to select the Service Code value using entering the value || Actual result : User can able to select the Service Code value using entering the value",
					test, test1);
		} else {
			...
			System.out.println(
					"Expected result : User should be able to select the Service Code value using entering the value || Actual result : User cannot able to select the Service Code value using entering the value");
			Extent_fail(driver,
					"Expected result : User should be able to select the Service Code value using entering the value || Actual result : User cannot able to select the Service Code value using entering the value",
					test, test1);
		...
		Step_End(5, "Enter the value and select the Service code using search", test, test1);
