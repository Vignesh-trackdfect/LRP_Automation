...
public class TC_Customer_Statement_SC044A extends Keywords {

	public void Customer_Statement_SC044A(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url)
			throws EncryptedDocumentException, InvalidFormatException {

		String testcase_Name = "TC_Customer_Statement_SC044A";
		...
		globalValueSearchWindow(driver, BL_Condition, customer_name_Search_Filter, customer_group_Input, "", "", "",
				"");
