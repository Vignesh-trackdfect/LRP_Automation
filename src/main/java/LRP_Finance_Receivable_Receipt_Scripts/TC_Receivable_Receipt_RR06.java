...
public class TC_Receivable_Receipt_RR06 extends Keywords {

	public void Receivable_Receipt_RR06(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {

		String testCaseName = "TC_Receivable_Receipt_RR06";
		...
		String accountHead = Excel_data.get("AccountHead");
		...
		if (!accountName.equals("") || !accountHead.equals("")) {
		...
		Step_Start(8, "Click on Add button without entering the value in the \"Deposit A/c\"", test, test1);

		waitForElement(driver, add_Button_Cash_Bank_Details_RR);
		click(driver, add_Button_Cash_Bank_Details_RR);

		Step_End(8, "Click on Add button without entering the value in the \"Deposit A/c\"", test, test1);
		Step_Start(9, "system should show pop up validation as \"Cheque a/c name\"", test, test1);
		...
		Step_End(9, "system should show pop up validation as \"Cheque a/c name\"", test, test1);
