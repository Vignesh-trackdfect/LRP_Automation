...
public class TC_Import_Invoice_SC025C extends Keywords {
	public void Import_Invoice_SC025C(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,
			Map<String, String> Excel_data, String url) {
		String testCaseName = "TC_Import_Invoice_SC025C";
		...
		for(int i=0;i<Status_Filer_Datas.size();i++) {
			...
			if(isdisplayed(driver, retrivedGlobalValue)) {
				System.err.println("Not  Matched || This BL Number : "+Global_Search_Input1+" is Already having the "+Status_Filer_Datas.get(i)+" Status Detention waiver");
				Extent_fail(driver, "Not  Matched || This BL Number : "+Global_Search_Input1+" is Already having the "+Status_Filer_Datas.get(i)+" Status Detention waiver", test, test1);
			}
		}
		waitForElement(driver, globalSearchCloseIcon_L);
		jsClick(driver, globalSearchCloseIcon_L);
		// Import Invoice
