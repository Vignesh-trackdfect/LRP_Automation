...
public class TC_Payable_Payment_PP12 extends Keywords {
	
	
	
public void Payable_Payment_PP12(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {
		
		
		String testcase_Name="TC_Payable_Payment_PP12";
		...
		Step_Start(8, "Click the dropdown, Cheque/Cash/TT should be displayed", test, test1);
		
		
		waitForElement(driver, cheque_Drpdwn_Label_PPT);
		click(driver, cheque_Drpdwn_Label_PPT);
		
		waitForDisplay(driver, cheque_Drpdwn_Items_PPT);
		if(isDisplayed(driver, cheque_Drpdwn_Items_PPT)) {
			
			System.out.println("Matched  || Expected After click on Drop down Cheque/Cash/TT should be display. Actual : click on Drop down Cheque/Cash/TT Is displayed");
			Extent_pass_New(driver, "Matched  || Expected After click on Drop down Cheque/Cash/TT should be display. Actual : click on Drop down Cheque/Cash/TT Is displayed", test, test1);
		}else {
			
			System.out.println("Not Matched  || Expected After click on Drop down Cheque/Cash/TT is display. Actual : click on Drop down Cheque/Cash/TT Is Not displayed");
			Extent_fail(driver, "Not Matched  || Expected After click on Drop down Cheque/Cash/TT is display. Actual : click on Drop down Cheque/Cash/TT Is Not displayed", test, test1);
		}
			
		Step_End(8, "Click the dropdown, Cheque/Cash/TT should be displayed", test, test1);
