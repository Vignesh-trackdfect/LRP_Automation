...
public class TC_Vendor_Invoice_Registration_SC14  extends Keywords{



	public void Vendor_Invoice_Registration_SC14(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset,Map<String, String> Excel_data,String url) {

		String testcase_Name="TC_Vendor_Invoice_Registration_SC14";
		...
		if(!Inv_Receiving_Date.equalsIgnoreCase("")) {
		...
		if(!Invoice_Currency_Select.equalsIgnoreCase("")) {
		...
		if(!Disbusse_currency.equalsIgnoreCase("")) {
		...
		if(!Payment_method.equalsIgnoreCase("")) {
		...
		if(!Act_Expensive_amount.equalsIgnoreCase("")) {
		...
		if(!Disbusement_Amount_Input.equalsIgnoreCase("")) {
		...
		Step_Start(5, "Select the CAR NO. option and change the contract type as PTC.\r\n"
				+ "", test, test1);
		...
		Step_Start(5, "Select the CAR NO. option and select the required CAR No. by using the Add button which is available in the CAR No. field.\r\n"
				+ "", test, test1);
		...
		Step_End(5, "Select the CAR NO. option and select the required CAR No. by using the Add button which is available in the CAR No. field.\r\n"
				+ "", test, test1);
		...
		Step_Start(9, "Open the Cost Activity Reporting module by using the module search.\r\n"
				+  "", test, test1);
		moduleNavigate(driver, Cost_Module);
		Step_End(9, "Open the Cost Activity Reporting module by using the module search.\r\n"
				+  "", test, test1);
		Step_Start(10, "Click on the Global search button,a new tab will open."
				+  "", test, test1);
		waitForElement(driver, SearchButton_Toolbar);
		click(driver, SearchButton_Toolbar);
		Step_End(10, "Click on the Global search button,a new tab will open."
				+  "", test, test1);
		Step_Start(11, "Paste the CAR No. in the CAR No. field and click on the search button.."
				+  "", test, test1);
		Step_Start(12, "Our CAR no. will be automatically select in the tab.\r\n"
				+  "", test, test1);
		Step_Start(13, "Click on the select button.\r\n"
				+  "", test, test1);
		globalValueSearchWindow(driver, Condition, Car_num_Search, Reference_number_vendor, "","", "","");

		Step_End(11, "Paste the CAR No. in the CAR No. field and click on the search button.."
				+  "", test, test1);
		Step_End(12, "Our CAR no. will be automatically select in the tab.\r\n"
				+  "", test, test1);
		Step_End(13, "Click on the select button.\r\n"
				+  "", test, test1);
		Step_Start(14, "Click on the Expense report tab.\r\n"
				+  "", test, test1);
		waitForElement(driver, ExpenseReport);
		click(driver, ExpenseReport);
		Step_End(14, "Click on the Expense report tab.\r\n"
				+  "", test, test1);
		Step_Start(15, "A new will be open and click on the approved expense button.\r\n"
				+ ""
				+  "", test, test1);

		waitForElement(driver, vendor_Approved_Expenses_tab);
		click(driver, vendor_Approved_Expenses_tab);
		Step_End(15, "A new will be open and click on the approved expense button.\r\n"
				+ ""
				+  "", test, test1);


	
		Step_Start(16, "Copy the reference no. in the AG grid for all the records by referring the Reference no. column and also it should be not invoiced by referring the the Invoice No. column.\r\n"
				+ ""
				+ ""
				+  "", test, test1);
		...
		Step_End(16, "Copy the reference no. in the AG grid for all the records by referring the Reference no. column and also it should be not invoiced by referring the the Invoice No. column.\r\n"
				+ ""
				+ ""
				+  "", test, test1);
		...
		Step_Start(17, "Then click on the Vendor invoice registration module.\r\n"
				+ ""
				+  "", test, test1);

		Step_Start(18, "Check whether the copied reference no. are available in the AG gid,by refering the Activity Ref. No column."
				+  "", test, test1);
		...
		Step_End(17, "Then click on the Vendor invoice registration module.\r\n"
				+ ""
				+  "", test, test1);

		Step_End(18, "Check whether the copied reference no. are available in the AG gid,by refering the Activity Ref. No column."
				+  "", test, test1);



		Step_Start(19, "Click on the save button which is available in the Tool bar.\r\n"
				+ ""+  "", test, test1);

		waitForElement(driver, SaveButton_ToolBar);
		jsClick(driver, SaveButton_ToolBar);
		Step_End(19, "Click on the save button which is available in the Tool bar.\r\n"
				+ ""+  "", test, test1);
		Step_Start(20, "Check whether the system prompts a message as \"\"Vendor Invoice saved\"\".\"\r\n"
		...
		Step_End(20, "Check whether the system prompts a message as \"\"Vendor Invoice saved\"\".\"\r\n"
				+  "", test, test1);
