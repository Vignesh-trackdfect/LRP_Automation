...
public class TC_Import_Documentation_SC069 extends Keywords  {
	
	public void Import_Documentation_SC069(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset,Map<String, String> Excel_data,String url) {
		String testcase_Name="TC_Import_Documentation_SC069";
...
//		Switch the Profile
		...
		if(isClickable(driver, Arrival_notice_button)) {
			System.out.println("Expected :  Arrival Notice button should be disabled when POD and DO issue locations are not same || Actual : Arrival Notice button is not disabled");
			Extent_fail(driver, "Expected :  Arrival Notice button should be disabled when POD and DO issue locations are not same || Actual : Arrival Notice button is not disabled", test, test1);
		
		}else {
			System.out.println("Expected :  Arrival Notice button should be disabled when POD and DO issue locations are not same || Actual : Arrival Notice button is disabled");
			Extent_pass_New(driver, "Expected :  Arrival Notice button should be disabled when POD and DO issue locations are not same || Actual : Arrival Notice button is disabled", test, test1);
		}
			...
			waitForDisplay(driver, Arrival_notice_button);
			if(isClickable(driver, Arrival_notice_button)) {
				System.out.println("Expected : Arrival Notice button Should be Enable || Actual : Arrival Notice  button is Enabled");
				Extent_pass_New(driver, "Expected : Arrival Notice button Should be Enable || Actual : Arrival Notice  button is Enabled", test, test1);
			
			}else {
				System.out.println("Expected : Arrival Notice button Should be Enable || Actual : Arrival Notice  button is Disabled");
				Extent_fail(driver, "Expected : Arrival Notice button Should be Enable || Actual : Arrival Notice  button is Disabled", test, test1);
			}
